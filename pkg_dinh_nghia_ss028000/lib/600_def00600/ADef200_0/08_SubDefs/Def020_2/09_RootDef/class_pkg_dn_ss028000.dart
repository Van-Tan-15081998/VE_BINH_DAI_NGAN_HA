...
/// -----
class MOHINHCHIENDAUCOSSS10SS010 extends MOHINHCHIENDAUCOCOBAN {
  ///
  static const String maDinhDanhChienDauCo = MOHINHCHIENDAUCOCOBAN.maDinhDanhCDCDCSSSS10SS010;
  ...
  Future<void> onSetupRoot({bool? isIgnoreSetupRootForSubCom}) async {
    ...
    try {
      ...
      /// -----
      await onCaiDatThuocTinhSoHuuChienDauCo(value: THUOCTINHSOHUUCHIENDAUCOSSS10SS010(), caiDatUuTien: true);
      await getThuocTinhSoHuuChienDauCo?.onSetupRoot();

      /// -----
      /// TODO: Cài Đặt Thuộc Tính Chiến Đấu Theo Quy Chuẩn
      /// -----
      await onCaiDatThuocTinhChienDauTheoQuyChuan(value: THUOCTINHCHIENDAUTHEOQUYCHUANSSS10SS010(), caiDatUuTien: true);
  ...
  Future<void> onCapNhatThuocTinhHinhAnh() async {
    ...
    /// -----
    final String nguonHinhAnhCoBan = THUOCTINHHINHANHCHIENDAUCO.nguonHinhAnhCoBanSSS10SS010;
