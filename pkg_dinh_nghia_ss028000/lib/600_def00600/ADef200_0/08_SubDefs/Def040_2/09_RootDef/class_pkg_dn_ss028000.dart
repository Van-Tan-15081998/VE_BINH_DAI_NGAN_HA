...
/// -----
class MOHINHCHIENDAUCOSSS10SS030 extends MOHINHCHIENDAUCOCOBAN {
  ///
  static const String maDinhDanhChienDauCo = MOHINHCHIENDAUCOCOBAN.maDinhDanhCDCDCSSSS10SS030;
  ...
  Future<void> onSetupRoot({bool? isIgnoreSetupRootForSubCom}) async {
    ...
    try {
      ...
      /// -----
      await onCaiDatThuocTinhSoHuuChienDauCo(value: THUOCTINHSOHUUCHIENDAUCOSSS10SS030(), caiDatUuTien: true);
      await getThuocTinhSoHuuChienDauCo?.onSetupRoot();

      /// -----
      /// TODO: Cài Đặt Thuộc Tính Chiến Đấu Theo Quy Chuẩn
      /// -----
      await onCaiDatThuocTinhChienDauTheoQuyChuan(value: THUOCTINHCHIENDAUTHEOQUYCHUANSSS10SS030(), caiDatUuTien: true);
  ...
  Future<void> onCapNhatThuocTinhHinhAnh() async {
    ...
    /// -----
    final String nguonHinhAnhCoBan = THUOCTINHHINHANHCHIENDAUCO.nguonHinhAnhCoBanSSS10SS030;
