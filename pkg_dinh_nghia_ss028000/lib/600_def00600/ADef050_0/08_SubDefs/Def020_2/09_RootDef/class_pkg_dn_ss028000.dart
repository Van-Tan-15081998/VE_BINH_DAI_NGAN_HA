...
/// -----
class MOHINHCHIENDAUCO00C05SS010 extends MOHINHCHIENDAUCOCOBAN {
  ///
  static const String maDinhDanhChienDauCo = MOHINHCHIENDAUCOCOBAN.maDinhDanhCDCDCS00C05SS010;
  ...
  Future<void> onSetupRoot({bool? isIgnoreSetupRootForSubCom}) async {
    ...
    try {
      ...
      /// -----
      await onCaiDatThuocTinhSoHuuChienDauCo(value: THUOCTINHSOHUUCHIENDAUCO00C05SS010(), caiDatUuTien: true);
      await getThuocTinhSoHuuChienDauCo?.onSetupRoot();

      /// -----
      /// TODO: Cài Đặt Thuộc Tính Chiến Đấu Theo Quy Chuẩn
      /// -----
      await onCaiDatThuocTinhChienDauTheoQuyChuan(value: THUOCTINHCHIENDAUTHEOQUYCHUAN00C05SS010(), caiDatUuTien: true);
  ...
  Future<void> onCapNhatThuocTinhHinhAnh() async {
    ...
    /// -----
    final String nguonHinhAnhCoBan = THUOCTINHHINHANHCHIENDAUCO.nguonHinhAnhCoBan00C05SS010;
