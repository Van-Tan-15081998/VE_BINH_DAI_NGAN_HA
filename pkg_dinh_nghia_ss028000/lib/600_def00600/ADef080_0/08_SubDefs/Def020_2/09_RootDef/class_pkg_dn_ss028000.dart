...
/// -----
class MOHINHCHIENDAUCO00S08SS010 extends MOHINHCHIENDAUCOCOBAN {
  ///
  static const String maDinhDanhChienDauCo = MOHINHCHIENDAUCOCOBAN.maDinhDanhCDCDCS00S08SS010;
  ...
  Future<void> onSetupRoot({bool? isIgnoreSetupRootForSubCom}) async {
    ...
    try {
      ...
      /// -----
      await onCaiDatThuocTinhSoHuuChienDauCo(value: THUOCTINHSOHUUCHIENDAUCO00S08SS010(), caiDatUuTien: true);
      await getThuocTinhSoHuuChienDauCo?.onSetupRoot();

      /// -----
      /// TODO: Cài Đặt Thuộc Tính Chiến Đấu Theo Quy Chuẩn
      /// -----
      await onCaiDatThuocTinhChienDauTheoQuyChuan(value: THUOCTINHCHIENDAUTHEOQUYCHUAN00S08SS010(), caiDatUuTien: true);
  ...
  Future<void> onCapNhatThuocTinhHinhAnh() async {
    ...
    getThuocTinhChienDauCo?.getThuocTinhHinhAnh?.getDonViHinhAnhSpriteNgoaiHinhRS025?.onVoidCaiDatChieuCaoFrame(value: 240.0 * (25/100), caiDatUuTien: true);
    ...
    /// -----
    final String nguonHinhAnhCoBan = THUOCTINHHINHANHCHIENDAUCO.nguonHinhAnhCoBan00S08SS010;
