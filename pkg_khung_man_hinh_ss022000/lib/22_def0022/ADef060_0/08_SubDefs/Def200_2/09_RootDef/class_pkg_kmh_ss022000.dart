...
import 'package:pkg_man_hinh_ss00222/22_def0022/ADef20_0/08_SubDefs/Def20_2/09_RootDef/class_20000220.dart';

/// -----
/// TODO: Card Chiến Đấu Cơ Chọn Sử Dụng Chiến Đấu
/// -----
class CARDCHIENDAUCOCHONSUDUNGCHIENDAU extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDCHIENDAUCOCHONSUDUNGCHIENDAU({
    ...
    caiDatTrangThai(value: getGlobalStateManagementSystem?.getChienDauCoTongQuat?.getChienDauCoChiDinhThucThiThongTin?.getTrangThaiChienDauCoChonSuDungChienDau);
  ...
  CHIENDAUCOCHONSUDUNGCHIENDAU? _spriteChienDauCoChonSuDungChienDau;

  @override
  Future<void> onThucThi() async {

    await getGlobalStateManagementSystem?.getChienDauCoTongQuat?.getChienDauCoChiDinhThucThiThongTin?.onCapNhatChienDauCoChiDinhThucThiThongTin();
