...
import 'package:pkg_khung_man_hinh_ss022500/22_def0022/ADef050_0/08_SubDefs/Def020_2/09_RootDef/class_pkg_kmh_ss022100.dart';

/// -----
/// TODO: Quản Lý Thành Phần Hình Ảnh Khung Màn Hình Chính Tab SS030 Chiến Đấu
/// -----
class QUANLYTHANHPHANHINHANHKHUNGMANHINHCHINHTABSS050CD
    extends QUANLYTHANHPHANHINHANHTHUOCCAPCOBAN {
  /// -----
  /// TODO:
  /// -----
  QUANLYTHANHPHANHINHANHKHUNGMANHINHCHINHTABSS050CD({
  ...
  /// TODO:
  /// -----
  HINHANHBACKGROUNDKHUNGMANHINHCHINHTABSS050CD? _hinhAnhBackGround;
  HINHANHBACKGROUNDKHUNGMANHINHCHINHTABSS050CD? get getHinhAnhBackGround =>
      _hinhAnhBackGround;
  Future<void> onCaiDatHinhAnhBackGround({
    required HINHANHBACKGROUNDKHUNGMANHINHCHINHTABSS050CD? value,
    bool? caiDatUuTien,
  }) async {
  ...
  Future<void> onSetupRootForSubCom() async {
    ...
    await Future.wait([
      onCaiDatHinhAnhBackGround(
        value: HINHANHBACKGROUNDKHUNGMANHINHCHINHTABSS050CD(
