...
/// TODO:
/// -----
class NUTBAMCHONCHATLUONGDOHOACAO extends THANHPHANNUTBAMTHUOCCAPTHUANKICHHOAT {
  /// -----
  /// TODO:
  /// -----
  ...
  void onThucThi() async {
    ...
    await getGameController?.onKichHoatCaiDatDoHoaCao?.call();
  ...
  void onTapUp(TapUpEvent event) async {
    ...
    await getGameController?.onChonChiDinhCaiDatChatLuongDoHoaCao();
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: 'Cao', caiDatUuTien: true);
