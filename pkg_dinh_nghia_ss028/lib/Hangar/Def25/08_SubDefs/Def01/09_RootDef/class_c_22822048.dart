...
import 'package:pkg_dinh_nghia_ss028/Hangar/Def25/08_SubDefs/Def01/08_SubDefs/Def01/08_SubDefs/Def01/09_RootDef/class_c_60620664.dart';
import 'package:pkg_dinh_nghia_ss028/Hangar/Def25/08_SubDefs/Def01/08_SubDefs/Def01/08_SubDefs/Def02/08_SubDefs/Def01/09_RootDef/class_c_46628642.dart';
import 'package:pkg_dinh_nghia_ss028/Hangar/Def25/08_SubDefs/Def01/08_SubDefs/Def01/08_SubDefs/Def03/08_SubDefs/Def01/09_RootDef/class_c_62488444.dart';
...
/// TODO:
///
class ChienDauCoDangCapSao00S08SS01 extends MoHinhChienDauCoDangCapSao00S08 {
  /// -----
  /// TODO: Setup Root
  /// -----
  @override
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await caiDatThuocTinhSoHuuChienDauCo(value: THUOCTINHSOHUUCHIENDAUCO00S08SS010(), caiDatUuTien: true);
    await getThuocTinhSoHuuChienDauCo?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Thuộc Tính Chiến Đấu Theo Quy Chuẩn
    /// -----
    await caiDatThuocTinhChienDauTheoQuyChuan(value: THUOCTINHCHIENDAUTHEOQUYCHUAN00S08SS010(), caiDatUuTien: true);
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: MoHinhThuocTinhKichThuocChienDauCoDangCapSao00S08SS01(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: MoHinhThuocTinhCapDoGiapChienDauCoDangCapSao00S08SS01(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: MoHinhThuocTinhCapDoMauChienDauCoDangCapSao00S08SS01(), caiDatUuTien: true);
    ...
    //     ?.caiDatCapDo(value: MoHinhThuocTinhCapDoVuKhiVKTCCBSS01ChienDauCoDangCapSao00S08SS01(), caiDatUuTien: true);
    ...
    //     ?.caiDatCapDo(value: MoHinhThuocTinhCapDoVuKhiVKTCTMSS01ChienDauCoDangCapSao00S08SS01(), caiDatUuTien: true);
  ...
  Future<void> onInitRoot() async {
    ...
    await getThuocTinhSoHuuChienDauCo?.getSoHuuTheoThoiGianVinhVien?.caiDatKhoaBanGhiDuLieuSoHuuTheoThoiGianVinhVienChienDauCoDangCapSao00S08SS010();

    await getThuocTinhChienDauTheoQuyChuan?.getThuocTinhCapDoChienDauCoTheoQuyChuan?.caiDatKhoaBanGhiDuLieuCapDoTheoQuyChuanChienDauCoDangCapSao00S08SS010();
    ...
    getThuocTinh?.caiDatTenChienDauCo(value: '00S08SS01', caiDatUuTien: true);
    getThuocTinh?.caiDatMaDinhDanhDangCapSao(value: '[00S08SS01]', caiDatUuTien: true);
  ...
  static const String maDinhDanhChienDauCo = '${MoHinhChienDauCoDangCapSao00S08.maDinhDanhDangCapSao}_[DANG_CAP_SAO_00S08_SS01]';
  ...
  Future<void> onInitHinhAnhSprite() async {
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.caiDatNguonHinhAnh(
      value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_00S08SS01.png',
    );
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongCoBanSS01SS01?.caiDatNguonHinhAnh(
      value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_00S08SS01.png',
    );
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongCoBanSS01SS02?.caiDatNguonHinhAnh(
      value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/sprite_sheet_00S08SS01.png',
    );
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongCoBanSS01SS03?.caiDatNguonHinhAnh(
      value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def24/09_RootDef/sprite_sheet_00S08SS01.png',
    );
    ...
    //   value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_00S08SS01.png',
    // );
    ...
    //   value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/sprite_sheet_00S08SS01.png',
    // );
    ...
    //   value: 'assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def24/09_RootDef/sprite_sheet_00S08SS01.png',
    // );
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhThanTheoPart() async {
    ...
    String srcPartSS01 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_PSS01.png';
    String srcPartSS02 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_PSS02.png';
    String srcPartSS03 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_PSS03.png';
    String srcPartSS04 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_PSS04.png';
    String srcPartSS05 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_PSS05.png';
    String srcPartSS06 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhVuKhiTanCongThongMinhSS01TheoPart() async {
    ...
    String srcPartSS01 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_VKTCTMSS01_PSS01.png';
    String srcPartSS02 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_VKTCTMSS01_PSS02.png';
    String srcPartSS03 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_VKTCTMSS01_PSS03.png';
    String srcPartSS04 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_VKTCTMSS01_PSS04.png';
    String srcPartSS05 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_VKTCTMSS01_PSS05.png';
    String srcPartSS06 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_00S08SS01_VKTCTMSS01_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhVuKhiTanCongThongMinhSS02TheoPart() async {
    ...
    String srcPartSS01 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_00S08SS01_VKTCTMSS02_PSS01.png';
    String srcPartSS02 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_00S08SS01_VKTCTMSS02_PSS02.png';
    String srcPartSS03 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_00S08SS01_VKTCTMSS02_PSS03.png';
    String srcPartSS04 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_00S08SS01_VKTCTMSS02_PSS04.png';
    String srcPartSS05 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_00S08SS01_VKTCTMSS02_PSS05.png';
    String srcPartSS06 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_00S08SS01_VKTCTMSS02_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhVuKhiTanCongThongMinhSS03TheoPart() async {
    ...
    String srcPartSS01 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_00S08SS01_VKTCTMSS03_PSS01.png';
    String srcPartSS02 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_00S08SS01_VKTCTMSS03_PSS02.png';
    String srcPartSS03 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_00S08SS01_VKTCTMSS03_PSS03.png';
    String srcPartSS04 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_00S08SS01_VKTCTMSS03_PSS04.png';
    String srcPartSS05 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_00S08SS01_VKTCTMSS03_PSS05.png';
    String srcPartSS06 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def30/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_00S08SS01_VKTCTMSS03_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
