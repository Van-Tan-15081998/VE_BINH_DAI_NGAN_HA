import 'package:pkg_dinh_nghia_ss028/Hangar/Def27/07_AbstractDef/09_RootDef/class_c_60060266.dart';
import 'package:pkg_dinh_nghia_ss028/Hangar/Def27/08_SubDefs/Def05/08_SubDefs/Def01/08_SubDefs/Def01/09_RootDef/class_c_08882066.dart';
import 'package:pkg_dinh_nghia_ss028/Hangar/Def27/08_SubDefs/Def05/08_SubDefs/Def01/08_SubDefs/Def02/08_SubDefs/Def01/09_RootDef/class_c_22240680.dart';
import 'package:pkg_dinh_nghia_ss028/Hangar/Def27/08_SubDefs/Def05/08_SubDefs/Def01/08_SubDefs/Def03/08_SubDefs/Def01/09_RootDef/class_c_04462604.dart';
...
/// TODO:
///
class ChienDauCoDangCapSaoSSS10SS05 extends MoHinhChienDauCoDangCapSaoSSS10 {
  /// -----
  /// TODO: Setup Root
  /// -----
  @override
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await caiDatThuocTinhSoHuuChienDauCo(value: THUOCTINHSOHUUCHIENDAUCOSSS10SS050(), caiDatUuTien: true);
    await getThuocTinhSoHuuChienDauCo?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Thuộc Tính Chiến Đấu Theo Quy Chuẩn
    /// -----
    await caiDatThuocTinhChienDauTheoQuyChuan(value: THUOCTINHCHIENDAUTHEOQUYCHUANSSS10SS050(), caiDatUuTien: true);
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: MoHinhThuocTinhKichThuocChienDauCoDangCapSaoSSS10SS05(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: MoHinhThuocTinhCapDoGiapChienDauCoDangCapSaoSSS10SS05(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: MoHinhThuocTinhCapDoMauChienDauCoDangCapSaoSSS10SS05(), caiDatUuTien: true);
    ...
    //     ?.caiDatCapDo(value: MoHinhThuocTinhCapDoVuKhiVKTCCBSS01ChienDauCoDangCapSaoSSS10SS05(), caiDatUuTien: true);
    ...
    //     ?.caiDatCapDo(value: MoHinhThuocTinhCapDoVuKhiVKTCTMSS01ChienDauCoDangCapSaoSSS10SS05(), caiDatUuTien: true);
  ...
  Future<void> onInitRoot() async {
    ...
    await getThuocTinhSoHuuChienDauCo?.getSoHuuTheoThoiGianVinhVien?.caiDatKhoaBanGhiDuLieuSoHuuTheoThoiGianVinhVienChienDauCoDangCapSaoSSS10SS050();

    await getThuocTinhChienDauTheoQuyChuan?.getThuocTinhCapDoChienDauCoTheoQuyChuan?.caiDatKhoaBanGhiDuLieuCapDoTheoQuyChuanChienDauCoDangCapSaoSSS10SS050();

    await super.onInitRoot();

    getThuocTinh?.getThuocTinhTanCong?.onVoidCaiDatMaDinhDanhHinhThucDuongBayVienDanDacHuu(value: '[HINH_THUC_SS160]');

    getThuocTinh?.caiDatTenChienDauCo(value: 'SSS10SS05', caiDatUuTien: true);
    getThuocTinh?.caiDatMaDinhDanhDangCapSao(value: '[SSS10SS05]', caiDatUuTien: true);
  ...
  /// TODO:
  /// -----
  static const String maDinhDanhChienDauCo = '${MoHinhChienDauCoDangCapSaoSSS10.maDinhDanhDangCapSao}_[DANG_CAP_SAO_SSS10_SS05]';
  ...
  Future<void> onInitHinhAnhSprite() async {
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.caiDatNguonHinhAnh(
      value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sprite_sheet_SSS10SS05.png',
    );
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.caiDatTongSoFrame(value: 90);
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.caiDatTongSoFrameTrenHang(value: 10);
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.caiDatChieuRongFrame(value: 350.0);
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.caiDatChieuCaoFrame(value: 408.0);
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongCoBanSS01SS01?.caiDatNguonHinhAnh(
      value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_SSS10SS05.png',
    );
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongCoBanSS01SS02?.caiDatNguonHinhAnh(
      value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/sprite_sheet_SSS10SS05.png',
    );
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongCoBanSS01SS03?.caiDatNguonHinhAnh(
      value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def24/09_RootDef/sprite_sheet_SSS10SS05.png',
    );
    ...
    //   value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_SSS10SS05.png',
    // );
    // await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS01SS01?.caiDatTongSoFrame(value: 90);
    ...
    //   value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/sprite_sheet_SSS10SS05.png',
    // );
    // await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS01SS02?.caiDatTongSoFrame(value: 90);
    ...
    //   value: 'assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def24/09_RootDef/sprite_sheet_SSS10SS05.png',
    // );
    // await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS01SS03?.caiDatTongSoFrame(value: 90);
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhThanTheoPart() async {
    ...
    double chieuRongFrame = 350.0;
    double chieuCaoFrame = 408.0;

    String srcPartSS01 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS01.png';
    String srcPartSS02 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS02.png';
    String srcPartSS03 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS03.png';
    String srcPartSS04 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS04.png';
    String srcPartSS05 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS05.png';
    String srcPartSS06 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS06.png';
    String srcPartSS07 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS07.png';
    String srcPartSS08 = 'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_PSS08.png';
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCoPartSS06?.caiDatTongSoFrame(value: tongSoFrame);
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhVuKhiTanCongThongMinhSS01TheoPart() async {
    ...
    String srcPartSS01 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_VKTCTMSS01_PSS01.png';
    String srcPartSS02 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_VKTCTMSS01_PSS02.png';
    String srcPartSS03 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_VKTCTMSS01_PSS03.png';
    String srcPartSS04 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_VKTCTMSS01_PSS04.png';
    String srcPartSS05 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_VKTCTMSS01_PSS05.png';
    String srcPartSS06 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/sps_SSS10SS05_VKTCTMSS01_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS01PartSS04?.caiDatTongSoFrame(value: tongSoFrame);
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS01PartSS06?.caiDatTongSoFrame(value: 15);
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhVuKhiTanCongThongMinhSS02TheoPart() async {
    ...
    String srcPartSS01 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_SSS10SS05_VKTCTMSS02_PSS01.png';
    String srcPartSS02 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_SSS10SS05_VKTCTMSS02_PSS02.png';
    String srcPartSS03 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_SSS10SS05_VKTCTMSS02_PSS03.png';
    String srcPartSS04 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_SSS10SS05_VKTCTMSS02_PSS04.png';
    String srcPartSS05 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_SSS10SS05_VKTCTMSS02_PSS05.png';
    String srcPartSS06 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def22/09_RootDef/sps_SSS10SS05_VKTCTMSS02_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS02PartSS04?.caiDatTongSoFrame(value: tongSoFrame);
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS02PartSS06?.caiDatTongSoFrame(value: 15);
  ...
  Future<void> onInitHinhAnhSpriteNgoaiHinhVuKhiTanCongThongMinhSS03TheoPart() async {
    ...
    String srcPartSS01 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_SSS10SS05_VKTCTMSS03_PSS01.png';
    String srcPartSS02 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_SSS10SS05_VKTCTMSS03_PSS02.png';
    String srcPartSS03 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_SSS10SS05_VKTCTMSS03_PSS03.png';
    String srcPartSS04 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_SSS10SS05_VKTCTMSS03_PSS04.png';
    String srcPartSS05 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_SSS10SS05_VKTCTMSS03_PSS05.png';
    String srcPartSS06 =
        'packages/pkg_dinh_nghia_ss028/assets/images/Def34/08_SubDefs/Def28/08_SubDefs/Def24/08_SubDefs/Def24/09_RootDef/sps_SSS10SS05_VKTCTMSS03_PSS06.png';
    String srcPartSS07 = '';
    String srcPartSS08 = '';
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS03PartSS04?.caiDatTongSoFrame(value: tongSoFrame);
    ...
    await getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhVuKhiTanCongThongMinhSS03PartSS06?.caiDatTongSoFrame(value: 15);
