...
class BANVEXAYDUNGDOIHINHCKVBSS040QDCV extends BANVEXAYDUNGDOIHINHCHIENDAUCOBAN {
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      hoatDongSS022?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 25.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS024 - phuongTienSS024
      hoatDongSS024?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 25.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      hoatDongSS036?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 4.0, dyRangeValue: 9.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 16.0, dyRangeValue: 9.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS022 - phuongTienSS022
      hoatDongSS022?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 25.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS024 - phuongTienSS024
      hoatDongSS024?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 25.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS036 - phuongTienSS036
      hoatDongSS036?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 4.0, dyRangeValue: 9.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 16.0, dyRangeValue: 9.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
