...
class BANVEXAYDUNGDOIHINHDTSDSS010TTTS extends BANVEXAYDUNGDOIHINHCHIENDAUCOBAN {
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      hoatDongSS026?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 6.0, dyRangeValue: 24.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS028 - phuongTienSS028
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 14.0, dyRangeValue: 24.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      hoatDongSS036?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 6.0, dyRangeValue: 11.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 14.0, dyRangeValue: 11.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS026 - phuongTienSS026
      hoatDongSS026?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 6.0, dyRangeValue: 24.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS028 - phuongTienSS028
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 14.0, dyRangeValue: 24.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS036 - phuongTienSS036
      hoatDongSS036?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 6.0, dyRangeValue: 11.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 14.0, dyRangeValue: 11.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
