...
class BANVEXAYDUNGDOIHINHTACLSS040DSTP extends BANVEXAYDUNGDOIHINHCHIENDAUCOBAN {
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      hoatDongSS020?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 27.0, khoangCachBienDuoiCheoTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS022 - phuongTienSS022
      hoatDongSS022?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 6.0, dyRangeValue: 24.0, khoangCachBienDuoiCheoTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS024 - phuongTienSS024
      hoatDongSS024?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 2.0, dyRangeValue: 22.0, khoangCachBienDuoiCheoTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS026 - phuongTienSS026
      hoatDongSS026?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 5.0, dyRangeValue: 21.0, khoangCachBienDuoiCheoTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS028 - phuongTienSS028
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 20.0, khoangCachBienDuoiCheoTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      hoatDongSS030?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 27.0, khoangCachBienDuoiCheoPhai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS032 - phuongTienSS032
      hoatDongSS032?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 14.0, dyRangeValue: 24.0, khoangCachBienDuoiCheoPhai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS034 - phuongTienSS034
      hoatDongSS034?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 18.0, dyRangeValue: 22.0, khoangCachBienDuoiCheoPhai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS036 - phuongTienSS036
      hoatDongSS036?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 15.0, dyRangeValue: 21.0, khoangCachBienDuoiCheoPhai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 20.0, khoangCachBienDuoiCheoPhai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS010({
    ...
    Future.wait([
      /// TODO: hoatDongSS020 - phuongTienSS020
      hoatDongSS020?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 27.0, khoangCachBienDuoiCheoTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS022 - phuongTienSS022
      hoatDongSS022?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 6.0, dyRangeValue: 24.0, khoangCachBienDuoiCheoTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS024 - phuongTienSS024
      hoatDongSS024?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 2.0, dyRangeValue: 22.0, khoangCachBienDuoiCheoTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS026 - phuongTienSS026
      hoatDongSS026?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 5.0, dyRangeValue: 21.0, khoangCachBienDuoiCheoTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS028 - phuongTienSS028
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 20.0, khoangCachBienDuoiCheoTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS020({
    ...
    Future.wait([
      /// TODO: hoatDongSS030 - phuongTienSS030
      hoatDongSS030?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 27.0, khoangCachBienDuoiCheoPhai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS032 - phuongTienSS032
      hoatDongSS032?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 14.0, dyRangeValue: 24.0, khoangCachBienDuoiCheoPhai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS034 - phuongTienSS034
      hoatDongSS034?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 18.0, dyRangeValue: 22.0, khoangCachBienDuoiCheoPhai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS036 - phuongTienSS036
      hoatDongSS036?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 15.0, dyRangeValue: 21.0, khoangCachBienDuoiCheoPhai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 20.0, khoangCachBienDuoiCheoPhai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
