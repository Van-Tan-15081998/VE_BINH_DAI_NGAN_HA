...
class BANVEXAYDUNGDOIHINHQDTSSS030DSTP extends BANVEXAYDUNGDOIHINHCHIENDAUCOBAN {
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 5.0, dyRangeValue: 9.0, khoangCachBienTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS028 - phuongTienSS028
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 5.0, dyRangeValue: 9.0, khoangCachBienTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
