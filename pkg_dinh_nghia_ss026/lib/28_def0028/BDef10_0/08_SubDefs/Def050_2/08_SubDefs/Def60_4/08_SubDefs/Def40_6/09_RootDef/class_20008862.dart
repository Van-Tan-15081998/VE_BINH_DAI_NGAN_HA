...
class BANVEXAYDUNGDOIHINHTDBPSS050STTC extends BANVEXAYDUNGDOIHINHCHIENDAUCOBAN {
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      hoatDongSS024?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 8.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      ...
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 4.0, dyRangeValue: 6.0, khoangCachBienTrai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS010NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      hoatDongSS034?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 8.0, khoangCachBienTren: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      ...
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 16.0, dyRangeValue: 6.0, khoangCachBienPhai: -1.0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS010({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS024 - phuongTienSS024
      hoatDongSS024?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 8.0, dyRangeValue: 8.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      ...
      /// TODO: hoatDongSS028 - phuongTienSS028
      hoatDongSS028?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 4.0, dyRangeValue: 6.0, khoangCachBienTrai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00ATurnSS020({
    ...
    Future.wait([
      ...
      /// TODO: hoatDongSS034 - phuongTienSS034
      hoatDongSS034?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 12.0, dyRangeValue: 8.0, khoangCachBienTren: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      ...
      /// TODO: hoatDongSS038 - phuongTienSS038
      hoatDongSS038?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.getDiemToaDo
              ?.onCaiDatGiaTriToaDo2040(dxRangeValue: 16.0, dyRangeValue: 6.0, khoangCachBienPhai: 0)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
