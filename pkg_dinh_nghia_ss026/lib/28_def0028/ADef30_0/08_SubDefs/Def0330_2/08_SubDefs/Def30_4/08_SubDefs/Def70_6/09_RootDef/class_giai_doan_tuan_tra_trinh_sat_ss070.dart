...
class GIAIDOANTUANTRATRINHSATSS070STAGESS00B013 extends GIAIDOANTUANTRATRINHSATSS070 {
  /// -----
  /// TODO: Init Root
  /// -----
  @override
  ...
  Future<void> onInitGiaiDoanSS070NhomSS00A() async {
    ...
    await getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS020?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.caiDatDiemToaDo(
      value:
          DIEMTOADOTHUOCDOANDUONGBAY.onCachBienGiua(maDinhDanh: DIEMTOADOTHUOCDOANDUONGBAY.constDiemToaDoVoHanTheoDy, khoangCach: 0)
            ..caiDatDxRangeValue(value: 9999, caiDatUuTien: true)
            ..caiDatDyRangeValue(value: 9999, caiDatUuTien: true)
