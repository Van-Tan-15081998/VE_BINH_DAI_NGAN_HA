...
class GIAIDOANDAUSYTIENPHONGSS020STAGESS00A009 extends GIAIDOANDAUSYTIENPHONGSS020 {
  /// -----
  /// TODO: Init Root
  /// -----
  @override
  ...
  Future<void> onInitGiaiDoanSS020NhomSS00A() async {
    ...
    await getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS020?.getDanhSachDoanDuongBayThuocKichBan?.getDoanDuongBaySS020?.caiDatDiemToaDo(
      value:
          DIEMTOADOTHUOCDOANDUONGBAY.onCachBienGiua(maDinhDanh: DIEMTOADOTHUOCDOANDUONGBAY.constDiemToaDoHanhTrinh, khoangCach: 0)
    ...
    // /// -----
    // /// TODO: Sử Dụng Bản Vẽ Xây Dựng Đội Hình Chiến Đấu
    // /// -----
    // await getBanVeXayDungDoiHinhDSTPNhomSS00A?.onInitGiaiDoanSS020NhomSS00ATurnSS010(
    ...
    // );
    //
    // await getBanVeXayDungDoiHinhDSTPNhomSS00A?.onInitGiaiDoanSS020NhomSS00ATurnSS020(
  ...
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// TODO: Giai Đoạn SS020 [1] - Nhóm SS00B [1]
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  Future<void> onInitGiaiDoanSS020NhomSS00B() async {
    ...
    // /// TODO: Sử Dụng Bản Vẽ Xây Dựng Đội Hình Chiến Đấu
    // /// -----
    // await getBanVeXayDungDoiHinhDSTPNhomSS00B?.onInitGiaiDoanSS020NhomSS00ATurnSS010(
    //   hoatDongSS020: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS020,
    //   hoatDongSS022: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS022,
    //   hoatDongSS024: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS024,
    //   hoatDongSS026: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS026,
    ...
    // );
    //
    // await getBanVeXayDungDoiHinhDSTPNhomSS00B?.onInitGiaiDoanSS020NhomSS00ATurnSS020(
    //   hoatDongSS030: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS030,
    //   hoatDongSS032: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS032,
    //   hoatDongSS034: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS034,
    //   hoatDongSS036: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS036,
  ...
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// TODO: Giai Đoạn SS020 [1] - Nhóm SS00C [1]
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  Future<void> onInitGiaiDoanSS020NhomSS00C() async {
    ...
    // /// TODO: Sử Dụng Bản Vẽ Xây Dựng Đội Hình Chiến Đấu
    // /// -----
    // await getBanVeXayDungDoiHinhDSTPNhomSS00C?.onInitGiaiDoanSS020NhomSS00ATurnSS010(
    //   hoatDongSS020: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS020,
    //   hoatDongSS022: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS022,
    //   hoatDongSS024: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS024,
    //   hoatDongSS026: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS026,
    ...
    // );
    //
    // await getBanVeXayDungDoiHinhDSTPNhomSS00C?.onInitGiaiDoanSS020NhomSS00ATurnSS020(
    //   hoatDongSS030: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS030,
    //   hoatDongSS032: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS032,
    //   hoatDongSS034: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS034,
    //   hoatDongSS036: getDanhSachHoatDongChienDauXamChiemNhomSS00A?.getHoatDongChienDauXamChiemSS036,
  ...
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// TODO: Giai Đoạn SS020 [1] - Nhóm SS00D [1]
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
  /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
