...
class GIAIDOANDAUSYTIENPHONGSS040STAGESS0020 extends GIAIDOANDAUSYTIENPHONGSS040 {
  /// -----
  /// TODO: Init Root
  /// -----
  @override
  Future<void> onInitRoot() async {
    ...
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// TODO: Giai Đoạn SS040 [3] - Nhóm SS00D [4] [X] (Đội Hình Đấu Sỹ Tiên Phong Không Có Nhóm SS00D)
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
