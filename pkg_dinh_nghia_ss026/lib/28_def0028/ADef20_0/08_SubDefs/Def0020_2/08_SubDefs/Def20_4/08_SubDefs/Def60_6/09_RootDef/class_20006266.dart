...
class GIAIDOANDAUSYTIENPHONGSS060STAGESS0020 extends GIAIDOANDAUSYTIENPHONGSS060 {
  /// -----
  /// TODO: Init Root
  /// -----
  @override
  Future<void> onInitRoot() async {
    ...
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// TODO: Giai Đoạn SS060 [5] - Nhóm SS00D [4] [X] (Đội Hình Đấu Sỹ Tiên Phong Không Có Nhóm SS00D)
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
