...
class GIAIDOANDAUSYTIENPHONGSS050STAGESS0020 extends GIAIDOANDAUSYTIENPHONGSS050 {
  /// -----
  /// TODO: Init Root
  /// -----
  @override
  Future<void> onInitRoot() async {
    ...
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// TODO: Giai Đoạn SS050 [4] - Nhóm SS00D [4] [X] (Đội Hình Đấu Sỹ Tiên Phong Không Có Nhóm SS00D)
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
    /// -----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
