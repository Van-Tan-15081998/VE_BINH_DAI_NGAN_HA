...
/// -----
/// TODO: Giai Đoạn Vật Phẩm Phần Thưởng Cơ Bản
/// -----
mixin GIAIDOANVATPHAMPHANTHUONGCOBAN {
  /// -----
  /// TODO: Danh Sách Phương Tiện Siêu Cấp Chỉ Huy Thuộc Giai Đoạn
  /// -----
  DANHSACHPHUONGTIENVATPHAMPHANTHUONGTHUOCGIAIDOAN? _danhSachPhuongTienSieuCapChiHuy;
  DANHSACHPHUONGTIENVATPHAMPHANTHUONGTHUOCGIAIDOAN? get getDanhSachPhuongTienSieuCapChiHuy => _danhSachPhuongTienSieuCapChiHuy;
  Future<void> caiDatDanhSachPhuongTienSieuCapChiHuy({required DANHSACHPHUONGTIENVATPHAMPHANTHUONGTHUOCGIAIDOAN? value, bool? caiDatUuTien}) async {
