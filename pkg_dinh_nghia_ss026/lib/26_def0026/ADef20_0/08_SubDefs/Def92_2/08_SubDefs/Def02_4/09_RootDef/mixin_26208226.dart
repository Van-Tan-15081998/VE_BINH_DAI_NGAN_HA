...
/// -----
/// TODO: Giai Đoạn Vũ Khí Ngẫu Nhiên Cơ Bản
/// -----
mixin GIAIDOANVUKHINGAUNHIENCOBAN {
  /// -----
  /// TODO: Danh Sách Phương Tiện Siêu Cấp Chỉ Huy Thuộc Giai Đoạn
  /// -----
  DANHSACHPHUONGTIENVUKHINGAUNHIENTHUOCGIAIDOAN? _danhSachPhuongTienSieuCapChiHuy;
  DANHSACHPHUONGTIENVUKHINGAUNHIENTHUOCGIAIDOAN? get getDanhSachPhuongTienSieuCapChiHuy => _danhSachPhuongTienSieuCapChiHuy;
  Future<void> caiDatDanhSachPhuongTienSieuCapChiHuy({required DANHSACHPHUONGTIENVUKHINGAUNHIENTHUOCGIAIDOAN? value, bool? caiDatUuTien}) async {
