...
/// -----
/// TODO: Giai Đoạn Vũ Khí Điều Khiển Cơ Bản
/// -----
mixin GIAIDOANVUKHIDIEUKHIENCOBAN {
  /// -----
  /// TODO: Danh Sách Phương Tiện Siêu Cấp Chỉ Huy Thuộc Giai Đoạn
  /// -----
  DANHSACHPHUONGTIENVUKHIDIEUKHIENTHUOCGIAIDOAN? _danhSachPhuongTienSieuCapChiHuy;
  DANHSACHPHUONGTIENVUKHIDIEUKHIENTHUOCGIAIDOAN? get getDanhSachPhuongTienSieuCapChiHuy => _danhSachPhuongTienSieuCapChiHuy;
  Future<void> caiDatDanhSachPhuongTienSieuCapChiHuy({required DANHSACHPHUONGTIENVUKHIDIEUKHIENTHUOCGIAIDOAN? value, bool? caiDatUuTien}) async {
