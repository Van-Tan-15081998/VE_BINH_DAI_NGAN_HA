...
///
class DoiHinh5HLKhoiKChieuNghichHanhLangBaySs4 extends MoHinhKichBanBayTheoDoiHinhKhoiTongQuat {
  TocDoCuongCheCoBan? _tocDoCuongCheHanhTrinhCaoNhat;
  TocDoCuongCheCoBan? _tocDoCuongCheHanhTrinhThapNhat;

  DoiHinh5HLKhoiKChieuNghichHanhLangBaySs4({
      ...
      MoHinhPhuongTienThuocKichBanChienDau phuongTienThuocKichBan = MoHinhPhuongTienThuocKichBanChienDau(
        ...
        danhSachDoanDuongBayThuocKichBan: [
          ...
          MoHinhDoanDuongBayThuocKichBanChienDau(
            ...
            maDinhDanhDiemToaDoCauNoiThuNhat: null,
            maDinhDanhDiemToaDoCauNoiThuHai: null,
            diemToaDoCauNoiCuongCheThuNhat: HanhLangBayCoBan.dcs_0_13(khoangCach: 0, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienGiua()).getViTriXuatPhat,
            diemToaDoCauNoiCuongCheThuHai: HanhLangBayCoBan.dcs_11_10(khoangCach: 0, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienGiua()).getViTriXuatPhat,
