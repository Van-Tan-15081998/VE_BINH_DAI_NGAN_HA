...
///
class DoiHinh6HLKhoiQChieuThuanHanhLangBaySs3 extends MoHinhKichBanBayTheoDoiHinhKhoiTongQuat {
  TocDoCuongCheCoBan? _tocDoCuongCheHanhTrinhCaoNhat;
  TocDoCuongCheCoBan? _tocDoCuongCheHanhTrinhThapNhat;

  DoiHinh6HLKhoiQChieuThuanHanhLangBaySs3({
  ...
  Future<void> onProcess({required MoHinhPhuongTienTongQuat? phuongTien, required double? phuongTienCachViTriXuatPhat}) async {
    if (phuongTien != null) {
      ...
      MoHinhPhuongTienThuocKichBanChienDau phuongTienThuocKichBan = MoHinhPhuongTienThuocKichBanChienDau(
        ...
        viTriXuatPhat: HanhLangBayCoBan.dcs_0_13(khoangCach: phuongTienCachViTriXuatPhat, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienTrai()).getViTriXuatPhat,
        danhSachDoanDuongBayThuocKichBan: [
          MoHinhDoanDuongBayThuocKichBanChienDau(
            maDinhDanhDiemToaDo: null,
            diemToaDoCuongChe: HanhLangBayCoBan.dcs_0_13(khoangCach: 0, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienGiua()).getViTriXuatPhat,
