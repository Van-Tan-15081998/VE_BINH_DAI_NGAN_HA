...
///
class DoiHinh6HLKhoiGGGChieuThuanHanhLangBaySs6 extends MoHinhKichBanBayTheoDoiHinhKhoiTongQuat {
  TocDoCuongCheCoBan? _tocDoCuongCheHanhTrinhCaoNhat;
  TocDoCuongCheCoBan? _tocDoCuongCheHanhTrinhThapNhat;

  DoiHinh6HLKhoiGGGChieuThuanHanhLangBaySs6({
    ...
    if (phuongTien != null) {
      ...
      MoHinhPhuongTienThuocKichBanChienDau phuongTienThuocKichBan = MoHinhPhuongTienThuocKichBanChienDau(
        ...
        danhSachDoanDuongBayThuocKichBan: [
          ...
          MoHinhDoanDuongBayThuocKichBanChienDau(
            maDinhDanhDiemToaDo: null,
            diemToaDoCuongChe: HanhLangBayCoBan.dcs_7_5(khoangCach: 10.0, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienTren()).getViTriXuatPhat,
            maDinhDanhDiemToaDoCauNoiThuNhat: null,
            maDinhDanhDiemToaDoCauNoiThuHai: null,
            diemToaDoCauNoiCuongCheThuNhat: null,
            diemToaDoCauNoiCuongCheThuHai: null,
          ...
          MoHinhDoanDuongBayThuocKichBanChienDau(
            ...
            maDinhDanhDiemToaDoCauNoiThuNhat: null,
            maDinhDanhDiemToaDoCauNoiThuHai: null,
            diemToaDoCauNoiCuongCheThuNhat: HanhLangBayCoBan.dcs_7_5(khoangCach: 0, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienGiua()).getViTriXuatPhat,
            diemToaDoCauNoiCuongCheThuHai: HanhLangBayCoBan.dcs_7_5(khoangCach: 10.0, dinhHuongTaoKhoangCach: DinhHuongTaoKhoangCachCoBan.cachBienDuoi()).getViTriXuatPhat,
