...
class HatVaChamCongKichSS04 extends MoHinhHatVaChamCoBan {
  static const String maDinhDanhHatVaCham = '[HAT_VA_CHAM_CONG_KICH_SS04]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanh(value: '[HIEUUNGVACHAMCONGKICHCLASSSS00ASS010SS040]');

    /// -----
    /// TODO: Cài Đặt Mã Định Danh
    /// -----
    await getThuocTinhTichHop?.caiDatMaDinhDanh(value: HatVaChamCongKichSS04.maDinhDanhHatVaCham);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS01 =
        '${HatVaChamCongKichSS04.constSourcePrefix}/28_def0028/ADef20_0/08_SubDefs/Def26_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_CONG_KICH_SS04_PSS01.png';
