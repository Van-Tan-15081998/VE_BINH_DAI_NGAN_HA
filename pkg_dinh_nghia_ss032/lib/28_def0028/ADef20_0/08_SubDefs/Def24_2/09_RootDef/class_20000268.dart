...
class HatVaChamCongKichSS03 extends MoHinhHatVaChamCoBan {
  static const String maDinhDanhHatVaCham = '[HAT_VA_CHAM_CONG_KICH_SS03]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanh(value: '[HIEUUNGVACHAMCONGKICHCLASSSS00ASS010SS030]');

    /// -----
    /// TODO: Cài Đặt Mã Định Danh
    /// -----
    await getThuocTinhTichHop?.caiDatMaDinhDanh(value: HatVaChamCongKichSS03.maDinhDanhHatVaCham);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    await getThuocTinhSprite?.getDonViSpriteNgoaiHinhHatVaCham?.caiDatChieuRongFrame(value: 200.0);
    await getThuocTinhSprite?.getDonViSpriteNgoaiHinhHatVaCham?.caiDatChieuCaoFrame(value: 200.0);

    /// -----
    /// TODO: Ngoại Hình Hạt Va Chạm Part SS01
    /// -----
    final String nguonSpriteNgoaiHinhHatVaChamPartSS01 =
        '${HatVaChamCongKichSS03.constSourcePrefix}/28_def0028/ADef20_0/08_SubDefs/Def24_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_CONG_KICH_SS03_PSS01.png';
    ...
    await getThuocTinhSprite?.getDonViSpriteNgoaiHinhHatVaChamPartSS01?.caiDatTongSoFrame(value: 16);
    await getThuocTinhSprite?.getDonViSpriteNgoaiHinhHatVaChamPartSS01?.caiDatTongSoFrameTrenHang(value: 4);
    await getThuocTinhSprite?.getDonViSpriteNgoaiHinhHatVaChamPartSS01?.caiDatChieuRongFrame(value: 200.0);
    await getThuocTinhSprite?.getDonViSpriteNgoaiHinhHatVaChamPartSS01?.caiDatChieuCaoFrame(value: 200.0);
