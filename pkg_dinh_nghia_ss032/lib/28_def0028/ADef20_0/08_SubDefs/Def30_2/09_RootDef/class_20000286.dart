...
class HatVaChamCongKichSS06 extends MoHinhHatVaChamCoBan {
  static const String maDinhDanhHatVaCham = '[HAT_VA_CHAM_CONG_KICH_SS06]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanh(value: '[HIEUUNGVACHAMCONGKICHCLASSSS00ASS010SS060]');

    /// -----
    /// TODO: Cài Đặt Mã Định Danh
    /// -----
    await getThuocTinhTichHop?.caiDatMaDinhDanh(value: HatVaChamCongKichSS06.maDinhDanhHatVaCham);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS01 =
        '${HatVaChamCongKichSS06.constSourcePrefix}/28_def0028/ADef20_0/08_SubDefs/Def30_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_CONG_KICH_SS06_PSS01.png';
