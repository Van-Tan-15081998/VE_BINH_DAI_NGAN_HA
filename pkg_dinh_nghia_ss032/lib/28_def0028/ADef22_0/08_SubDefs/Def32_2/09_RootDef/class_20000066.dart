...
class HatVaChamPhaHuySS07 extends MoHinhHatVaChamCoBan {
  static const String maDinhDanhHatVaCham = '[HAT_VA_CHAM_PHA_HUY_SS07]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanh(value: '[HIEUUNGVACHAMPHAHUYCLASSSS00ASS010SS070]');

    /// -----
    /// TODO: Cài Đặt Mã Định Danh
    /// -----
    await getThuocTinhTichHop?.caiDatMaDinhDanh(value: HatVaChamPhaHuySS07.maDinhDanhHatVaCham);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS01 =
        '${HatVaChamPhaHuySS07.constSourcePrefix}/28_def0028/ADef22_0/08_SubDefs/Def32_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_PHA_HUY_SS07_PSS01.png';
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS02 =
        '${HatVaChamPhaHuySS07.constSourcePrefix}/28_def0028/ADef22_0/08_SubDefs/Def32_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_PHA_HUY_SS07_PSS02.png';
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS03 =
        '${HatVaChamPhaHuySS07.constSourcePrefix}/28_def0028/ADef22_0/08_SubDefs/Def32_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_PHA_HUY_SS07_PSS03.png';
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS04 =
        '${HatVaChamPhaHuySS07.constSourcePrefix}/28_def0028/ADef22_0/08_SubDefs/Def32_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_PHA_HUY_SS07_PSS04.png';
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS05 =
        '${HatVaChamPhaHuySS07.constSourcePrefix}/28_def0028/ADef22_0/08_SubDefs/Def32_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_PHA_HUY_SS07_PSS05.png';
    ...
    final String nguonSpriteNgoaiHinhHatVaChamPartSS06 =
        '${HatVaChamPhaHuySS07.constSourcePrefix}/28_def0028/ADef22_0/08_SubDefs/Def32_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def20_8/09_RootDef/'
        'sps_HAT_VA_CHAM_PHA_HUY_SS07_PSS06.png';
