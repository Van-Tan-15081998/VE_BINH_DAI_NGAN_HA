...
/// TODO:
/// -----
class QuanLyTrangThaiDieuKhienDiChuyenKhungHinhNenVatTheMoiTruong with KhungThucThiCoBan, DanhSachQuanLyTrangThai, KichThuocManHinhCoBan {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  Future<void> onSetupRoot() async {
    ...
    /// TODO:
    /// -----
    await caiDatTrangThai(value: TrangThaiBienKhungHinhNenVatTheMoiTruong.onMacDinh());
  ...
  /// TODO:
  /// -----
  TrangThaiBienKhungHinhNenVatTheMoiTruong? _trangThai;
  TrangThaiBienKhungHinhNenVatTheMoiTruong? get getTrangThai => _trangThai;
  Future<void> caiDatTrangThai({required TrangThaiBienKhungHinhNenVatTheMoiTruong? value}) async {
    _trangThai ??= value;
    return;
  }
  ...
  //     ///
  //     /// TODO: Độ lệch biên trái của 'layer điều khiển' không được vượt quá khoảng [ -100; 0]
  ...
  //         (eccentricity * (-1) + (getTrangThai?.getMoHinh?.getBienTraiTangTien ?? 0) > (-100.0))) {
  //       ///
