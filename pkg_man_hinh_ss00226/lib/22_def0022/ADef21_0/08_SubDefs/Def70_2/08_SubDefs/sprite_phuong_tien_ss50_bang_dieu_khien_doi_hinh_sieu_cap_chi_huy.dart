...
/// TODO:
/// -----
class SpritePhuongTienSS50BangDieuKhienDoiHinhSieuCapChiHuy extends SpritePhuongTienCoBan {
  SpritePhuongTienSS50BangDieuKhienDoiHinhSieuCapChiHuy({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSCCH?.getTrangThaiPhuongTienSS050);
