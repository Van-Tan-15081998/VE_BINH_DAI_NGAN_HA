...
/// TODO:
/// -----
class SpritePhuongTienSS20BangDieuKhienDoiHinhSieuCapChiHuy extends SpritePhuongTienCoBan {
  SpritePhuongTienSS20BangDieuKhienDoiHinhSieuCapChiHuy({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSCCH?.getTrangThaiPhuongTienSS020);
