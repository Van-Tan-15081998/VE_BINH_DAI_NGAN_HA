...
/// TODO:
/// -----
class SpritePhuongTienSS26BangDieuKhienDoiHinhSieuCapChiHuy extends SpritePhuongTienCoBan {
  SpritePhuongTienSS26BangDieuKhienDoiHinhSieuCapChiHuy({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSCCH?.getTrangThaiPhuongTienSS026);
