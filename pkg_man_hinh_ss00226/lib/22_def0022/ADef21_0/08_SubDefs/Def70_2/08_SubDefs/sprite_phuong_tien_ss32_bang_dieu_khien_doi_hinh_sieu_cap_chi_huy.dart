...
/// TODO:
/// -----
class SpritePhuongTienSS32BangDieuKhienDoiHinhSieuCapChiHuy extends SpritePhuongTienCoBan {
  SpritePhuongTienSS32BangDieuKhienDoiHinhSieuCapChiHuy({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSCCH?.getTrangThaiPhuongTienSS032);
