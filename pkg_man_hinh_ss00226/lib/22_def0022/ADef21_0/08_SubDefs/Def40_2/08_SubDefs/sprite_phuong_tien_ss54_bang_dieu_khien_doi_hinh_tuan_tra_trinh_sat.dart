...
/// TODO:
/// -----
class SpritePhuongTienSS54BangDieuKhienDoiHinhTuanTraTrinhSat extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhTTTS?.getTrangThaiPhuongTienSS054);
