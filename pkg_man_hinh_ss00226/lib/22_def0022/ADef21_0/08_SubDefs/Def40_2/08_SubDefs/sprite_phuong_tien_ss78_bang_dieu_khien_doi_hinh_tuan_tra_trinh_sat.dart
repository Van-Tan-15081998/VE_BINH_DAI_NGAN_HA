...
/// TODO:
/// -----
class SpritePhuongTienSS78BangDieuKhienDoiHinhTuanTraTrinhSat extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhTTTS?.getTrangThaiPhuongTienSS078);
