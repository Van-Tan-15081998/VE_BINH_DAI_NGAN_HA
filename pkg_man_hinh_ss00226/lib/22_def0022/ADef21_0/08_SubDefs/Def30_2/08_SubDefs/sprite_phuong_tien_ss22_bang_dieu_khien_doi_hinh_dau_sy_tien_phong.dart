...
/// TODO:
/// -----
class SpritePhuongTienSS22BangDieuKhienDoiHinhDauSyTienPhong extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhDSTP?.getTrangThaiPhuongTienSS022);
  ...
  Future<void> onCapNhatPhamViViPham() async {
    ...
    //   Future(() async {
    //     await getTrangThaiTongQuat?.getDichVuMayPhatAmThanh?.getMayPhatAmThanh?.getMayPhatAmThanhHieuUngSS022?.onPlay();
    //   });
    // }
    return;
  }
