...
/// TODO:
/// -----
class SpritePhuongTienSS62BangDieuKhienDoiHinhDauSyTienPhong extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhDSTP?.getTrangThaiPhuongTienSS062);
  ...
  Future<void> onCapNhatPhamViViPham() async {
    ...
    //   Future(() async {
    //     await getTrangThaiTongQuat?.getDichVuMayPhatAmThanh?.getMayPhatAmThanh?.getMayPhatAmThanhHieuUngSS062?.onPlay();
    //   });
    // }
    return;
  }
