...
/// TODO:
/// -----
class SpritePhuongTienSS40BangDieuKhienDoiHinhDauSyTienPhong extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhDSTP?.getTrangThaiPhuongTienSS040);
  ...
  Future<void> onCapNhatPhamViViPham() async {
    ...
    //   Future(() async {
    //     await getTrangThaiTongQuat?.getDichVuMayPhatAmThanh?.getMayPhatAmThanh?.getMayPhatAmThanhHieuUngSS040?.onPlay();
    //   });
    // }
    return;
  }
