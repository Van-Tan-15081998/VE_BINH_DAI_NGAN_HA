...
/// TODO:
/// -----
class SpritePhuongTienSS30BangDieuKhienDoiHinhDauSyTienPhong extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhDSTP?.getTrangThaiPhuongTienSS030);
  ...
  Future<void> onCapNhatPhamViViPham() async {
    ...
    //   Future(() async {
    //     await getTrangThaiTongQuat?.getDichVuMayPhatAmThanh?.getMayPhatAmThanh?.getMayPhatAmThanhHieuUngSS030?.onPlay();
    //   });
    // }
    return;
  }
