...
/// TODO:
/// -----
class SpritePhuongTienSS36BangDieuKhienDoiHinhSatThuTanCong extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSTTC?.getTrangThaiPhuongTienSS036);
