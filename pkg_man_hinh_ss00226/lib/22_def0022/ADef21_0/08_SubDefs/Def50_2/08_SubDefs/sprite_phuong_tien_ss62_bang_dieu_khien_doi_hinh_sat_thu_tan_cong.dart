...
/// TODO:
/// -----
class SpritePhuongTienSS62BangDieuKhienDoiHinhSatThuTanCong extends SpritePhuongTienCoBan {
  SpritePhuongTienSS62BangDieuKhienDoiHinhSatThuTanCong({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSTTC?.getTrangThaiPhuongTienSS062);
