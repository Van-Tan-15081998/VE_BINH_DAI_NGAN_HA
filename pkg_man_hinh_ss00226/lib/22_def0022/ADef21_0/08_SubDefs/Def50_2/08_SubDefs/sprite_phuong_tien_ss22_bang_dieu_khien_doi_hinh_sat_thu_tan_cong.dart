...
/// TODO:
/// -----
class SpritePhuongTienSS22BangDieuKhienDoiHinhSatThuTanCong extends SpritePhuongTienCoBan {
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSTTC?.getTrangThaiPhuongTienSS022);
  ...
  void onVoidThucThiTanCong() async {
    ...
    if (getMoHinh?.getMoHinh?.getDuLieuJsonLamPhang['[DI_CHUYEN_HIEN_THI]'] == true) {
      if (getTrangThaiTongQuat?.getThietLapTongQuat?.onKiemTraChoPhepCapNhatTheoTocDoKhungHinh(
            maDinhDanh: '[PHUONG_TIEN_THUC_THI_TAN_CONG_600]',
