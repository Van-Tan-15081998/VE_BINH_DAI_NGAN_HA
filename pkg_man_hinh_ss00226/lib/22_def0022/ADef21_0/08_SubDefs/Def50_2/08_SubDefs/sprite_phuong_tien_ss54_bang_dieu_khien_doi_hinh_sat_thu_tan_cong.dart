...
/// TODO:
/// -----
class SpritePhuongTienSS54BangDieuKhienDoiHinhSatThuTanCong extends SpritePhuongTienCoBan {
  SpritePhuongTienSS54BangDieuKhienDoiHinhSatThuTanCong({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhSTTC?.getTrangThaiPhuongTienSS054);
