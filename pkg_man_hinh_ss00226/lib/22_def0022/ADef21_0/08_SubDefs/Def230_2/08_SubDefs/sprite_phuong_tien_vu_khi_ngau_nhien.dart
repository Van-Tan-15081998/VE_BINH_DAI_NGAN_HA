...
class SpritePhuongTienVuKhiNgauNhien extends SpritePhuongTienCoBan {
  SpritePhuongTienVuKhiNgauNhien({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  void onVoidCapNhatKiemTraHienThi() async {
    ...
    /// TODO:
    /// -----
    getMoHinh?.getMoHinh?.onKhoiPhucTrangThaiPhuongTienVuKhiNgauNhien();
  }
