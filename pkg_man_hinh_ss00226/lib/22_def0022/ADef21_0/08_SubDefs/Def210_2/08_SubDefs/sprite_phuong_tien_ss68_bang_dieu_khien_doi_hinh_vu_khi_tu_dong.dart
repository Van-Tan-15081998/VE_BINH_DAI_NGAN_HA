...
/// TODO:
/// -----
class SpritePhuongTienSS68BangDieuKhienDoiHinhVuKhiTuDong extends SpritePhuongTienVuKhiTuDong {
  ...
  Future<void> onInitRoot() async {
    ...
    getSpriteMaDinhDanhPhuongTien?.caiDatMaDinhDanh(value: 68);
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhVKTD?.getTrangThaiPhuongTienSS068);
