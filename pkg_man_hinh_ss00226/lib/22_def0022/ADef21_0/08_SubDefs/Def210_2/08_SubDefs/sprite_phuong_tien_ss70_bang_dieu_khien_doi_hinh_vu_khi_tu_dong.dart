...
/// TODO:
/// -----
class SpritePhuongTienSS70BangDieuKhienDoiHinhVuKhiTuDong extends SpritePhuongTienVuKhiTuDong {
  ...
  Future<void> onInitRoot() async {
    ...
    getSpriteMaDinhDanhPhuongTien?.caiDatMaDinhDanh(value: 70);
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhVKTD?.getTrangThaiPhuongTienSS070);
