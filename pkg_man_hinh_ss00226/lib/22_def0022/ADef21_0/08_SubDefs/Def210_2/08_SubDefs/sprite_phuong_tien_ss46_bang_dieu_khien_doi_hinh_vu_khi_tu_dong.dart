...
/// TODO:
/// -----
class SpritePhuongTienSS46BangDieuKhienDoiHinhVuKhiTuDong extends SpritePhuongTienVuKhiTuDong {
  ...
  Future<void> onInitRoot() async {
    ...
    getSpriteMaDinhDanhPhuongTien?.caiDatMaDinhDanh(value: 46);
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhVKTD?.getTrangThaiPhuongTienSS046);
