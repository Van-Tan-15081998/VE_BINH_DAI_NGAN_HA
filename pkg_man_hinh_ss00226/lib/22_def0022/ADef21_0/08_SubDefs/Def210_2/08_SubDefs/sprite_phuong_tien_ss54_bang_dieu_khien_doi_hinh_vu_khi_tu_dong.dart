...
class SpritePhuongTienSS54BangDieuKhienDoiHinhVuKhiTuDong extends SpritePhuongTienVuKhiTuDong {
  ...
  Future<void> onInitRoot() async {
    ...
    getSpriteMaDinhDanhPhuongTien?.caiDatMaDinhDanh(value: 54);
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhVKTD?.getTrangThaiPhuongTienSS054);
