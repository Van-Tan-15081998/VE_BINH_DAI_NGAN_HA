...
/// TODO:
/// -----
class SpritePhuongTienSS42BangDieuKhienDoiHinhVuKhiTuDong extends SpritePhuongTienVuKhiTuDong {
  ...
  Future<void> onInitRoot() async {
    ...
    getSpriteMaDinhDanhPhuongTien?.caiDatMaDinhDanh(value: 42);
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhVKTD?.getTrangThaiPhuongTienSS042);
