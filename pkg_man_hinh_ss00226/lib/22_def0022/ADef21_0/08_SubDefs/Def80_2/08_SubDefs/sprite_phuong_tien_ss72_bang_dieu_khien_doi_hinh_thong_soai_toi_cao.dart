...
/// TODO:
/// -----
class SpritePhuongTienSS72BangDieuKhienDoiHinhThongSoaiToiCao extends SpritePhuongTienThongSoaiToiCao {
  SpritePhuongTienSS72BangDieuKhienDoiHinhThongSoaiToiCao({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhTSTC?.getTrangThaiPhuongTienSS072);
    ...
    if (getMoHinh?.getMoHinh?.getDuLieuJsonLamPhang['[DI_CHUYEN_HIEN_THI]'] == true) {
      if (getMoHinh?.getMoHinh is MOHINHPHUONGTIENCHIHUY) {
        ...
        if ((animationTicker?.currentIndex ?? 0) == 50 && getSanSangThucThiTanCongLienKichSS010 == true) {
          if (getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS10ASS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS20ASS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS30ASS01 || // Thực Thi Đòn Đánh Liên Kích 1
              // getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS40ASS01 || // Thực Thi Tại Frame 75
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS50ASS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS10BSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              // getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS20BSS01 || // Thực Thi Tại Frame 70
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS30BSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS40BSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS50BSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              // getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS10CSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              // getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS20CSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS30CSS01 || // Thực Thi Đòn Đánh Liên Kích 1
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS40CSS01) // Thực Thi Đòn Đánh Liên Kích 1
        ...
        if ((animationTicker?.currentIndex ?? 0) == 70 && getSanSangThucThiTanCongLienKichSS020 == true) {
          if (getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS30BSS01 || // Thực Thi Đòn Đánh Liên Kích 2
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS40CSS01 || // Thực Thi Đòn Đánh Liên Kích 2
              getMoHinh?.getMoHinh is PHUONGTIENCHIHUYCLASS50ASS01) // Thực Thi Đòn Đánh Liên Kích 2
          {
            /// -----
            /// TODO:
            /// -----
