...
/// TODO:
/// -----
class SpritePhuongTienSS42BangDieuKhienDoiHinhQuanDoanCanVe extends SpritePhuongTienCoBan {
  SpritePhuongTienSS42BangDieuKhienDoiHinhQuanDoanCanVe({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhQDCV?.getTrangThaiPhuongTienSS042);
