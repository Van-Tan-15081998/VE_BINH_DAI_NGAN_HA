...
/// TODO:
/// -----
class SpritePhuongTienSS52BangDieuKhienDoiHinhQuanDoanCanVe extends SpritePhuongTienCoBan {
  SpritePhuongTienSS52BangDieuKhienDoiHinhQuanDoanCanVe({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhQDCV?.getTrangThaiPhuongTienSS052);
