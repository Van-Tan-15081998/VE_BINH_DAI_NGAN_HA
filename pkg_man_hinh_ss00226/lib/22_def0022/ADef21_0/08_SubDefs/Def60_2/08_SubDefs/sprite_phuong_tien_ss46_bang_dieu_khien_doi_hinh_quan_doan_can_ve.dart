...
/// TODO:
/// -----
class SpritePhuongTienSS46BangDieuKhienDoiHinhQuanDoanCanVe extends SpritePhuongTienCoBan {
  SpritePhuongTienSS46BangDieuKhienDoiHinhQuanDoanCanVe({required super.trangThaiTongQuat, required super.parentComponent});
  ...
  Future<void> onCaiDatMoHinhChiTiet() async {
    await caiDatMoHinh(value: getTrangThaiTongQuat?.getBangDieuKhienChienDau?.getBangDieuKhienDoiHinhQDCV?.getTrangThaiPhuongTienSS046);
