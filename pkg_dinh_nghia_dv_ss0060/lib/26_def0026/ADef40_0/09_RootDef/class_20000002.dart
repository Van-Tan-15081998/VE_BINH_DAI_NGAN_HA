...
/// -----
class THUOCTINHTHANHTICHCHIENDAUTHEOLICHSU with CauTrucThucThiCoBan {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  Future<void> onSetupRoot() async {
    ...
    /// TODO:
    /// -----
    await caiDatThongTinThanhTich(value: THUOCTINHTHONGTINTHANHTICHTLS(), caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatDieuKienDatThanhTich(value: THUOCTINHDIEUKIENDATTHANHTICHTLS(), caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatPhanThuongDatThanhTich(value: THUOCTINHPHANTHUONGDATTHANHTICHTLS(), caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatTrangThaiSoHuuPhanThuong(value: TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTLS(), caiDatUuTien: true);
  ...
  /// -----
  THUOCTINHTHONGTINTHANHTICHTLS? _thongTinThanhTich;
  THUOCTINHTHONGTINTHANHTICHTLS? get getThongTinThanhTich => _thongTinThanhTich;
  Future<void> caiDatThongTinThanhTich({required THUOCTINHTHONGTINTHANHTICHTLS? value, bool? caiDatUuTien}) async {
  ...
  /// -----
  THUOCTINHDIEUKIENDATTHANHTICHTLS? _dieuKienDatThanhTich;
  THUOCTINHDIEUKIENDATTHANHTICHTLS? get getDieuKienDatThanhTich => _dieuKienDatThanhTich;
  Future<void> caiDatDieuKienDatThanhTich({required THUOCTINHDIEUKIENDATTHANHTICHTLS? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  /// -----
  THUOCTINHPHANTHUONGDATTHANHTICHTLS? _phanThuongDatThanhTich;
  THUOCTINHPHANTHUONGDATTHANHTICHTLS? get getPhanThuongDatThanhTich => _phanThuongDatThanhTich;
  Future<void> caiDatPhanThuongDatThanhTich({required THUOCTINHPHANTHUONGDATTHANHTICHTLS? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  /// -----
  TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTLS? _trangThaiSoHuuPhanThuong;
  TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTLS? get getTrangThaiSoHuuPhanThuong => _trangThaiSoHuuPhanThuong;
  Future<void> caiDatTrangThaiSoHuuPhanThuong({required TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTLS? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
