...
/// -----
class THUOCTINHTHANHTICHCHIENDAUTHEONHIEMVU with CauTrucThucThiCoBan {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  Future<void> onSetupRoot() async {
    ...
    /// TODO:
    /// -----
    await caiDatThongTinThanhTich(value: THUOCTINHTHONGTINTHANHTICHTNV(), caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatDieuKienDatThanhTich(value: THUOCTINHDIEUKIENDATTHANHTICHTNV(), caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatPhanThuongDatThanhTich(value: THUOCTINHPHANTHUONGDATTHANHTICHTNV(), caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatTrangThaiSoHuuPhanThuong(value: TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTNV(), caiDatUuTien: true);
  ...
  /// -----
  THUOCTINHTHONGTINTHANHTICHTNV? _thongTinThanhTich;
  THUOCTINHTHONGTINTHANHTICHTNV? get getThongTinThanhTich => _thongTinThanhTich;
  Future<void> caiDatThongTinThanhTich({required THUOCTINHTHONGTINTHANHTICHTNV? value, bool? caiDatUuTien}) async {
  ...
  /// -----
  THUOCTINHDIEUKIENDATTHANHTICHTNV? _dieuKienDatThanhTich;
  THUOCTINHDIEUKIENDATTHANHTICHTNV? get getDieuKienDatThanhTich => _dieuKienDatThanhTich;
  Future<void> caiDatDieuKienDatThanhTich({required THUOCTINHDIEUKIENDATTHANHTICHTNV? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  /// -----
  THUOCTINHPHANTHUONGDATTHANHTICHTNV? _phanThuongDatThanhTich;
  THUOCTINHPHANTHUONGDATTHANHTICHTNV? get getPhanThuongDatThanhTich => _phanThuongDatThanhTich;
  Future<void> caiDatPhanThuongDatThanhTich({required THUOCTINHPHANTHUONGDATTHANHTICHTNV? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  /// -----
  TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTNV? _trangThaiSoHuuPhanThuong;
  TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTNV? get getTrangThaiSoHuuPhanThuong => _trangThaiSoHuuPhanThuong;
  Future<void> caiDatTrangThaiSoHuuPhanThuong({required TRANGTHAISOHUUPHANTHUONGDATTHANHTICHTNV? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
