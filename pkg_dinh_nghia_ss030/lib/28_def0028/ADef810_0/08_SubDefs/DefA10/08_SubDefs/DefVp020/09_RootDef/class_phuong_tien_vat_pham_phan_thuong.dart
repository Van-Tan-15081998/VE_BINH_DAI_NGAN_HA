import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef810_0/08_SubDefs/DefA10/08_SubDefs/DefVp020/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef810_0/08_SubDefs/DefA10/08_SubDefs/DefVp020/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef810_0/08_SubDefs/DefA10/08_SubDefs/DefVp020/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef810_0/08_SubDefs/DefA10/08_SubDefs/DefVp020/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENVATPHAMPHANTHUONGCLASS10ASS010VPSS020 extends MOHINHPHUONGTIENVATPHAMPHANTHUONG {
  PHUONGTIENVATPHAMPHANTHUONGCLASS10ASS010VPSS020({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '[VATPHAMPHANTHUONGCLASSSS00ASS010SS030]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENVATPHAMPHANTHUONGCLASS10ASS010VPSS020(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENVATPHAMPHANTHUONGCLASS10ASS010VPSS020(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENVATPHAMPHANTHUONGCLASS10ASS010VPSS020(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENVATPHAMPHANTHUONGCLASS10ASS010VPSS020(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef810_0/08_SubDefs/DefA10/08_SubDefs/DefVp020/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
