import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefA50/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20020680.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefA50/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20020682.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefA50/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20020686.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefA50/08_SubDefs/Def22/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20020688.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTANCONGCLASS50ASS02 extends MOHINHPHUONGTIENTANCONG {
  PHUONGTIENTANCONGCLASS50ASS02({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[MONSTERSTTCCLASSSS00ASS050SS020]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTANCONGCLASS50ASS02(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTANCONGCLASS50ASS02(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTANCONGCLASS50ASS02(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTANCONGCLASS50ASS02(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef22_0/08_SubDefs/DefA50/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
