import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB30/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20020628.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB30/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20020660.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB30/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20020662.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB30/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20020666.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTANCONGCLASS30BSS01 extends MOHINHPHUONGTIENTANCONG {
  PHUONGTIENTANCONGCLASS30BSS01({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '${MOHINHPHUONGTIENTANCONG.class30B}.[CLASS_50A_SS01]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanhLopPhuongTien(value: MOHINHPHUONGTIENTANCONG.class30B);
    await caiDatMaDinhDanhPhuongTien(value: maDinhDanhPhuongTien);

    /// -----
    /// TODO: Cài Đặt Kích Thước
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTANCONGCLASS30BSS01(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTANCONGCLASS30BSS01(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTANCONGCLASS30BSS01(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTANCONGCLASS30BSS01(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef22_0/08_SubDefs/DefB30/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
