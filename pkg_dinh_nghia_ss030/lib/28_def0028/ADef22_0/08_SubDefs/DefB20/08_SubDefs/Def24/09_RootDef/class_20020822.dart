import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20020802.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20020806.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20020808.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef22_0/08_SubDefs/DefB20/08_SubDefs/Def24/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20020820.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTANCONGCLASS20BSS03 extends MOHINHPHUONGTIENTANCONG {
  PHUONGTIENTANCONGCLASS20BSS03({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '[MONSTERSTTCCLASSSS00ASS070SS030]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTANCONGCLASS20BSS03(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTANCONGCLASS20BSS03(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTANCONGCLASS20BSS03(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTANCONGCLASS20BSS03(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef22_0/08_SubDefs/DefB20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
