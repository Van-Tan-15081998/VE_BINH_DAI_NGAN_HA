...
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB20/08_SubDefs/DefVk040/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENVUKHICHIHUYCLASS20BSS010VKSS040 extends MOHINHPHUONGTIENVUKHIDIEUKHIEN {
  PHUONGTIENVUKHICHIHUYCLASS20BSS010VKSS040({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[VUKHIMONSTERTSTCCLASSSS00ASS070SS010SS040]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENVUKHICHIHUYCLASS20BSS010VKSS040(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENVUKHICHIHUYCLASS20BSS010VKSS040(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENVUKHICHIHUYCLASS20BSS010VKSS040(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENVUKHICHIHUYCLASS20BSS010VKSS040(), caiDatUuTien: true);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final double chieuRongFrame = 240.0;
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef26_0/08_SubDefs/DefB20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
