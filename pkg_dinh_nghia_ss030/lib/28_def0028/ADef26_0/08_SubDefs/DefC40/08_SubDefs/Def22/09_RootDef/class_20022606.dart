import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20022622.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20022680.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20022620.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20022608.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENCHIHUYCLASS40CSS02 extends MOHINHPHUONGTIENCHIHUY {
  PHUONGTIENCHIHUYCLASS40CSS02({super.capDo, super.phuongTienThongSoaiToiCao});
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENCHIHUYCLASS40CSS02(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENCHIHUYCLASS40CSS02(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENCHIHUYCLASS40CSS02(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENCHIHUYCLASS40CSS02(), caiDatUuTien: true);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteNgoaiHinhThan =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef26_0/08_SubDefs/DefA10/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_CHIHUYCLASS40CSS02.png';
