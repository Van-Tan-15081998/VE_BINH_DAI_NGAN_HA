...
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB10/08_SubDefs/DefVk010/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB10/08_SubDefs/DefVk010/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB10/08_SubDefs/DefVk010/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefB10/08_SubDefs/DefVk010/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENVUKHICHIHUYCLASS10BSS010VKSS010 extends MOHINHPHUONGTIENVUKHI {
  PHUONGTIENVUKHICHIHUYCLASS10BSS010VKSS010({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[VUKHIMONSTERTSTCCLASSSS00ASS060SS010SS010]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENVUKHICHIHUYCLASS10BSS010VKSS010(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENVUKHICHIHUYCLASS10BSS010VKSS010(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENVUKHICHIHUYCLASS10BSS010VKSS010(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENVUKHICHIHUYCLASS10BSS010VKSS010(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef26_0/08_SubDefs/DefB10/08_SubDefs/DefVk010/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
