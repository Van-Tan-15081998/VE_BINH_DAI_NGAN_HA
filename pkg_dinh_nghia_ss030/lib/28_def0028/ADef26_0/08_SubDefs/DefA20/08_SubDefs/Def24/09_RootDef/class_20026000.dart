import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefA20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20022880.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefA20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20022882.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefA20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20022886.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef26_0/08_SubDefs/DefA20/08_SubDefs/Def24/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20022888.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENCHIHUYCLASS20ASS03 extends MOHINHPHUONGTIENCHIHUY {
  PHUONGTIENCHIHUYCLASS20ASS03({super.capDo, super.phuongTienThongSoaiToiCao});
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENCHIHUYCLASS20ASS03(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENCHIHUYCLASS20ASS03(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENCHIHUYCLASS20ASS03(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENCHIHUYCLASS20ASS03(), caiDatUuTien: true);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteNgoaiHinhThan =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef26_0/08_SubDefs/DefA20/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_CHIHUYCLASS20ASS03.png';
