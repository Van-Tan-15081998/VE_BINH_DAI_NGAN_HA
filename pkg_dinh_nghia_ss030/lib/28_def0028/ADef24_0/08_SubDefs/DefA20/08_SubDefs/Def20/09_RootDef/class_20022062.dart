import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20022022.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20022026.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20022028.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA20/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20022060.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENHOVECLASS20ASS01 extends MOHINHPHUONGTIENHOVE {
  PHUONGTIENHOVECLASS20ASS01({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '${MOHINHPHUONGTIENHOVE.class20A}.[CLASS_20A_SS01]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanhLopPhuongTien(value: MOHINHPHUONGTIENHOVE.class20A);
    await caiDatMaDinhDanhPhuongTien(value: maDinhDanhPhuongTien);

    /// -----
    /// TODO: Cài Đặt Kích Thước
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENHOVECLASS20ASS01(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENHOVECLASS20ASS01(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENHOVECLASS20ASS01(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENHOVECLASS20ASS01(), caiDatUuTien: true);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteNgoaiHinhThan =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef24_0/08_SubDefs/DefA20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/09_RootDef/sprite_sheet_HOVECLASS20ASS01.png';
