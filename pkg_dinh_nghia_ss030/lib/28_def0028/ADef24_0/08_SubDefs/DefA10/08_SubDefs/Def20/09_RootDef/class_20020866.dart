import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA10/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20020826.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA10/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20020828.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA10/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20020860.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef24_0/08_SubDefs/DefA10/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20020862.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENHOVECLASS10ASS01 extends MOHINHPHUONGTIENHOVE {
  PHUONGTIENHOVECLASS10ASS01({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '[MONSTERDSTPCLASSSS00ASS010SS010]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanhLopPhuongTien(value: MOHINHPHUONGTIENHOVE.class10A);
    await caiDatMaDinhDanhPhuongTien(value: maDinhDanhPhuongTien);

    /// -----
    /// TODO: Cài Đặt Kích Thước
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENHOVECLASS10ASS01(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENHOVECLASS10ASS01(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENHOVECLASS10ASS01(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENHOVECLASS10ASS01(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef24_0/08_SubDefs/DefA10/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
