import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefC10/08_SubDefs/DefVk020/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefC10/08_SubDefs/DefVk020/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefC10/08_SubDefs/DefVk020/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefC10/08_SubDefs/DefVk020/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENVUKHICLASS10CSS010VKSS020 extends MOHINHPHUONGTIENVUKHINGAUNHIEN {
  PHUONGTIENVUKHICLASS10CSS010VKSS020({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '[VUKHIMONSTERCLASSSS00ASS110SS020]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENVUKHICLASS10CSS010VKSS020(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENVUKHICLASS10CSS010VKSS020(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENVUKHICLASS10CSS010VKSS020(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENVUKHICLASS10CSS010VKSS020(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef210_0/08_SubDefs/DefC10/08_SubDefs/DefVk020/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
