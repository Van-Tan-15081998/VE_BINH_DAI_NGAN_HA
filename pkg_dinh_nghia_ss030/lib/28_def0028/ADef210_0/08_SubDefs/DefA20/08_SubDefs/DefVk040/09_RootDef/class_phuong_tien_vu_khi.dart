import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefA20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefA20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefA20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef210_0/08_SubDefs/DefA20/08_SubDefs/DefVk040/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20000000.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENVUKHICLASS20ASS010VKSS040 extends MOHINHPHUONGTIENVUKHINGAUNHIEN {
  PHUONGTIENVUKHICLASS20ASS010VKSS040({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '[VUKHIMONSTERCLASSSS00ASS020SS040]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENVUKHICLASS20ASS010VKSS040(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENVUKHICLASS20ASS010VKSS040(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENVUKHICLASS20ASS010VKSS040(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENVUKHICLASS20ASS010VKSS040(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef210_0/08_SubDefs/DefA20/08_SubDefs/DefVk040/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
