import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC10/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20006666.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC10/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20006668.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC10/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20006680.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC10/08_SubDefs/Def24/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20006682.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTRINHSATCLASS10CSS03 extends MOHINHPHUONGTIENTRINHSAT {
  PHUONGTIENTRINHSATCLASS10CSS03({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[MONSTERTTTSCLASSSS00ASS110SS030]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanhLopPhuongTien(value: MOHINHPHUONGTIENTRINHSAT.class10C);
    await caiDatMaDinhDanhPhuongTien(value: maDinhDanhPhuongTien);

    /// -----
    /// TODO: Cài Đặt Kích Thước
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTRINHSATCLASS10CSS03(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTRINHSATCLASS10CSS03(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTRINHSATCLASS10CSS03(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTRINHSATCLASS10CSS03(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef20_0/08_SubDefs/DefC10/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
