import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB50/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20006202.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB50/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20006206.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB50/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20006208.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB50/08_SubDefs/Def20/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20006220.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTRINHSATCLASS50BSS01 extends MOHINHPHUONGTIENTRINHSAT {
  PHUONGTIENTRINHSATCLASS50BSS01({super.capDo, super.phuongTienThongSoaiToiCao});
  
  ///
  static const String maDinhDanhPhuongTien = '[MONSTERTTTSCLASSSS00ASS100SS010]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTRINHSATCLASS50BSS01(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTRINHSATCLASS50BSS01(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTRINHSATCLASS50BSS01(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTRINHSATCLASS50BSS01(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef20_0/08_SubDefs/DefB50/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
