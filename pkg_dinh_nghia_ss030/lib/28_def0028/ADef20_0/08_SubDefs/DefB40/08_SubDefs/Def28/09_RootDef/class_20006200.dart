import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB40/08_SubDefs/Def28/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20006080.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB40/08_SubDefs/Def28/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20006082.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB40/08_SubDefs/Def28/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20006086.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefB40/08_SubDefs/Def28/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20006088.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTRINHSATCLASS40BSS05 extends MOHINHPHUONGTIENTRINHSAT {
  PHUONGTIENTRINHSATCLASS40BSS05({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[MONSTERTTTSCLASSSS00ASS090SS050]';
  ...
  Future<void> onSetupRoot() async {
    ...
    await caiDatMaDinhDanhLopPhuongTien(value: MOHINHPHUONGTIENTRINHSAT.class40B);
    await caiDatMaDinhDanhPhuongTien(value: maDinhDanhPhuongTien);

    /// -----
    /// TODO: Cài Đặt Kích Thước
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTRINHSATCLASS40BSS05(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTRINHSATCLASS40BSS05(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTRINHSATCLASS40BSS05(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTRINHSATCLASS40BSS05(), caiDatUuTien: true);
  ...
  Future<void> onInitThuocTinhSprite() async {
    ...
    final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef20_0/08_SubDefs/DefB40/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS01?.caiDatNguonHinhAnhToiUuKichThuocRS100(value: nguonSpriteNgoaiHinhThanPhuongTienRS100PartSS01);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS01?.caiDatNguonHinhAnhToiUuKichThuocRS025(value: nguonSpriteNgoaiHinhThanPhuongTienRS025PartSS01);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS01?.caiDatNguonHinhAnhToiUuKichThuocRS050(value: nguonSpriteNgoaiHinhThanPhuongTienRS050PartSS01);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS02?.caiDatNguonHinhAnhToiUuKichThuocRS100(value: nguonSpriteNgoaiHinhThanPhuongTienRS100PartSS02);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS02?.caiDatNguonHinhAnhToiUuKichThuocRS025(value: nguonSpriteNgoaiHinhThanPhuongTienRS025PartSS02);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS02?.caiDatNguonHinhAnhToiUuKichThuocRS050(value: nguonSpriteNgoaiHinhThanPhuongTienRS050PartSS02);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS03?.caiDatNguonHinhAnhToiUuKichThuocRS100(value: nguonSpriteNgoaiHinhThanPhuongTienRS100PartSS03);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS03?.caiDatNguonHinhAnhToiUuKichThuocRS025(value: nguonSpriteNgoaiHinhThanPhuongTienRS025PartSS03);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS03?.caiDatNguonHinhAnhToiUuKichThuocRS050(value: nguonSpriteNgoaiHinhThanPhuongTienRS050PartSS03);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS04?.caiDatNguonHinhAnhToiUuKichThuocRS100(value: nguonSpriteNgoaiHinhThanPhuongTienRS100PartSS04);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS04?.caiDatNguonHinhAnhToiUuKichThuocRS025(value: nguonSpriteNgoaiHinhThanPhuongTienRS025PartSS04);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS04?.caiDatNguonHinhAnhToiUuKichThuocRS050(value: nguonSpriteNgoaiHinhThanPhuongTienRS050PartSS04);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS05?.caiDatNguonHinhAnhToiUuKichThuocRS100(value: nguonSpriteNgoaiHinhThanPhuongTienRS100PartSS05);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS05?.caiDatNguonHinhAnhToiUuKichThuocRS025(value: nguonSpriteNgoaiHinhThanPhuongTienRS025PartSS05);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS05?.caiDatNguonHinhAnhToiUuKichThuocRS050(value: nguonSpriteNgoaiHinhThanPhuongTienRS050PartSS05);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS06?.caiDatNguonHinhAnhToiUuKichThuocRS100(value: nguonSpriteNgoaiHinhThanPhuongTienRS100PartSS06);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS06?.caiDatNguonHinhAnhToiUuKichThuocRS025(value: nguonSpriteNgoaiHinhThanPhuongTienRS025PartSS06);
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteNgoaiHinhThanPhuongTienPartSS06?.caiDatNguonHinhAnhToiUuKichThuocRS050(value: nguonSpriteNgoaiHinhThanPhuongTienRS050PartSS06);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteVuKhiTanCongThongMinhXSS01?.caiDatNguonHinhAnh(value: nguonSpriteVuKhiTanCongThongMinhXSS01);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteVuKhiTanCongThongMinhXSS02?.caiDatNguonHinhAnh(value: nguonSpriteVuKhiTanCongThongMinhXSS02);
    ...
    await getThuocTinh?.getThuocTinhSprite?.getDonViSpriteVuKhiTanCongThongMinhXSS03?.caiDatNguonHinhAnh(value: nguonSpriteVuKhiTanCongThongMinhXSS03);
