import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefA40/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20002002.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefA40/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20002006.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefA40/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20002008.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefA40/08_SubDefs/Def24/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20002020.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTRINHSATCLASS40ASS03 extends MOHINHPHUONGTIENTRINHSAT {
  PHUONGTIENTRINHSATCLASS40ASS03({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[MONSTERTTTSCLASSSS00ASS040SS030]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTRINHSATCLASS40ASS03(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTRINHSATCLASS40ASS03(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTRINHSATCLASS40ASS03(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTRINHSATCLASS40ASS03(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef20_0/08_SubDefs/DefA40/08_SubDefs/Def24/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
