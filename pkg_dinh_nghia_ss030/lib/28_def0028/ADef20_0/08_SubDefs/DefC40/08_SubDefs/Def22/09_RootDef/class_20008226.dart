import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def22/09_RootDef/class_20008206.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def24/08_SubDefs/Def20/09_RootDef/class_20008208.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def26/08_SubDefs/Def20/09_RootDef/class_20008220.dart';
import 'package:pkg_dinh_nghia_ss030/28_def0028/ADef20_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def22/08_SubDefs/Def20/09_RootDef/class_20008222.dart';
import 'package:pkg_dinh_nghia_ss030/pkg_dinh_nghia_ss030_exp.dart';

/// -----
/// TODO:
/// -----
class PHUONGTIENTRINHSATCLASS40CSS02 extends MOHINHPHUONGTIENTRINHSAT {
  PHUONGTIENTRINHSATCLASS40CSS02({super.capDo, super.phuongTienThongSoaiToiCao});

  ///
  static const String maDinhDanhPhuongTien = '[MONSTERTTTSCLASSSS00ASS140SS020]';
  ...
  Future<void> onSetupRoot() async {
    ...
    /// -----
    await getThuocTinh?.caiDatThuocTinhKichThuoc(value: KICHTHUOCPHUONGTIENTRINHSATCLASS40CSS02(), caiDatUuTien: true);

    /// -----
    /// TODO: Cài Đặt Cấp Độ Giáp
    /// -----
    await getThuocTinh?.getThuocTinhPhongThu?.caiDatCapDoGiap(value: CAPDOGIAPPHUONGTIENPHUONGTIENTRINHSATCLASS40CSS02(), caiDatUuTien: true);
    await getThuocTinh?.getThuocTinhPhongThu?.onSetupRoot();

    /// -----
    /// TODO: Cài Đặt Cấp Độ Máu
    /// -----
    await getThuocTinh?.getThuocTinhSinhTon?.caiDatCapDoMau(value: CAPDOMAUPHUONGTIENTRINHSATCLASS40CSS02(), caiDatUuTien: true);
    ...
    /// -----
    await getPhuongThuc?.caiDatPhuongThucBay(value: PHUONGTHUCBAYPHUONGTIENTRINHSATCLASS40CSS02(), caiDatUuTien: true);
...
final String nguonSpriteDongKhoi =
        'packages/pkg_dinh_nghia_ss030/lib/28_def0028/ADef20_0/08_SubDefs/DefC40/08_SubDefs/Def22/08_SubDefs/Def20/08_SubDefs/Def20/08_SubDefs';
