...
/// -----
/// TODO: Máy Phát Âm Thanh V3
/// -----
class MAYPHATAMTHANHV3 with CauTrucThucThiCoBan {
  ...
  Future<void> onSetupRoot() async {
    await caiDatMayPhatAmThanh(value: AudioPlayer());
  ...
  MAYPHATAMTHANHV3({required String maDinhDanh}) {
    ...
    if (getNguonAmThanh?.isNotEmpty == true) {
      if (await getTrangThaiSanSangPhatAmThanh?.isChuanBiPhatAmThanh() == true) {
        try {
          ...
          /// TODO: Work OK
          await getMayPhatAmThanh?.setAsset('../$getNguonAmThanh');
          await getMayPhatAmThanh?.play();
          if (kDebugMode) {
