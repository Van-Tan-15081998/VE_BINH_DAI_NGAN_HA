...
import 'package:pkg_khung_man_hinh_ss022110/pkg_khung_man_hinh_ss022110_exp.dart';
import 'package:pkg_khung_man_hinh_ss022120/pkg_khung_man_hinh_ss022120_exp.dart';
import 'package:pkg_khung_man_hinh_ss022130/pkg_khung_man_hinh_ss022130_exp.dart';
...
class QUANLYTHANHPHANMANHINHTHUOCCAP
  ...
  /// TODO:
  /// -----
  KHUNGMANHINHTABSS010THUOCCAPTABSS010CH? _khungManHinhTabSS010;
  KHUNGMANHINHTABSS010THUOCCAPTABSS010CH? get getKhungManHinhTabSS010 =>
      _khungManHinhTabSS010;
  Future<void> onCaiDatKhungManHinhTabSS010({
    required KHUNGMANHINHTABSS010THUOCCAPTABSS010CH? value,
    bool? caiDatUuTien,
  }) async {
  ...
  /// TODO:
  /// -----
  KHUNGMANHINHTABSS020THUOCCAPTABSS010CH? _khungManHinhTabSS020;
  KHUNGMANHINHTABSS020THUOCCAPTABSS010CH? get getKhungManHinhTabSS020 =>
      _khungManHinhTabSS020;
  Future<void> onCaiDatKhungManHinhTabSS020({
    required KHUNGMANHINHTABSS020THUOCCAPTABSS010CH? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  /// TODO:
  /// -----
  KHUNGMANHINHTABSS030THUOCCAPTABSS010CH? _khungManHinhTabSS030;
  KHUNGMANHINHTABSS030THUOCCAPTABSS010CH? get getKhungManHinhTabSS030 =>
      _khungManHinhTabSS030;
  Future<void> onCaiDatKhungManHinhTabSS030({
    required KHUNGMANHINHTABSS030THUOCCAPTABSS010CH? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  Future<void> onSetupRootForSubCom() async {
    ...
    await Future.wait([
      onCaiDatKhungManHinhTabSS010(
        value: KHUNGMANHINHTABSS010THUOCCAPTABSS010CH(
      ...
      onCaiDatKhungManHinhTabSS020(
        value: KHUNGMANHINHTABSS020THUOCCAPTABSS010CH(
          globalState: getGlobalState,
          gameController: getGameController,
          thanhPhanQuanLyThuocCapTrucTiep: getThanhPhanQuanLyThuocCapTrucTiep,
          sizeDx: sizeDxKhungManHinhTab,
      ...
      onCaiDatKhungManHinhTabSS030(
        value: KHUNGMANHINHTABSS030THUOCCAPTABSS010CH(
          globalState: getGlobalState,
          gameController: getGameController,
          thanhPhanQuanLyThuocCapTrucTiep: getThanhPhanQuanLyThuocCapTrucTiep,
          sizeDx: sizeDxKhungManHinhTab,
