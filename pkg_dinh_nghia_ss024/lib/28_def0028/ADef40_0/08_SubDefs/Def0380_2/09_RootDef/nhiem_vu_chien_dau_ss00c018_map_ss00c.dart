...
/// -----
/// TODO: Nhiệm Vụ Chiến Đấu SS00C018 MAP SS00C
/// -----
class NHIEMVUCHIENDAUSS00C018MAPSS00C extends NHIEMVUCHIENDAUCOBAN {
  /// -----
  /// TODO: Setup Root
  /// -----
  @override
  Future<void> onSetupRoot() async {
    ...
    /// TODO:
    /// -----
    await caiDatMaDinhDanh(value: NHIEMVUCHIENDAUCOBAN.constKhoaBanGhiDuLieuNhiemVuChienDauSS00C018MAPSS00C, caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatKichBanChienDau(value: KICHBANCHIENDAUTHEOGIAIDOANSTAGESS00C018MAPSS00C(), caiDatUuTien: true);
  ...
  Future<void> onInitRootForSubCom() async {
    ...
    await getThanhTichNhiemVuChienDau?.onCaiDatKhoaBanGhiDuLieu(
      value: THANHTICHNHIEMVUCHIENDAUCOBAN.constKhoaBanGhiDuLieuNhiemVuChienDauSS00C018MAPSS00C,
      caiDatUuTien: true,
    );
    ...
    await getKhoaTruyCapNhiemVuChienDau?.onCaiDatKhoaBanGhiDuLieu(
      value: KHOATRUYCAPNHIEMVUCHIENDAUCOBAN.constKhoaBanGhiDuLieuNhiemVuChienDauSS00C018MAPSS00C,
      caiDatUuTien: true,
    );
