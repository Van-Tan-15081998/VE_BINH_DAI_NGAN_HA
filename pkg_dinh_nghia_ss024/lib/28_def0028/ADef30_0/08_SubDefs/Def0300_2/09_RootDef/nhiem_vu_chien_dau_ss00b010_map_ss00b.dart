...
/// -----
/// TODO: Nhiệm Vụ Chiến Đấu SS00B010 MAP SS00B
/// -----
class NHIEMVUCHIENDAUSS00B010MAPSS00B extends NHIEMVUCHIENDAUCOBAN {
  /// -----
  /// TODO: Setup Root
  /// -----
  @override
  Future<void> onSetupRoot() async {
    ...
    /// TODO:
    /// -----
    await caiDatMaDinhDanh(value: NHIEMVUCHIENDAUCOBAN.constKhoaBanGhiDuLieuNhiemVuChienDauSS00B010MAPSS00B, caiDatUuTien: true);

    /// -----
    /// TODO:
    /// -----
    await caiDatKichBanChienDau(value: KICHBANCHIENDAUTHEOGIAIDOANSTAGESS00B010MAPSS00B(), caiDatUuTien: true);
  ...
  Future<void> onInitRootForSubCom() async {
    ...
    await getThanhTichNhiemVuChienDau?.onCaiDatKhoaBanGhiDuLieu(
      value: THANHTICHNHIEMVUCHIENDAUCOBAN.constKhoaBanGhiDuLieuNhiemVuChienDauSS00B010MAPSS00B,
      caiDatUuTien: true,
    );
    ...
    await getKhoaTruyCapNhiemVuChienDau?.onCaiDatKhoaBanGhiDuLieu(
      value: KHOATRUYCAPNHIEMVUCHIENDAUCOBAN.constKhoaBanGhiDuLieuNhiemVuChienDauSS00B010MAPSS00B,
      caiDatUuTien: true,
    );
