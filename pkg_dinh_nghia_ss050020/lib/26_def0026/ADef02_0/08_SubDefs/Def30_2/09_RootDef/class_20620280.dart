...
/// -----
abstract class KICHBANCHIENDAUTICHHOPDOIHINHTHEOGIAIDOANCOBAN
  ...
  Future<void> onAttachRootForSubCom({required dynamic attachValue}) async {
    ...
    /// TODO:
    /// -----
     getKichBanChienDauTheoDoiHinhThuocGiaiDoan?.onAttachRoot(
      attachValue: attachValue,
    ).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),

    /// -----
    /// TODO:
    /// -----
     getBangDieuKhienGiaiDoanThuocKichBan?.onAttachRoot(
      attachValue: attachValue,
    ).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
  ...
  Future<void> onTichHopThanhPhan() async {
    ...
    await Future.wait([
      getBangDieuKhienDoiHinhDSTP
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhDSTP,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
      ...
      getBangDieuKhienDoiHinhTTTS
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhTTTS,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhSTTC
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhSTTC,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhQDCV
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhQDCV,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhSCCH
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhSCCH,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhTSTC
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhTSTC,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKTD
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhVKTD,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKDK
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhVKDK,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKNN
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhVKNN,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVPTC
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhVPTC,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVPPT
              ?.caiDatBangDieuKhienGiaiDoanThuocDoiHinh(
                value:
                    getBangDieuKhienGiaiDoanThuocKichBan
                        ?.getBangDieuKhienGiaiDoanThuocDoiHinhVPPT,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ...
    await Future.wait([
      getBangDieuKhienDoiHinhDSTP
              ?.caiDatKichBan(
                value: getKichBanChienDauTheoDoiHinhThuocGiaiDoan,
                caiDatUuTien: true,
              )
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ...
    /// -----
    await Future.wait([
      getBangDieuKhienDoiHinhDSTP?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhTTTS?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhSTTC?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhQDCV?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhSCCH?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhTSTC?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),

      getBangDieuKhienDoiHinhVKTD?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKDK?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKNN?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),

      getBangDieuKhienDoiHinhVPTC?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVPPT?.onTichHopDoiHinhPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
    ]);
    ...
    /// -----
    await Future.wait([
      getBangDieuKhienDoiHinhDSTP?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhTTTS?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhSTTC?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhQDCV?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhSCCH?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhTSTC?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),

      getBangDieuKhienDoiHinhVKTD?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKDK?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVKNN?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
          ) ??
          onReportRootIssue(nameFunction: ''),

      getBangDieuKhienDoiHinhVPTC?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
      ) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhVPPT?.onTichHopKichBanPhuongTien().catchError(
            (e) => null,
      ) ??
          onReportRootIssue(nameFunction: ''),
    ]);
    ...
    await Future.wait([
      getBangDieuKhienDoiHinhDSTP
              ?.onKichHoatHoatDongChienDauXamChiemThuocGiaiDoanSS010()
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getBangDieuKhienDoiHinhTTTS
              ?.onKichHoatHoatDongChienDauXamChiemThuocGiaiDoanSS010()
    ...
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhDSTP?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhTTTS?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhSTTC?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhQDCV?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhSCCH?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhTSTC?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );

    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhVKTD?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhVKDK?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhVKNN?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );

    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhVPTC?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    getDanhSachMaDinhDanhPhuongTien.addAll(
      getBangDieuKhienDoiHinhVPPT?.getDanhSachMaDinhDanhPhuongTien ?? [],
    );
    ...
    List<String> danhSach =
        getDanhSachMaDinhDanhPhuongTien
            .where(
              (String maDinhDanh) => danhSachMaDinhDanhDuyNhat.add(maDinhDanh),
            )
            .toList();
  ...
  List<String> get getDanhSachMaDinhDanhPhuongTien =>
      _danhSachMaDinhDanhPhuongTien;

  /// -----
  /// TODO: Bảng Điều Khiển Giai Đoạn Thuộc Kịch Bản
  /// -----
  BANGDIEUKHIENGIAIDOANTHUOCKICHBANCOBAN? _bangDieuKhienGiaiDoanThuocKichBan;
  BANGDIEUKHIENGIAIDOANTHUOCKICHBANCOBAN?
  get getBangDieuKhienGiaiDoanThuocKichBan =>
      _bangDieuKhienGiaiDoanThuocKichBan;
  Future<void> caiDatBangDieuKhienGiaiDoanThuocKichBan({
    required BANGDIEUKHIENGIAIDOANTHUOCKICHBANCOBAN? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHDAUSYTIENPHONG? get getBangDieuKhienDoiHinhDSTP =>
      _bangDieuKhienDoiHinhDSTP;
  Future<void> caiDatBangDieuKhienDoiHinhDSTP({
    required BANGDIEUKHIENDOIHINHDAUSYTIENPHONG? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHTUANTRATRINHSAT? get getBangDieuKhienDoiHinhTTTS =>
      _bangDieuKhienDoiHinhTTTS;
  Future<void> caiDatBangDieuKhienDoiHinhTTTS({
    required BANGDIEUKHIENDOIHINHTUANTRATRINHSAT? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHSATTHUTANCONG? get getBangDieuKhienDoiHinhSTTC =>
      _bangDieuKhienDoiHinhSTTC;
  Future<void> caiDatBangDieuKhienDoiHinhSTTC({
    required BANGDIEUKHIENDOIHINHSATTHUTANCONG? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHQUANDOANCANVE? get getBangDieuKhienDoiHinhQDCV =>
      _bangDieuKhienDoiHinhQDCV;
  Future<void> caiDatBangDieuKhienDoiHinhQDCV({
    required BANGDIEUKHIENDOIHINHQUANDOANCANVE? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHSIEUCAPCHIHUY? get getBangDieuKhienDoiHinhSCCH =>
      _bangDieuKhienDoiHinhSCCH;
  Future<void> caiDatBangDieuKhienDoiHinhSCCH({
    required BANGDIEUKHIENDOIHINHSIEUCAPCHIHUY? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHTHONGSOAITOICAO? get getBangDieuKhienDoiHinhTSTC =>
      _bangDieuKhienDoiHinhTSTC;
  Future<void> caiDatBangDieuKhienDoiHinhTSTC({
    required BANGDIEUKHIENDOIHINHTHONGSOAITOICAO? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHVUKHITUDONG? get getBangDieuKhienDoiHinhVKTD =>
      _bangDieuKhienDoiHinhVKTD;
  Future<void> caiDatBangDieuKhienDoiHinhVKTD({
    required BANGDIEUKHIENDOIHINHVUKHITUDONG? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHVUKHIDIEUKHIEN? get getBangDieuKhienDoiHinhVKDK =>
      _bangDieuKhienDoiHinhVKDK;
  Future<void> caiDatBangDieuKhienDoiHinhVKDK({
    required BANGDIEUKHIENDOIHINHVUKHIDIEUKHIEN? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHVUKHINGAUNHIEN? get getBangDieuKhienDoiHinhVKNN =>
      _bangDieuKhienDoiHinhVKNN;
  Future<void> caiDatBangDieuKhienDoiHinhVKNN({
    required BANGDIEUKHIENDOIHINHVUKHINGAUNHIEN? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHVATPHAMTANGCUONG? get getBangDieuKhienDoiHinhVPTC =>
      _bangDieuKhienDoiHinhVPTC;
  Future<void> caiDatBangDieuKhienDoiHinhVPTC({
    required BANGDIEUKHIENDOIHINHVATPHAMTANGCUONG? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  BANGDIEUKHIENDOIHINHVATPHAMPHANTHUONG? get getBangDieuKhienDoiHinhVPPT =>
      _bangDieuKhienDoiHinhVPPT;
  Future<void> caiDatBangDieuKhienDoiHinhVPPT({
    required BANGDIEUKHIENDOIHINHVATPHAMPHANTHUONG? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  /// -----
  KICHBANCHIENDAUTHEODOIHINHTHUOCGIAIDOANCOBAN?
  _kichBanChienDauTheoDoiHinhThuocGiaiDoan;
  KICHBANCHIENDAUTHEODOIHINHTHUOCGIAIDOANCOBAN?
  get getKichBanChienDauTheoDoiHinhThuocGiaiDoan =>
      _kichBanChienDauTheoDoiHinhThuocGiaiDoan;
  Future<void> caiDatKichBanChienDauTheoDoiHinhThuocGiaiDoan({
    required KICHBANCHIENDAUTHEODOIHINHTHUOCGIAIDOANCOBAN? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
