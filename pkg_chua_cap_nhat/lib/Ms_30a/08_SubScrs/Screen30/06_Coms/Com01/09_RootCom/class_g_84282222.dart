...
class NutBamTrienKhaiChienDau extends StatefulWidget {
  const NutBamTrienKhaiChienDau({super.key});

  @override
  State<NutBamTrienKhaiChienDau> createState() => _NutBamTrienKhaiChienDauState();
}

class _NutBamTrienKhaiChienDauState extends State<NutBamTrienKhaiChienDau> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;

  String nguonHinhAnh =
      'packages/pkg_chua_cap_nhat/assets/images/01_Man_Hinh/Screen05/08_SubComs/Com01/08_SubComs/Com01/08_SubComs/Com01/08_SubComs/Com03/hinh_anh_nut_bam_trien_khai_chien_dau.png';

  double chieuRongNutBamGioiHan = 160.0;
  double chieuCaoNutBamGioiHan = 80.0;
