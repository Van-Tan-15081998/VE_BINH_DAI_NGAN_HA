...
class KhungHinhTheHangarChienDauCoSSS10SS04 extends StatefulWidget {
  const KhungHinhTheHangarChienDauCoSSS10SS04({
    super.key,
  ...
  @override
  State<KhungHinhTheHangarChienDauCoSSS10SS04> createState() =>
      _KhungHinhTheHangarChienDauCoState();
}

class _KhungHinhTheHangarChienDauCoState
    extends State<KhungHinhTheHangarChienDauCoSSS10SS04> {
  String nguonHinhAnh =
      'packages/pkg_chua_cap_nhat/assets/images/01_Man_Hinh/Screen03/08_SubComs/Com02/08_SubComs/Com01/08_SubComs/Com08/08_SubComs/Com04/hinh_anh_khung_nen_the_chien_binh_SSS10SS04.png';
