...
class KhungHinhTheThongTinChienDauCo00S08SS01 extends StatefulWidget {
  const KhungHinhTheThongTinChienDauCo00S08SS01({
    super.key,
  ...
  @override
  State<KhungHinhTheThongTinChienDauCo00S08SS01> createState() =>
      _KhungHinhTheThongTinChienDauCoState();
}

class _KhungHinhTheThongTinChienDauCoState
    extends State<KhungHinhTheThongTinChienDauCo00S08SS01> {
  String nguonHinhAnh =
      'assets/images/Ms_30a/08_SubScrs/Screen20/08_SubScrs/Screen10/06_Coms/Com12/08_SubComs/Com10/08_SubComs/Com60/08_SubComs/Com10/hinh_anh_khung_hinh_the_thong_tin_00S08SS01.png';
