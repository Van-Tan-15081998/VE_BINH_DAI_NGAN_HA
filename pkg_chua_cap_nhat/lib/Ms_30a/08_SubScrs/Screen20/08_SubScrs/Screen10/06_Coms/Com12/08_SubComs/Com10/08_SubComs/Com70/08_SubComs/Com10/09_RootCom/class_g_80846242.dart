...
class KhungHinhTheThongTinChienDauCo0SS09SS01 extends StatefulWidget {
  const KhungHinhTheThongTinChienDauCo0SS09SS01({
    super.key,
  ...
  @override
  State<KhungHinhTheThongTinChienDauCo0SS09SS01> createState() =>
      _KhungHinhTheThongTinChienDauCoState();
}

class _KhungHinhTheThongTinChienDauCoState
    extends State<KhungHinhTheThongTinChienDauCo0SS09SS01> {
  String nguonHinhAnh =
      'assets/images/Ms_30a/08_SubScrs/Screen20/08_SubScrs/Screen10/06_Coms/Com12/08_SubComs/Com10/08_SubComs/Com70/08_SubComs/Com10/hinh_anh_khung_hinh_the_thong_tin_0SS09SS01.png';
