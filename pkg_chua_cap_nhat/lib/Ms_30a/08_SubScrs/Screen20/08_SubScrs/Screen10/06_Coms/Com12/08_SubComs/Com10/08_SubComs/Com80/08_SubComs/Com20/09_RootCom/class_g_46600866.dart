...
class KhungHinhTheThongTinChienDauCoSSS10SS02 extends StatefulWidget {
  const KhungHinhTheThongTinChienDauCoSSS10SS02({
    super.key,
  ...
  @override
  State<KhungHinhTheThongTinChienDauCoSSS10SS02> createState() =>
      _KhungHinhTheThongTinChienDauCoState();
}

class _KhungHinhTheThongTinChienDauCoState
    extends State<KhungHinhTheThongTinChienDauCoSSS10SS02> {
  String nguonHinhAnh =
      'assets/images/Ms_30a/08_SubScrs/Screen20/08_SubScrs/Screen10/06_Coms/Com12/08_SubComs/Com10/08_SubComs/Com80/08_SubComs/Com20/hinh_anh_khung_hinh_the_thong_tin_SSS10SS02.png';
