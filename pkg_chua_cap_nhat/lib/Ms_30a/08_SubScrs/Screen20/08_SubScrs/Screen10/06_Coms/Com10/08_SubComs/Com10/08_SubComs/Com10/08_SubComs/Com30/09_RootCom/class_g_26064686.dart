...
class KhungHinhTheHangarChienDauCo00E03SS03 extends StatefulWidget {
  const KhungHinhTheHangarChienDauCo00E03SS03({
    super.key,
  ...
  @override
  State<KhungHinhTheHangarChienDauCo00E03SS03> createState() =>
      _KhungHinhTheHangarChienDauCoState();
}

class _KhungHinhTheHangarChienDauCoState
    extends State<KhungHinhTheHangarChienDauCo00E03SS03> {
  String nguonHinhAnh =
      'packages/pkg_chua_cap_nhat/assets/images/01_Man_Hinh/Screen03/08_SubComs/Com02/08_SubComs/Com01/08_SubComs/Com01/08_SubComs/Com03/hinh_anh_khung_nen_the_chien_binh_00E03SS03.png';
