...
class KhungHinhTheHangarChienDauCo0SS09SS02 extends StatefulWidget {
  const KhungHinhTheHangarChienDauCo0SS09SS02({
    super.key,
  ...
  @override
  State<KhungHinhTheHangarChienDauCo0SS09SS02> createState() =>
      _KhungHinhTheHangarChienDauCoState();
}

class _KhungHinhTheHangarChienDauCoState
    extends State<KhungHinhTheHangarChienDauCo0SS09SS02> {
  String nguonHinhAnh =
      'packages/pkg_chua_cap_nhat/assets/images/01_Man_Hinh/Screen03/08_SubComs/Com02/08_SubComs/Com01/08_SubComs/Com07/08_SubComs/Com02/hinh_anh_khung_nen_the_chien_binh_0SS09SS02.png';
