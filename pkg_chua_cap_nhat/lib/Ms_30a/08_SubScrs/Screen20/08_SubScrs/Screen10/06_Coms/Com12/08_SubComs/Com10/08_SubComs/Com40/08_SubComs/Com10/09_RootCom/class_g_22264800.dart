...
class KhungHinhTheThongTinChienDauCo00B06SS01 extends StatefulWidget {
  const KhungHinhTheThongTinChienDauCo00B06SS01({
    super.key,
  ...
  @override
  State<KhungHinhTheThongTinChienDauCo00B06SS01> createState() =>
      _KhungHinhTheThongTinChienDauCoState();
}

class _KhungHinhTheThongTinChienDauCoState
    extends State<KhungHinhTheThongTinChienDauCo00B06SS01> {
  String nguonHinhAnh =
      'assets/images/Ms_30a/08_SubScrs/Screen20/08_SubScrs/Screen10/06_Coms/Com12/08_SubComs/Com10/08_SubComs/Com40/08_SubComs/Com10/hinh_anh_khung_hinh_the_thong_tin_00B06SS01.png';
