...
class KhungHinhTheHangarChienDauCo00A07SS01 extends StatefulWidget {
  const KhungHinhTheHangarChienDauCo00A07SS01({
    super.key,
  ...
  @override
  State<KhungHinhTheHangarChienDauCo00A07SS01> createState() =>
      _KhungHinhTheHangarChienDauCoState();
}

class _KhungHinhTheHangarChienDauCoState
    extends State<KhungHinhTheHangarChienDauCo00A07SS01> {
  String nguonHinhAnh =
      'packages/pkg_chua_cap_nhat/assets/images/01_Man_Hinh/Screen03/08_SubComs/Com02/08_SubComs/Com01/08_SubComs/Com05/08_SubComs/Com01/hinh_anh_khung_nen_the_chien_binh_00A07SS01.png';
