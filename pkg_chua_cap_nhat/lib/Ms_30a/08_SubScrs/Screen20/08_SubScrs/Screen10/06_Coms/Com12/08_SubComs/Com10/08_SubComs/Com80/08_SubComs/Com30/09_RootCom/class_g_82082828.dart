...
class KhungHinhTheThongTinChienDauCoSSS10SS03 extends StatefulWidget {
  const KhungHinhTheThongTinChienDauCoSSS10SS03({
    super.key,
  ...
  @override
  State<KhungHinhTheThongTinChienDauCoSSS10SS03> createState() =>
      _KhungHinhTheThongTinChienDauCoState();
}

class _KhungHinhTheThongTinChienDauCoState
    extends State<KhungHinhTheThongTinChienDauCoSSS10SS03> {
  String nguonHinhAnh =
      'assets/images/Ms_30a/08_SubScrs/Screen20/08_SubScrs/Screen10/06_Coms/Com12/08_SubComs/Com10/08_SubComs/Com80/08_SubComs/Com30/hinh_anh_khung_hinh_the_thong_tin_SSS10SS03.png';
