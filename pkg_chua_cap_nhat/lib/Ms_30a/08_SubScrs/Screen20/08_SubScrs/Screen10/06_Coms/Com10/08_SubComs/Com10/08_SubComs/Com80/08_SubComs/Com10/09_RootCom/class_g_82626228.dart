...
class KhungHinhTheHangarChienDauCoSSS10SS01 extends StatefulWidget {
  const KhungHinhTheHangarChienDauCoSSS10SS01({
    super.key,
  ...
  @override
  State<KhungHinhTheHangarChienDauCoSSS10SS01> createState() =>
      _KhungHinhTheHangarChienDauCoState();
}

class _KhungHinhTheHangarChienDauCoState
    extends State<KhungHinhTheHangarChienDauCoSSS10SS01> {
  String nguonHinhAnh =
      'packages/pkg_chua_cap_nhat/assets/images/01_Man_Hinh/Screen03/08_SubComs/Com02/08_SubComs/Com01/08_SubComs/Com08/08_SubComs/Com01/hinh_anh_khung_nen_the_chien_binh_SSS10SS01.png';
