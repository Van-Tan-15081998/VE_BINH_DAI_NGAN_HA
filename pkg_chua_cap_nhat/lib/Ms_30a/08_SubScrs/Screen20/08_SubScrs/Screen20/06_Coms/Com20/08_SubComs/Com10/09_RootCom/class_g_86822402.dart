...
class NutBamChuyenChonTraiB extends StatefulWidget {
  const NutBamChuyenChonTraiB({super.key, required this.onThucThi});

  final VoidCallback? onThucThi;

  @override
  State<NutBamChuyenChonTraiB> createState() => _NutBamChuyenChonTraiBState();
}

class _NutBamChuyenChonTraiBState extends State<NutBamChuyenChonTraiB> {
  String nguonHinhAnh =
      'assets/images/01_Man_Hinh/Screen05/08_SubComs/Com01/08_SubComs/Com01/08_SubComs/Com01/08_SubComs/Com04/hinh_anh_nut_bam_chuyen_chon_trai.png';
