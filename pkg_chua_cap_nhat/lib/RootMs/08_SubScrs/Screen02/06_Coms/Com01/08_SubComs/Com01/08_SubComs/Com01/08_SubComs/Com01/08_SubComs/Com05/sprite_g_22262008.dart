...
class SpriteNutBamChuyenManHinhChucNangCapMotSS05 extends SpriteAnimationComponent {
  SpriteNutBamChuyenManHinhChucNangCapMotSS05();
  ...
  FutureOr<void> update(double dt) async {
    ...
    if (_kiemTraXuLyHoatAnh == false) {
      ...
      if (animation == null) {
        ...
        images
            .load(
                'packages/pkg_chua_cap_nhat/assets/images/RootMd/0002_TruyCap_1/00005_TruyCap_2/000001_TruyCap_3/0000001_TruyCap_4/00000001_TruyCap_5/000000001_TruyCap_6/R000000000_TruyCap_7/nut_bam.png')
