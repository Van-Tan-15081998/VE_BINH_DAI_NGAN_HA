...
class NutBamChuyenChonPhaiB extends StatefulWidget {
  const NutBamChuyenChonPhaiB({super.key, required this.onThucThi});

  final VoidCallback? onThucThi;

  @override
  State<NutBamChuyenChonPhaiB> createState() => _NutBamChuyenChonPhaiBState();
}

class _NutBamChuyenChonPhaiBState extends State<NutBamChuyenChonPhaiB> {
  String nguonHinhAnh =
