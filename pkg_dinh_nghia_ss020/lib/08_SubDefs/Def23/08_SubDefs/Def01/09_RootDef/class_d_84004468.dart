...
class HeSoTangGiamTocDoCoBan {
  ...
  HeSoTangGiamTocDoCoBan.onMacDinh() {
    caiDatTangGiamToc(value: null);
  }

  HeSoTangGiamTocDoCoBan.tangToc({required int capDo}) {
    caiDatTangGiamToc(value: '[TANG_TOC]');
    caiDatCapDoTangGiamToc(value: capDo);
  }

  HeSoTangGiamTocDoCoBan.giamToc({required int capDo}) {
