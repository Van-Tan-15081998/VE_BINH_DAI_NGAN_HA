...
class DinhHuongBayCoBan {
  ...
  static const String constDinhHuongTheoTraiSangPhaiViTriXuatPhatNguyenBanChienDauCo =
      '[DINH_HUONG_THEO_TRAI_SANG_PHAI_VI_TRI_XUAT_PHAT_NGUYEN_BAN_CHIEN_DAU_CO]';
  static const String constDinhHuongTheoPhaiSangTraiViTriXuatPhatNguyenBanChienDauCo =
      '[DINH_HUONG_THEO_PHAI_SANG_TRAI_VI_TRI_XUAT_PHAT_NGUYEN_BAN_CHIEN_DAU_CO]';
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTrenXuongDuoi() {
    caiDatDinhHuong(value: '[DINH_HUONG_THEO_TREN_XUONG_DUOI]');
  }
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTrenXuongDuoiLechTrai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTrenXuongDuoiLechPhai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoDuoiLenTren() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTraiSangPhai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhaiSangTrai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTrenTraiSangDuoiPhai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoDuoiTraiSangTrenPhai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTrenPhaiSangDuoiTrai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoDuoiPhaiSangTrenTrai() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoChiSoTangTien() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoDoanDuongBayThuocKichBan() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoDoanDuongBayThuocLichSuBay() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoViTriChienDauCoGiaiDoanBanHanhTrinh() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoViTriXuatPhatNguyenBanChienDauCo() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoViTriChienDauChienDauCo() {
  ...
  /// -----
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoTraiSangPhaiViTriXuatPhatNguyenBanChienDauCo() {
  ...
  /// -----
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhaiSangTraiViTriXuatPhatNguyenBanChienDauCo() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs01() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs02() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs03() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs04() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs05() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs06() {
  ...
  /// -----v
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs07() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs08() {
  ...
  /// TODO: Định Hướng Theo Phương Thức X Siêu Cấp SS06
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs09() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoPhuongThucXSieuCapSs10() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoViTriPhuongTienLayMucTieu() {
  ...
  /// -----
  DinhHuongBayCoBan.dinhHuongTheoQuanTinhLichSuDiChuyen() {
