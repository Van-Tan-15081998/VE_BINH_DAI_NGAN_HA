...
/// -----
abstract class THANHPHANNUTBAMTICHHOPTHUOCCAP extends PositionComponent
  ...
  /// TODO:
  /// -----
  THANHPHANNUTBAMTICHHOPTHUOCCAP({
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIKichHoat => _thanhPhanGameUIKichHoat;
  Future<void> onCaiDatThanhPhanGameUIKichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIKichHoat2 => _thanhPhanGameUIKichHoat2;
  Future<void> onCaiDatThanhPhanGameUIKichHoat2({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIHuyKichHoat => _thanhPhanGameUIHuyKichHoat;
  Future<void> onCaiDatThanhPhanGameUIHuyKichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentThanhTichSS020KichHoat => _spriteAnimationComponentThanhTichSS020KichHoat;
  Future<void> onCaiDatSpriteAnimationComponentThanhTichSS020KichHoat({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentThanhTichSS030KichHoat => _spriteAnimationComponentThanhTichSS030KichHoat;
  Future<void> onCaiDatSpriteAnimationComponentThanhTichSS030KichHoat({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? _spriteAnimationComponentThanhTichSS010HuyKichHoat;
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentThanhTichSS010HuyKichHoat => _spriteAnimationComponentThanhTichSS010HuyKichHoat;
  Future<void> onCaiDatSpriteAnimationComponentThanhTichSS010HuyKichHoat({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? _spriteAnimationComponentThanhTichSS020HuyKichHoat;
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentThanhTichSS020HuyKichHoat => _spriteAnimationComponentThanhTichSS020HuyKichHoat;
  Future<void> onCaiDatSpriteAnimationComponentThanhTichSS020HuyKichHoat({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? _spriteAnimationComponentThanhTichSS030HuyKichHoat;
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentThanhTichSS030HuyKichHoat => _spriteAnimationComponentThanhTichSS030HuyKichHoat;
  Future<void> onCaiDatSpriteAnimationComponentThanhTichSS030HuyKichHoat({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIThanhTichSS010KichHoat => _thanhPhanGameUIThanhTichSS010KichHoat;
  Future<void> onCaiDatThanhPhanGameUIThanhTichSS010KichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIThanhTichSS020KichHoat => _thanhPhanGameUIThanhTichSS020KichHoat;
  Future<void> onCaiDatThanhPhanGameUIThanhTichSS020KichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIThanhTichSS030KichHoat => _thanhPhanGameUIThanhTichSS030KichHoat;
  Future<void> onCaiDatThanhPhanGameUIThanhTichSS030KichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIThanhTichSS010HuyKichHoat => _thanhPhanGameUIThanhTichSS010HuyKichHoat;
  Future<void> onCaiDatThanhPhanGameUIThanhTichSS010HuyKichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIThanhTichSS020HuyKichHoat => _thanhPhanGameUIThanhTichSS020HuyKichHoat;
  Future<void> onCaiDatThanhPhanGameUIThanhTichSS020HuyKichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  THANHPHANGAMEUICOBAN? get getThanhPhanGameUIThanhTichSS030HuyKichHoat => _thanhPhanGameUIThanhTichSS030HuyKichHoat;
  Future<void> onCaiDatThanhPhanGameUIThanhTichSS030HuyKichHoat({required THANHPHANGAMEUICOBAN? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentOnLayerSS01 => _spriteAnimationComponentOnLayerSS01;
  Future<void> onCaiDatSpriteAnimationComponentOnLayerSS01({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentOnLayerSS02 => _spriteAnimationComponentOnLayerSS02;
  Future<void> onCaiDatSpriteAnimationComponentOnLayerSS02({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentOnLayerSS03 => _spriteAnimationComponentOnLayerSS03;
  Future<void> onCaiDatSpriteAnimationComponentOnLayerSS03({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentOnLayerSS04 => _spriteAnimationComponentOnLayerSS04;
  Future<void> onCaiDatSpriteAnimationComponentOnLayerSS04({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  SPRITEANIMATIONHASVISIBILITY? get getSpriteAnimationComponentOnLayerSS05 => _spriteAnimationComponentOnLayerSS05;
  Future<void> onCaiDatSpriteAnimationComponentOnLayerSS05({required SPRITEANIMATIONHASVISIBILITY? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
  ...
  Future<void> onCapNhatChiTietThanhPhanGameUI() async {
    await Future.wait([
      getSpriteAnimationComponentKichHoat?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIKichHoat, caiDatUuTien: true).catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentKichHoat2?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIKichHoat2, caiDatUuTien: true).catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentHuyKichHoat?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIHuyKichHoat, caiDatUuTien: true).catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),

      ///
      getSpriteAnimationComponentThanhTichSS010KichHoat?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIThanhTichSS010KichHoat, caiDatUuTien: true).catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentThanhTichSS020KichHoat?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIThanhTichSS020KichHoat, caiDatUuTien: true).catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentThanhTichSS030KichHoat?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIThanhTichSS030KichHoat, caiDatUuTien: true).catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentThanhTichSS010HuyKichHoat
              ?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIThanhTichSS010HuyKichHoat, caiDatUuTien: true)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentThanhTichSS020HuyKichHoat
              ?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIThanhTichSS020HuyKichHoat, caiDatUuTien: true)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
      getSpriteAnimationComponentThanhTichSS030HuyKichHoat
              ?.onCaiDatThanhPhanGameUI(value: getThanhPhanGameUIThanhTichSS030HuyKichHoat, caiDatUuTien: true)
              .catchError((e) => null) ??
          onReportRootIssue(nameFunction: ''),
    ]);
  }

  Future<void> onRemoveThanhPhanKhongHoatDong() async {

    // getSpriteAnimationComponentOnLayerSS01?.removeFromParent();
    getSpriteAnimationComponentOnLayerSS02?.removeFromParent();
    getSpriteAnimationComponentOnLayerSS03?.removeFromParent();
    getSpriteAnimationComponentOnLayerSS04?.removeFromParent();
    getSpriteAnimationComponentOnLayerSS05?.removeFromParent();

    getSpriteAnimationComponentThanhTichSS010KichHoat?.removeFromParent();
    getSpriteAnimationComponentThanhTichSS020KichHoat?.removeFromParent();
    getSpriteAnimationComponentThanhTichSS030KichHoat?.removeFromParent();
    getSpriteAnimationComponentThanhTichSS010HuyKichHoat?.removeFromParent();
    getSpriteAnimationComponentThanhTichSS020HuyKichHoat?.removeFromParent();
    getSpriteAnimationComponentThanhTichSS030HuyKichHoat?.removeFromParent();
