...
abstract class THANHPHANMANHINHTHUOCCAPCOBAN extends PositionComponent with CAUTRUCTHUCTHICOBAN, KICHBANDIEUKHIENTHUOCCAPCOBAN {
  ...
  Future<void> onAddRoot({required FlameGame? flameGame, required Component? component}) async {
    ...
    // await Future.wait([
    //   getQuanLyThanhPhanHinhAnhThuocCap?.onAddRoot(flameGame: flameGame, component: this).catchError((e) => null) ?? onReportRootIssue(nameFunction: 'onAddRoot'),
    //   getQuanLyThanhPhanManHinhThuocCap?.onAddRoot(flameGame: flameGame, component: this).catchError((e) => null) ?? onReportRootIssue(nameFunction: 'onAddRoot'),
    //   getQuanLyThanhPhanNutBamThuocCap?.onAddRoot(flameGame: flameGame, component: this).catchError((e) => null) ?? onReportRootIssue(nameFunction: 'onAddRoot'),
    //   getQuanLyThanhPhanVanBanThuocCap?.onAddRoot(flameGame: flameGame, component: this).catchError((e) => null) ?? onReportRootIssue(nameFunction: 'onAddRoot'),
    //   getQuanLyThanhPhanTichHopThuocCap?.onAddRoot(flameGame: flameGame, component: this).catchError((e) => null) ?? onReportRootIssue(nameFunction: 'onAddRoot'),
    // ]);
