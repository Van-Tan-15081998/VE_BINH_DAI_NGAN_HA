...
/// TODO: [GAMEUI]
///
class GAMEUINUTBAMCHIENDAUNGANCHANXAMNHAP extends CoreGameUIComponent {
  static const String maDinhDanhGameUI = '[GAMEUI]_[GAMEUINUTBAMCHIENDAUNGANCHANXAMNHAP]';
  ...
  Future<void> onInitSpriteGameUI() async {
    ...
    final double chieuCaoFrame = 98.0;
    await Future.wait([
    ...
    /// -----
    final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss022/lib/28_def0028/ADef400_0/08_SubDefs/Def240_2';
