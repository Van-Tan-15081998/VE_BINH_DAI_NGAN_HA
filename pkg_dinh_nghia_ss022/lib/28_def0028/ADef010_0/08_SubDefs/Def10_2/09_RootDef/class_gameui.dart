...
///
/// TODO: [GAMEUI] Thành Phần Game UI Sprite Animation Mặc Định
///
class GAMEUISPRITEANIMATIONMACDINH extends CoreGameUIComponent {
  static const String maDinhDanhGameUI = '[GAMEUI]_[GAMEUISPRITEANIMATIONMACDINH]';
  ...
  Future<void> onInitSpriteGameUI() async {
    ...
    final double chieuRongFrame = 483.0;
    final double chieuCaoFrame = 290.0;
    await Future.wait([
    ...
    /// -----
    final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss022/lib/28_def0028/ADef010_0/08_SubDefs/Def10_2';
