...
/// -----
class KHUNGTHANHPHANNUTBAMCHONTABTHUVIEN extends StatefulWidget {
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNUTBAMCHONTABTHUVIEN({super.key, required this.chieuRongKhungThanhPhan, required this.chieuCaoKhungThanhPhan, required this.trangThaiTongQuat, required this.onThucThi});

  @override
  State<KHUNGTHANHPHANNUTBAMCHONTABTHUVIEN> createState() => KHUNGTHANHPHANNUTBAMCHONTABTHUVIENSTATE();
}

class KHUNGTHANHPHANNUTBAMCHONTABTHUVIENSTATE extends State<KHUNGTHANHPHANNUTBAMCHONTABTHUVIEN> {
  /// -----
  /// TODO:
  /// -----
  ...
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHUVIEN? _gameWidget;
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHUVIEN? get getGameWidget => _gameWidget;
  ...
  Widget build(BuildContext context) {
    _gameWidget = FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHUVIEN(
...
class FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHUVIEN extends FlameGame {
  @override
  ...
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHUVIEN({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongFlameGameUI, required this.chieuCaoFlameGameUI}) {
  ...
  SPRITEGAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT? _thanhPhanGameUIKhongKichHoat;
  SPRITEGAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT? get getThanhPhanGameUIKhongKichHoat => _thanhPhanGameUIKhongKichHoat;

  SPRITEGAMEUINUTBAMCHONTABTHUVIENKICHHOAT? _thanhPhanGameUIKichHoat;
  SPRITEGAMEUINUTBAMCHONTABTHUVIENKICHHOAT? get getThanhPhanGameUIKichHoat => _thanhPhanGameUIKichHoat;

  @override
  FutureOr<void> onLoad() async {
    _thanhPhanGameUIKhongKichHoat = SPRITEGAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT(
      chieuRongSpriteGameUI: chieuRongFlameGameUI,
      chieuCaoSpriteGameUI: chieuCaoFlameGameUI,
      trangThaiTongQuat: getTrangThaiTongQuat,
    );
    _thanhPhanGameUIKichHoat = SPRITEGAMEUINUTBAMCHONTABTHUVIENKICHHOAT(
      chieuRongSpriteGameUI: chieuRongFlameGameUI,
      chieuCaoSpriteGameUI: chieuCaoFlameGameUI,
      trangThaiTongQuat: getTrangThaiTongQuat,
    );
...
/// TODO:
/// -----
class SPRITEGAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;

  SPRITEGAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongSpriteGameUI, required this.chieuCaoSpriteGameUI}) {
    onVoidCaiDatTrangThaiTongQuat(value: trangThaiTongQuat);
  }

  GAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT? _thanhPhanGameUI;
  GAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT? get getThanhPhanGameUI => _thanhPhanGameUI;
  ...
  FutureOr<void> onLoad() async {
    ...
    _thanhPhanGameUI = GAMEUINUTBAMCHONTABTHUVIENKHONGKICHHOAT();
...
/// TODO:
/// -----
class SPRITEGAMEUINUTBAMCHONTABTHUVIENKICHHOAT extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;

  SPRITEGAMEUINUTBAMCHONTABTHUVIENKICHHOAT({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongSpriteGameUI, required this.chieuCaoSpriteGameUI}) {
    onVoidCaiDatTrangThaiTongQuat(value: trangThaiTongQuat);
  }

  GAMEUINUTBAMCHONTABTHUVIENKICHHOAT? _thanhPhanGameUI;
  GAMEUINUTBAMCHONTABTHUVIENKICHHOAT? get getThanhPhanGameUI => _thanhPhanGameUI;
  ...
  FutureOr<void> onLoad() async {
    ...
    _thanhPhanGameUI = GAMEUINUTBAMCHONTABTHUVIENKICHHOAT();
    await _thanhPhanGameUI?.onSetupRoot();
    await _thanhPhanGameUI?.onInitRoot();
