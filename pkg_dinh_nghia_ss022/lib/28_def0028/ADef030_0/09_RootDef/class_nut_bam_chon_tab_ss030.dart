...
/// -----
class KHUNGTHANHPHANNUTBAMCHONTABCHIENDAU extends StatefulWidget {
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNUTBAMCHONTABCHIENDAU({super.key, required this.chieuRongKhungThanhPhan, required this.chieuCaoKhungThanhPhan, required this.trangThaiTongQuat, required this.onThucThi});

  @override
  State<KHUNGTHANHPHANNUTBAMCHONTABCHIENDAU> createState() => KHUNGTHANHPHANNUTBAMCHONTABCHIENDAUSTATE();
}

class KHUNGTHANHPHANNUTBAMCHONTABCHIENDAUSTATE extends State<KHUNGTHANHPHANNUTBAMCHONTABCHIENDAU> {
  /// -----
  /// TODO:
  /// -----
  ...
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABCHIENDAU? _gameWidget;
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABCHIENDAU? get getGameWidget => _gameWidget;
  ...
  Widget build(BuildContext context) {
    _gameWidget = FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABCHIENDAU(
...
class FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABCHIENDAU extends FlameGame {
  @override
  ...
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABCHIENDAU({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongFlameGameUI, required this.chieuCaoFlameGameUI}) {
  ...
  SPRITEGAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT? _thanhPhanGameUIKhongKichHoat;
  SPRITEGAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT? get getThanhPhanGameUIKhongKichHoat => _thanhPhanGameUIKhongKichHoat;

  SPRITEGAMEUINUTBAMCHONTABCHIENDAUKICHHOAT? _thanhPhanGameUIKichHoat;
  SPRITEGAMEUINUTBAMCHONTABCHIENDAUKICHHOAT? get getThanhPhanGameUIKichHoat => _thanhPhanGameUIKichHoat;

  @override
  FutureOr<void> onLoad() async {
    _thanhPhanGameUIKhongKichHoat = SPRITEGAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT(
      chieuRongSpriteGameUI: chieuRongFlameGameUI,
      chieuCaoSpriteGameUI: chieuCaoFlameGameUI,
      trangThaiTongQuat: getTrangThaiTongQuat,
    );
    _thanhPhanGameUIKichHoat = SPRITEGAMEUINUTBAMCHONTABCHIENDAUKICHHOAT(
      chieuRongSpriteGameUI: chieuRongFlameGameUI,
      chieuCaoSpriteGameUI: chieuCaoFlameGameUI,
      trangThaiTongQuat: getTrangThaiTongQuat,
    );
...
/// TODO:
/// -----
class SPRITEGAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;

  SPRITEGAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongSpriteGameUI, required this.chieuCaoSpriteGameUI}) {
    onVoidCaiDatTrangThaiTongQuat(value: trangThaiTongQuat);
  }

  GAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT? _thanhPhanGameUI;
  GAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT? get getThanhPhanGameUI => _thanhPhanGameUI;
  ...
  FutureOr<void> onLoad() async {
    ...
    _thanhPhanGameUI = GAMEUINUTBAMCHONTABCHIENDAUKHONGKICHHOAT();
...
/// TODO:
/// -----
class SPRITEGAMEUINUTBAMCHONTABCHIENDAUKICHHOAT extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;

  SPRITEGAMEUINUTBAMCHONTABCHIENDAUKICHHOAT({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongSpriteGameUI, required this.chieuCaoSpriteGameUI}) {
    onVoidCaiDatTrangThaiTongQuat(value: trangThaiTongQuat);
  }

  GAMEUINUTBAMCHONTABCHIENDAUKICHHOAT? _thanhPhanGameUI;
  GAMEUINUTBAMCHONTABCHIENDAUKICHHOAT? get getThanhPhanGameUI => _thanhPhanGameUI;
  ...
  FutureOr<void> onLoad() async {
    ...
    _thanhPhanGameUI = GAMEUINUTBAMCHONTABCHIENDAUKICHHOAT();
    await _thanhPhanGameUI?.onSetupRoot();
    await _thanhPhanGameUI?.onInitRoot();
