...
class KHUNGTHANHPHANNUTBAMCHONTABTHANHTICHSTATE extends State<KHUNGTHANHPHANNUTBAMCHONTABTHANHTICH> {
  /// -----
  /// TODO:
  /// -----
  ...
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHANHTICH? _gameWidget;
  FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHANHTICH? get getGameWidget => _gameWidget;
  ...
  Widget build(BuildContext context) {
    _gameWidget = FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHANHTICH(
...
class FLAMEGAMEKHUNGTHANHPHANNUTBAMCHONTABTHANHTICH extends FlameGame {
  @override
  ...
  SPRITEGAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT? _thanhPhanGameUIKhongKichHoat;
  SPRITEGAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT? get getThanhPhanGameUIKhongKichHoat => _thanhPhanGameUIKhongKichHoat;

  SPRITEGAMEUINUTBAMCHONTABTHANHTICHKICHHOAT? _thanhPhanGameUIKichHoat;
  SPRITEGAMEUINUTBAMCHONTABTHANHTICHKICHHOAT? get getThanhPhanGameUIKichHoat => _thanhPhanGameUIKichHoat;

  @override
  FutureOr<void> onLoad() async {
    _thanhPhanGameUIKhongKichHoat = SPRITEGAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT(
      chieuRongSpriteGameUI: chieuRongFlameGameUI,
      chieuCaoSpriteGameUI: chieuCaoFlameGameUI,
      trangThaiTongQuat: getTrangThaiTongQuat,
    );
    _thanhPhanGameUIKichHoat = SPRITEGAMEUINUTBAMCHONTABTHANHTICHKICHHOAT(
      chieuRongSpriteGameUI: chieuRongFlameGameUI,
      chieuCaoSpriteGameUI: chieuCaoFlameGameUI,
      trangThaiTongQuat: getTrangThaiTongQuat,
    );
...
/// TODO:
/// -----
class SPRITEGAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT extends SpriteAnimationComponent with HasVisibility {
  ...
  GAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT? _thanhPhanGameUI;
  GAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT? get getThanhPhanGameUI => _thanhPhanGameUI;
...
/// TODO:
/// -----
class SPRITEGAMEUINUTBAMCHONTABTHANHTICHKICHHOAT extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;
  ...
  GAMEUINUTBAMCHONTABTHANHTICHKICHHOAT? _thanhPhanGameUI;
  GAMEUINUTBAMCHONTABTHANHTICHKICHHOAT? get getThanhPhanGameUI => _thanhPhanGameUI;
