...
///
/// TODO: [GAMEUI] Nút Bấm Chọn Tab Thành Tích Không Kích Hoạt
///
class GAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT extends THANHPHANGAMEUICOBAN {
  static const String maDinhDanhGameUI = '[GAMEUI]_[GAMEUINUTBAMCHONTABTHANHTICHKHONGKICHHOAT]';
  ...
  Future<void> onInitSpriteGameUI() async {
    ...
    final double chieuRongFrame = 220.0;
    final double chieuCaoFrame = 150.0;
    await Future.wait([
    ...
    /// -----
    final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss022/lib/28_def0028/ADef030_0/08_SubDefs/Def310_2';
    ...
    await Future.wait([
      ...
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS01?.caiDatChieuRongFrameRS100(value: chieuRongFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS01?.caiDatChieuCaoFrameRS100(value: chieuCaoFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
    ]);
    ...
    await Future.wait([
      ...
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS02?.caiDatChieuRongFrameRS100(value: chieuRongFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS02?.caiDatChieuCaoFrameRS100(value: chieuCaoFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
    ]);
    ...
    await Future.wait([
      ...
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS03?.caiDatChieuRongFrameRS100(value: chieuRongFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS03?.caiDatChieuCaoFrameRS100(value: chieuCaoFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
    ]);
    ...
    await Future.wait([
      ...
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS04?.caiDatChieuRongFrameRS100(value: chieuRongFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS04?.caiDatChieuCaoFrameRS100(value: chieuCaoFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
    ]);
    ...
    await Future.wait([
      ...
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS05?.caiDatChieuRongFrameRS100(value: chieuRongFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS05?.caiDatChieuCaoFrameRS100(value: chieuCaoFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
    ]);
    ...
    await Future.wait([
      ...
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS06?.caiDatChieuRongFrameRS100(value: chieuRongFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
      getSpriteThanhPhanGameUI?.getDonViSpriteNgoaiHinhGameUIPartSS06?.caiDatChieuCaoFrameRS100(value: chieuCaoFrame).catchError((e) => null) ?? onReportRootIssue(nameFunction: ''),
    ]);
