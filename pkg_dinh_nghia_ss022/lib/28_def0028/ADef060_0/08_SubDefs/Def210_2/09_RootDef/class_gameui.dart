...
/// TODO: [GAMEUI] Nút Bấm
///
class GAMEUINUTBAMCHUYENCHONCHIDINHTRAI extends THANHPHANGAMEUICOBAN {
  static const String maDinhDanhGameUI = '[GAMEUI]_[GAMEUINUTBAMCHUYENCHONCHIDINHTRAI]';
  ...
  Future<void> onInitSpriteGameUI() async {
    ...
    final double chieuRongFrame = 180.0;
    ...
    /// -----
    final String nguonSpriteDongKhoi = 'packages/pkg_dinh_nghia_ss022/lib/28_def0028/ADef060_0/08_SubDefs/Def210_2';
