...
/// -----
class KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI extends StatefulWidget {
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI> createState() => KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOISTATE();
}

class KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOISTATE extends State<KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI> {
  /// -----
  /// TODO:
  /// -----
  ...
  FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI? _gameWidget;
  FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI? get getGameWidget => _gameWidget;
  ...
  Widget build(BuildContext context) {
    _gameWidget = FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI(
...
class FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI extends FlameGame {
  @override
  ...
  FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENVANGTRAODOI({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongFlameGameUI, required this.chieuCaoFlameGameUI}) {
  ...
  SPRITEGAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI? _thanhPhanGameUI;
  SPRITEGAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI? get getThanhPhanGameUI => _thanhPhanGameUI;

  @override
  FutureOr<void> onLoad() async {
    _thanhPhanGameUI = SPRITEGAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI(chieuRongSpriteGameUI: chieuRongFlameGameUI, chieuCaoSpriteGameUI: chieuCaoFlameGameUI, trangThaiTongQuat: getTrangThaiTongQuat);
...
/// TODO:
/// -----
class SPRITEGAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;

  SPRITEGAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongSpriteGameUI, required this.chieuCaoSpriteGameUI}) {
    onVoidCaiDatTrangThaiTongQuat(value: trangThaiTongQuat);
  }

  GAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI? _thanhPhanGameUI;
  GAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI? get getThanhPhanGameUI => _thanhPhanGameUI;
  ...
  FutureOr<void> onLoad() async {
    ...
    _thanhPhanGameUI = GAMEUIKHUNGTHONGTINTAINGUYENVANGTRAODOI();
