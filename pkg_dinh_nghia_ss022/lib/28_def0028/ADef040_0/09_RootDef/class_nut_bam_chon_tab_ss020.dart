...
/// -----
class KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI extends StatefulWidget {
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI> createState() => KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOISTATE();
}

class KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOISTATE extends State<KHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI> {
  /// -----
  /// TODO:
  /// -----
  ...
  FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI? _gameWidget;
  FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI? get getGameWidget => _gameWidget;
  ...
  Widget build(BuildContext context) {
    _gameWidget = FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI(
...
class FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI extends FlameGame {
  @override
  ...
  FLAMEGAMEKHUNGTHANHPHANKHUNGTHONGTINTAINGUYENNGOCTRAODOI({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongFlameGameUI, required this.chieuCaoFlameGameUI}) {
  ...
  SPRITEGAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI? _thanhPhanGameUI;
  SPRITEGAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI? get getThanhPhanGameUI => _thanhPhanGameUI;

  @override
  FutureOr<void> onLoad() async {
    _thanhPhanGameUI = SPRITEGAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI(chieuRongSpriteGameUI: chieuRongFlameGameUI, chieuCaoSpriteGameUI: chieuCaoFlameGameUI, trangThaiTongQuat: getTrangThaiTongQuat);
...
/// TODO:
/// -----
class SPRITEGAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI extends SpriteAnimationComponent with HasVisibility {
  final double chieuRongSpriteGameUI;
  final double chieuCaoSpriteGameUI;

  SPRITEGAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI({GlobalStateManagementSystem? trangThaiTongQuat, required this.chieuRongSpriteGameUI, required this.chieuCaoSpriteGameUI}) {
    onVoidCaiDatTrangThaiTongQuat(value: trangThaiTongQuat);
  }

  GAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI? _thanhPhanGameUI;
  GAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI? get getThanhPhanGameUI => _thanhPhanGameUI;
  ...
  FutureOr<void> onLoad() async {
    ...
    _thanhPhanGameUI = GAMEUIKHUNGTHONGTINTAINGUYENNGOCTRAODOI();
