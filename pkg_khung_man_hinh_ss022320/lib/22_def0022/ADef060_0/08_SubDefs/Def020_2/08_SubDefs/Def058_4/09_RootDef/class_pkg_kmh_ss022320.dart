...
/// TODO:
/// -----
class CARDNHIEMVUSS00A020MAPSS00A extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDNHIEMVUSS00A020MAPSS00A({
    ...
    getNhiemVuChienDau?.onCaiDatMoHinh(
      value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS200,
      caiDatUuTien: true,
    );
  }
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: '20', caiDatUuTien: true);
