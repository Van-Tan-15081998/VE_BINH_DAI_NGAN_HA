...
/// TODO:
/// -----
class CARDNHIEMVUSS00A016MAPSS00A extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDNHIEMVUSS00A016MAPSS00A({
    ...
    getNhiemVuChienDau?.onCaiDatMoHinh(
      value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS160,
      caiDatUuTien: true,
    );
  }
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: '16', caiDatUuTien: true);
