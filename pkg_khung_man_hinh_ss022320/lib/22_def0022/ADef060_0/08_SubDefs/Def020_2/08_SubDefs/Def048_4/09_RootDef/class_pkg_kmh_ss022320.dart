...
/// TODO:
/// -----
class CARDNHIEMVUSS00A015MAPSS00A extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDNHIEMVUSS00A015MAPSS00A({
    ...
    getNhiemVuChienDau?.onCaiDatMoHinh(
      value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS150,
      caiDatUuTien: true,
    );
  }
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: '15', caiDatUuTien: true);
