...
/// TODO:
/// -----
class CARDNHIEMVUSS00A011MAPSS00A extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDNHIEMVUSS00A011MAPSS00A({
    ...
    getNhiemVuChienDau?.onCaiDatMoHinh(
      value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS110,
      caiDatUuTien: true,
    );
  }
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: '11', caiDatUuTien: true);
