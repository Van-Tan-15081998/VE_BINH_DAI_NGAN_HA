...
/// TODO:
/// -----
class CARDNHIEMVUSS00A019MAPSS00A extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDNHIEMVUSS00A019MAPSS00A({
    ...
    getNhiemVuChienDau?.onCaiDatMoHinh(
      value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS190,
      caiDatUuTien: true,
    );
  }
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: '19', caiDatUuTien: true);
