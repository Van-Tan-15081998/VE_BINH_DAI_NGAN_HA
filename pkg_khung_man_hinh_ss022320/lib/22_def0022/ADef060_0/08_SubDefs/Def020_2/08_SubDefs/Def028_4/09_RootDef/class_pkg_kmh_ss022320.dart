...
/// TODO:
/// -----
class CARDNHIEMVUSS00A005MAPSS00A extends CARDNHIEMVUCHIENDAUCOBAN {
  /// -----
  /// TODO:
  /// -----
  CARDNHIEMVUSS00A005MAPSS00A({
    ...
    getNhiemVuChienDau?.onCaiDatMoHinh(
      value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS050,
      caiDatUuTien: true,
    );
  }
  ...
  Future<void> onInitRoot() async {
    ...
    getThanhPhanVanBan?.onVoidCaiDatVanBan(value: '5', caiDatUuTien: true);
