...
class KhungHinhPopupCuaHangChienDauCo00C05SS01 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCo00C05SS01({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSao00C05SS01? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCo00C05SS01> createState() => _KhungHinhPopupCuaHangChienDauCo00C05SS01State();
}

class _KhungHinhPopupCuaHangChienDauCo00C05SS01State extends State<KhungHinhPopupCuaHangChienDauCo00C05SS01> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDC00C05SS01.png';
