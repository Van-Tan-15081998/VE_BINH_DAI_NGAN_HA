...
import 'package:pkg_man_hinh_ss00024/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def26_4/08_SubDefs/Def20_6/08_SubDefs/Def22_8/08_SubDefs/Def20_20/09_RootDef/class_20002080.dart';

class KhungHinhTheCuaHangChienDauCo00E03SS02 extends StatefulWidget {
  const KhungHinhTheCuaHangChienDauCo00E03SS02({super.key, required this.chieuRongLayout, required this.chienDauCo, required this.trangThaiTongQuat});
  ...
  @override
  State<KhungHinhTheCuaHangChienDauCo00E03SS02> createState() => _KhungHinhTheCuaHangChienDauCo00E03SS02State();
}

class _KhungHinhTheCuaHangChienDauCo00E03SS02State extends State<KhungHinhTheCuaHangChienDauCo00E03SS02>
    with SingleTickerProviderStateMixin, ThanhPhanManHinhPopupCoBan {
  late AnimationController _controller;
  late Animation<double> _animation;

  String nguonHinhAnh =
      'packages/pkg_man_hinh_ss00024/lib/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def26_4/08_SubDefs/Def20_6/08_SubDefs/Def22_8/06_ImgSrcs/'
      'hinh_the_cua_hang_CDC00E03SS02.png';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await caiDatNoiDungManHinh(
        value: KhungHinhPopupCuaHangChienDauCo00E03SS02(chienDauCo: widget.chienDauCo, trangThaiTongQuat: widget.trangThaiTongQuat),
      );
    });
  }
