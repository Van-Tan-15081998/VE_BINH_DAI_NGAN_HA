...
class KhungHinhPopupCuaHangChienDauCo0SS09SS03 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCo0SS09SS03({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSao0SS09SS03? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCo0SS09SS03> createState() => _KhungHinhPopupCuaHangChienDauCo0SS09SS03State();
}

class _KhungHinhPopupCuaHangChienDauCo0SS09SS03State extends State<KhungHinhPopupCuaHangChienDauCo0SS09SS03> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDC0SS09SS03.png';
