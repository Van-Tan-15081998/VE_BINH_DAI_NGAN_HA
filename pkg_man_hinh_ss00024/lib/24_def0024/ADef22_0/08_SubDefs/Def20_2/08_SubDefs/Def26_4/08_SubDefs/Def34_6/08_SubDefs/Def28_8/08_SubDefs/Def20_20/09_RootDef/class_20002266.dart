...
class KhungHinhPopupCuaHangChienDauCoSSS10SS05 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCoSSS10SS05({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSaoSSS10SS05? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCoSSS10SS05> createState() => _KhungHinhPopupCuaHangChienDauCoSSS10SS05State();
}

class _KhungHinhPopupCuaHangChienDauCoSSS10SS05State extends State<KhungHinhPopupCuaHangChienDauCoSSS10SS05> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDCSSS10SS05.png';
