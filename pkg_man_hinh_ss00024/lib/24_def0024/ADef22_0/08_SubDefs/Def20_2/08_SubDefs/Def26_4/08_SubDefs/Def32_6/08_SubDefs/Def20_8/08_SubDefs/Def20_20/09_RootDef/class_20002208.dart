...
class KhungHinhPopupCuaHangChienDauCo0SS09SS01 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCo0SS09SS01({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSao0SS09SS01? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCo0SS09SS01> createState() => _KhungHinhPopupCuaHangChienDauCo0SS09SS01State();
}

class _KhungHinhPopupCuaHangChienDauCo0SS09SS01State extends State<KhungHinhPopupCuaHangChienDauCo0SS09SS01> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDC0SS09SS01.png';
