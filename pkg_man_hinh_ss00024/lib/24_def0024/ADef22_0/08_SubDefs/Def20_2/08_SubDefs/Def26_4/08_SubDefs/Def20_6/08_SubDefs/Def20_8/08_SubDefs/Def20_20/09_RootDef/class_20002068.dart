...
class KhungHinhPopupCuaHangChienDauCo00E03SS01 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCo00E03SS01({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSao00E03SS01? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCo00E03SS01> createState() => _KhungHinhPopupCuaHangChienDauCo00E03SS01State();
}

class _KhungHinhPopupCuaHangChienDauCo00E03SS01State extends State<KhungHinhPopupCuaHangChienDauCo00E03SS01> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDC00E03SS01.png';
  ...
  Widget build(BuildContext context) {
    ...
    caiDatChamNgoaiKetThucManHinh(value: false);
