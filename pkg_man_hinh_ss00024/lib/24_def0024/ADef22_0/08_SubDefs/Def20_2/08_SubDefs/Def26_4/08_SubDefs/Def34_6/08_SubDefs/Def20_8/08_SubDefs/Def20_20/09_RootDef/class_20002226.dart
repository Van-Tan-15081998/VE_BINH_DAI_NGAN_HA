...
class KhungHinhPopupCuaHangChienDauCoSSS10SS01 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCoSSS10SS01({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSaoSSS10SS01? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCoSSS10SS01> createState() => _KhungHinhPopupCuaHangChienDauCoSSS10SS01State();
}

class _KhungHinhPopupCuaHangChienDauCoSSS10SS01State extends State<KhungHinhPopupCuaHangChienDauCoSSS10SS01> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDCSSS10SS01.png';
