...
class KhungHinhPopupCuaHangChienDauCoSSS10SS02 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCoSSS10SS02({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSaoSSS10SS02? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCoSSS10SS02> createState() => _KhungHinhPopupCuaHangChienDauCoSSS10SS02State();
}

class _KhungHinhPopupCuaHangChienDauCoSSS10SS02State extends State<KhungHinhPopupCuaHangChienDauCoSSS10SS02> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDCSSS10SS02.png';
