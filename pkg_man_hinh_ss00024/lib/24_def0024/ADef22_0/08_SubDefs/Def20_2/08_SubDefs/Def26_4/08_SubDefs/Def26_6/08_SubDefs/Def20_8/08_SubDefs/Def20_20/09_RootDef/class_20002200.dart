...
class KhungHinhPopupCuaHangChienDauCo00B06SS01 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCo00B06SS01({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSao00B06SS01? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCo00B06SS01> createState() => _KhungHinhPopupCuaHangChienDauCo00B06SS01State();
}

class _KhungHinhPopupCuaHangChienDauCo00B06SS01State extends State<KhungHinhPopupCuaHangChienDauCo00B06SS01> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDC00B06SS01.png';
