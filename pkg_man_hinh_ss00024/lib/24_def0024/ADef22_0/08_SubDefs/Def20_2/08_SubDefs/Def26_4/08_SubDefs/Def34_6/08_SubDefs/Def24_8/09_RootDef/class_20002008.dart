...
import 'package:pkg_man_hinh_ss00024/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def26_4/08_SubDefs/Def34_6/08_SubDefs/Def24_8/08_SubDefs/Def20_20/09_RootDef/class_20002260.dart';

class KhungHinhTheCuaHangChienDauCoSSS10SS03 extends StatefulWidget {
  const KhungHinhTheCuaHangChienDauCoSSS10SS03({super.key, required this.chieuRongLayout, required this.chienDauCo, required this.trangThaiTongQuat});

  final double chieuRongLayout;
  final ChienDauCoDangCapSaoSSS10SS03? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhTheCuaHangChienDauCoSSS10SS03> createState() => _KhungHinhTheCuaHangChienDauCoSSS10SS03State();
}

class _KhungHinhTheCuaHangChienDauCoSSS10SS03State extends State<KhungHinhTheCuaHangChienDauCoSSS10SS03>
    with SingleTickerProviderStateMixin, ThanhPhanManHinhPopupCoBan {
  late AnimationController _controller;
  late Animation<double> _animation;

  String nguonHinhAnh =
      'packages/pkg_man_hinh_ss00024/lib/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def26_4/08_SubDefs/Def34_6/08_SubDefs/Def24_8/06_ImgSrcs/'
      'hinh_the_cua_hang_CDCSSS10SS03.png';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await caiDatNoiDungManHinh(
        value: KhungHinhPopupCuaHangChienDauCoSSS10SS03(chienDauCo: widget.chienDauCo, trangThaiTongQuat: widget.trangThaiTongQuat),
      );
    });
  }
