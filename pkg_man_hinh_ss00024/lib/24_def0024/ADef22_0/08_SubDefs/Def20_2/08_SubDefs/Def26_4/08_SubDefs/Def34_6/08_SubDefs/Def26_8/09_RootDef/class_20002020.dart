...
import 'package:pkg_man_hinh_ss00024/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def26_4/08_SubDefs/Def34_6/08_SubDefs/Def26_8/08_SubDefs/Def20_20/09_RootDef/class_20002262.dart';

class KhungHinhTheCuaHangChienDauCoSSS10SS04 extends StatefulWidget {
  const KhungHinhTheCuaHangChienDauCoSSS10SS04({super.key, required this.chieuRongLayout, required this.chienDauCo, required this.trangThaiTongQuat});
  ...
  @override
  State<KhungHinhTheCuaHangChienDauCoSSS10SS04> createState() => _KhungHinhTheCuaHangChienDauCoSSS10SS04State();
}

class _KhungHinhTheCuaHangChienDauCoSSS10SS04State extends State<KhungHinhTheCuaHangChienDauCoSSS10SS04>
  ...
  String nguonHinhAnh =
      ...
      'hinh_the_cua_hang_CDCSSS10SS04.png';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await caiDatNoiDungManHinh(
        value: KhungHinhPopupCuaHangChienDauCoSSS10SS04(chienDauCo: widget.chienDauCo, trangThaiTongQuat: widget.trangThaiTongQuat),
      );
    });
  }
