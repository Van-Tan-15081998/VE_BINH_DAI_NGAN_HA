...
class KhungHinhPopupCuaHangChienDauCoSSS10SS03 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCoSSS10SS03({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSaoSSS10SS03? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCoSSS10SS03> createState() => _KhungHinhPopupCuaHangChienDauCoSSS10SS03State();
}

class _KhungHinhPopupCuaHangChienDauCoSSS10SS03State extends State<KhungHinhPopupCuaHangChienDauCoSSS10SS03> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDCSSS10SS03.png';
