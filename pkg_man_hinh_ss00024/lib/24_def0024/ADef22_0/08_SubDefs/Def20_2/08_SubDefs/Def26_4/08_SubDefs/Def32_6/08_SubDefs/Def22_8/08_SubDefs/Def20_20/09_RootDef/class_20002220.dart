...
class KhungHinhPopupCuaHangChienDauCo0SS09SS02 extends StatefulWidget {
  const KhungHinhPopupCuaHangChienDauCo0SS09SS02({super.key, required this.chienDauCo, required this.trangThaiTongQuat});

  final ChienDauCoDangCapSao0SS09SS02? chienDauCo;
  final QuanLyTrangThaiTongQuat? trangThaiTongQuat;

  @override
  State<KhungHinhPopupCuaHangChienDauCo0SS09SS02> createState() => _KhungHinhPopupCuaHangChienDauCo0SS09SS02State();
}

class _KhungHinhPopupCuaHangChienDauCo0SS09SS02State extends State<KhungHinhPopupCuaHangChienDauCo0SS09SS02> with ThanhPhanManHinhPopupCoBan {
  String nguonHinhAnh =
      ...
      'hinh_popup_cua_hang_CDC0SS09SS02.png';
