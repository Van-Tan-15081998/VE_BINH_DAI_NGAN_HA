...
/// -----
class VANBANGIATRICHISOSATTHUONGCOBANTENLUA extends THANHPHANVANBANTHUANTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  VANBANGIATRICHISOSATTHUONGCOBANTENLUA({
  ...
  Future<void> update(double dt) async {
    ...
    if (getGiaTriChiSoVanHanh !=
        getTrangThai
            ...
            ?.getCapDoSatThuongCoBanTLTCHienHanh
