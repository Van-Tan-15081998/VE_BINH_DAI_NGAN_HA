...
/// -----
class VANBANCHISOSATTHUONGBAOKICH extends THANHPHANVANBANTHUANTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  VANBANCHISOSATTHUONGBAOKICH({
  ...
  Future<void> onCaiDatChiTietThanhPhanVanBan() async {
    onVoidCaiDatVanBan(value: 'Sát thương bạo kích (%):', caiDatUuTien: true);
