...
/// -----
class VANBANGIATRICHISOSATTHUONGBAOKICHSUNGCHINH extends THANHPHANVANBANTHUANTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  VANBANGIATRICHISOSATTHUONGBAOKICHSUNGCHINH({
  ...
  Future<void> update(double dt) async {
    ...
    if (getGiaTriChiSoVanHanh !=
        getTrangThai
            ...
            ?.getCapDoSatThuongBaoKichVKSCHienHanh
