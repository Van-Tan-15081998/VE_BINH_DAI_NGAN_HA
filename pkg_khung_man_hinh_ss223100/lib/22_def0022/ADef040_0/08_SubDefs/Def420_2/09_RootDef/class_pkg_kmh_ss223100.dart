...
/// -----
class VANBANCHISOSATTHUONGCOBAN extends THANHPHANVANBANTHUANTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  VANBANCHISOSATTHUONGCOBAN({
  ...
  Future<void> onCaiDatChiTietThanhPhanVanBan() async {
    onVoidCaiDatVanBan(value: 'Sát thương cơ bản:', caiDatUuTien: true);
