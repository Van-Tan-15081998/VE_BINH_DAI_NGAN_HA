...
/// -----
class VANBANGIATRICHISOTYLEBAOKICHSUNGCHINH extends THANHPHANVANBANTHUANTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  VANBANGIATRICHISOTYLEBAOKICHSUNGCHINH({
  ...
  Future<void> update(double dt) async {
    ...
    if (getGiaTriChiSoVanHanh !=
        getTrangThai
            ...
            ?.getCapDoTyLeBaoKichVKSCHienHanh
            ?.getCapDoChuanChinhThuc
            ?.getChiSoTheoCapDo
            ?.getChiSoTyLeBaoKichVanHanh) {
