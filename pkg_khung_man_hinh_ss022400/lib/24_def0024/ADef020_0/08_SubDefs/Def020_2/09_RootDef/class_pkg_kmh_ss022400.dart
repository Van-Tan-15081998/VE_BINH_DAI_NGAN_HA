...
import 'package:pkg_khung_man_hinh_ss022410/pkg_khung_man_hinh_ss022410_exp.dart';
import 'package:pkg_khung_man_hinh_ss022420/pkg_khung_man_hinh_ss022420_exp.dart';
import 'package:pkg_khung_man_hinh_ss022430/pkg_khung_man_hinh_ss022430_exp.dart';
...
class QUANLYTHANHPHANMANHINHTHUOCCAP
  ...
  /// TODO:
  /// -----
  KHUNGMANHINHTABSS010THUOCCAPTABSS040TV? _khungManHinhTabSS010;
  KHUNGMANHINHTABSS010THUOCCAPTABSS040TV? get getKhungManHinhTabSS010 =>
      _khungManHinhTabSS010;
  Future<void> onCaiDatKhungManHinhTabSS010({
    required KHUNGMANHINHTABSS010THUOCCAPTABSS040TV? value,
    bool? caiDatUuTien,
  }) async {
  ...
  /// TODO:
  /// -----
  KHUNGMANHINHTABSS020THUOCCAPTABSS040TV? _khungManHinhTabSS020;
  KHUNGMANHINHTABSS020THUOCCAPTABSS040TV? get getKhungManHinhTabSS020 =>
      _khungManHinhTabSS020;
  Future<void> onCaiDatKhungManHinhTabSS020({
    required KHUNGMANHINHTABSS020THUOCCAPTABSS040TV? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  /// TODO:
  /// -----
  KHUNGMANHINHTABSS030THUOCCAPTABSS040TV? _khungManHinhTabSS030;
  KHUNGMANHINHTABSS030THUOCCAPTABSS040TV? get getKhungManHinhTabSS030 =>
      _khungManHinhTabSS030;
  Future<void> onCaiDatKhungManHinhTabSS030({
    required KHUNGMANHINHTABSS030THUOCCAPTABSS040TV? value,
    bool? caiDatUuTien,
  }) async {
    if (caiDatUuTien == true) {
  ...
  Future<void> onSetupRootForSubCom() async {
    ...
    await Future.wait([
      onCaiDatKhungManHinhTabSS010(
        value: KHUNGMANHINHTABSS010THUOCCAPTABSS040TV(
      ...
      onCaiDatKhungManHinhTabSS020(
        value: KHUNGMANHINHTABSS020THUOCCAPTABSS040TV(
          globalState: getGlobalState,
          gameController: getGameController,
          thanhPhanQuanLyThuocCapTrucTiep: getThanhPhanQuanLyThuocCapTrucTiep,
          sizeDx: sizeDxKhungManHinhTab,
      ...
      onCaiDatKhungManHinhTabSS030(
        value: KHUNGMANHINHTABSS030THUOCCAPTABSS040TV(
          globalState: getGlobalState,
          gameController: getGameController,
          thanhPhanQuanLyThuocCapTrucTiep: getThanhPhanQuanLyThuocCapTrucTiep,
          sizeDx: sizeDxKhungManHinhTab,
