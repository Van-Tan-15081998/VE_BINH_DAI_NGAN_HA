...
class KHUNGTAINGUYENTRAODOIMUACHIENDAUCODANGCAPSAO00B06SS01 extends THANHPHANTICHHOPSPRITEANIMATIONVANBANTHUOCCAP {
  ...
  void update(double dt) {
    ...
    if (getChienDauCoDangCapSao00B06SS01?.getThuocTinhSoHuuChienDauCo?.getSoHuuTheoThoiGianVinhVien?.getTrangThaiSoHuuTheoThoiGianVinhVien?.getSoHuu == false) {
    ...
    } else if (getChienDauCoDangCapSao00B06SS01?.getThuocTinhSoHuuChienDauCo?.getSoHuuTheoThoiGianVinhVien?.getTrangThaiSoHuuTheoThoiGianVinhVien?.getSoHuu == true) {
      ///
      getSpriteAnimationComponent?.removeFromParent();
      getThanhPhanVanBanSoHoc?.removeFromParent();

      if (getGiaTriChiSoVanHanh !=
          getChienDauCoDangCapSao00B06SS01?.getThuocTinhChienDauTheoQuyChuan?.getThuocTinhCapDoChienDauCoTheoQuyChuan?.getCapDoChienDauCoTheoQuyChuanHienHanh?.getCapDoChuanChinhThuc?.getMaDinhDanh) {
