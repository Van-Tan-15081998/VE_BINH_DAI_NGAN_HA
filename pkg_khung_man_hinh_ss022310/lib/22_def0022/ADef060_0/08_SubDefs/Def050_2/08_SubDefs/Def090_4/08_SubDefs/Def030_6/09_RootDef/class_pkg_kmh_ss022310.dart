...
class KHUNGTAINGUYENTRAODOIMUACHIENDAUCODANGCAPSAO0SS09SS02 extends THANHPHANTICHHOPSPRITEANIMATIONVANBANTHUOCCAP {
  ...
  void update(double dt) {
    ...
    if (getChienDauCoDangCapSao0SS09SS02?.getThuocTinhSoHuuChienDauCo?.getSoHuuTheoThoiGianVinhVien?.getTrangThaiSoHuuTheoThoiGianVinhVien?.getSoHuu == false) {
    ...
    } else if (getChienDauCoDangCapSao0SS09SS02?.getThuocTinhSoHuuChienDauCo?.getSoHuuTheoThoiGianVinhVien?.getTrangThaiSoHuuTheoThoiGianVinhVien?.getSoHuu == true) {
      ///
      getSpriteAnimationComponent?.removeFromParent();
      getThanhPhanVanBanSoHoc?.removeFromParent();

      if (getGiaTriChiSoVanHanh !=
          getChienDauCoDangCapSao0SS09SS02?.getThuocTinhChienDauTheoQuyChuan?.getThuocTinhCapDoChienDauCoTheoQuyChuan?.getCapDoChienDauCoTheoQuyChuanHienHanh?.getCapDoChuanChinhThuc?.getMaDinhDanh) {
