...
/// -----
class CARDCHIENDAUCODANGCAPSAO00C05SS01
  ...
  CARDCHIENDAUCODANGCAPSAO00C05SS01({
    ...
    onCaiDatChienDauCoDangCapSao00C05SS01(
      value:
          getGlobalState
  ...
  Future<void> onCaiDatChienDauCoDangCapSao00C05SS01({
  ...
  void onThucThi() async {
    ...
    await getGlobalState
        ...
        ?.getTrangThai
        ?.caiDatMoHinh(value: getChienDauCoDangCapSao00C05SS01);
    await getGlobalState
        ?.getChienDauCoTongQuat
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    await onCaiDatThanhPhanGameUIKichHoat(
      value: GAMEUICARDDANGCAPSAO00C050(),
      caiDatUuTien: true,
    );
