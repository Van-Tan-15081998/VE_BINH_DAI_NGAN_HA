...
/// -----
class CARDCHIENDAUCODANGCAPSAO00A07SS01
  ...
  CARDCHIENDAUCODANGCAPSAO00A07SS01({
    ...
    onCaiDatChienDauCoDangCapSao00A07SS01(
      value:
          getGlobalState
  ...
  Future<void> onCaiDatChienDauCoDangCapSao00A07SS01({
  ...
  void onThucThi() async {
    ...
    await getGlobalState
        ...
        ?.getTrangThai
        ?.caiDatMoHinh(value: getChienDauCoDangCapSao00A07SS01);
    await getGlobalState
        ?.getChienDauCoTongQuat
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    await onCaiDatThanhPhanGameUIKichHoat(
      value: GAMEUICARDDANGCAPSAO00A070(),
      caiDatUuTien: true,
    );
