...
/// -----
/// TODO: Card Chiến Đấu Cơ Đẳng Cấp Sao [00A07_SS01]
/// -----
class CARDCHIENDAUCODANGCAPSAO00A07SS01 extends THANHPHANNUTBAMTICHHOPTHUOCCAP {
  /// -----
  /// TODO:
  /// -----
  CARDCHIENDAUCODANGCAPSAO00A07SS01({
    ...
    onCaiDatChienDauCoDangCapSao00A07SS01(value: getGlobalStateManagementSystem?.getHangarChienDauCoTongQuat?.getChienDauCoDangCapSao00A07SS01);
  }
  ...
  Future<void> onCaiDatChienDauCoDangCapSao00A07SS01({required ChienDauCoDangCapSao00A07SS01? value}) async {
  ...
  void onThucThi() async {
    ...
    /// -----
    await getGlobalStateManagementSystem?.getChienDauCoTongQuat?.getChiDinhChienDauCoThucThiChienDau?.getTrangThai?.caiDatMoHinh(value: getChienDauCoDangCapSao00A07SS01);
    await getGlobalStateManagementSystem?.getChienDauCoTongQuat?.getChienDauCoTrucTiepThucThiChienDau?.getTrangThai?.caiDatMoHinh(value: getChienDauCoDangCapSao00A07SS01);
    await getGlobalStateManagementSystem?.getChienDauCoTongQuat?.getChienDauCoChiDinhThucThiThongTin?.getTrangThai?.caiDatMoHinh(value: getChienDauCoDangCapSao00A07SS01);
    ...
    //     ?.onTaiTaiNguyenChienDauCo00A07SS010FullSize();
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    await onCaiDatThanhPhanGameUIKichHoat(value: GAMEUICARDDANGCAPSAO00A070(), caiDatUuTien: true);
    await onCaiDatThanhPhanGameUIKichHoat2(value: GAMEUICARDCHIENDAUCOKICHHOAT(), caiDatUuTien: true);
    await onCaiDatThanhPhanGameUIHuyKichHoat(value: GAMEUICARDDANGCAPSAO00A070(), caiDatUuTien: true);
  ...
  Future<void> onCapNhatChiTietSpriteAnimationComponentOnLayerSS010() async {
    double sizeDxCapNhat = (getChienDauCoDangCapSao00A07SS01?.getThuocTinh?.getThuocTinhKichThuoc?.getChieuRongThan ?? 50.0) * 0.35;
    double sizeDyCapNhat = (getChienDauCoDangCapSao00A07SS01?.getThuocTinh?.getThuocTinhKichThuoc?.getChieuCaoThan ?? 50.0) * 0.35;
    ...
    /// -----
    await getGlobalStateManagementSystem?.onGetEntityResourceManagement?.getQuanLyTrangThaiHangarChienDauCo?.onTruyXuatHinhAnhNgoaiHinhChienDauCo00A07SS010(
  ...
  void update(double dt) {
    ...
    if (getSpriteAnimationComponentOnLayerSS01?.animation != null) {
      ...
      getSpriteAnimationComponentOnLayerSS01?.animation = getChienDauCoDangCapSao00A07SS01?.getThuocTinh?.getThuocTinhHinhAnhSprite?.getDonViSpriteNgoaiHinhThanChienDauCo?.getSpriteAnimation;
