...
/// -----
class CARDCHIENDAUCODANGCAPSAO00B06SS01
  ...
  CARDCHIENDAUCODANGCAPSAO00B06SS01({
    ...
    onCaiDatChienDauCoDangCapSao00B06SS01(
      value:
          getGlobalState
  ...
  Future<void> onCaiDatChienDauCoDangCapSao00B06SS01({
  ...
  void onThucThi() async {
    ...
    await getGlobalState
        ...
        ?.getTrangThai
        ?.caiDatMoHinh(value: getChienDauCoDangCapSao00B06SS01);
    await getGlobalState
        ?.getChienDauCoTongQuat
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    await onCaiDatThanhPhanGameUIKichHoat(
      value: GAMEUICARDDANGCAPSAO00B060(),
      caiDatUuTien: true,
    );
