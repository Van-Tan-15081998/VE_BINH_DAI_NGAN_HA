...
/// -----
class CARDCHIENDAUCODANGCAPSAO00D04SS01
  ...
  CARDCHIENDAUCODANGCAPSAO00D04SS01({
    ...
    onCaiDatChienDauCoDangCapSao00D04SS01(
      value:
          getGlobalState
  ...
  Future<void> onCaiDatChienDauCoDangCapSao00D04SS01({
  ...
  void onThucThi() async {
    ...
    await getGlobalState
        ...
        ?.getTrangThai
        ?.caiDatMoHinh(value: getChienDauCoDangCapSao00D04SS01);
    await getGlobalState
        ?.getChienDauCoTongQuat
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    await onCaiDatThanhPhanGameUIKichHoat(
      value: GAMEUICARDDANGCAPSAO00D040(),
      caiDatUuTien: true,
    );
