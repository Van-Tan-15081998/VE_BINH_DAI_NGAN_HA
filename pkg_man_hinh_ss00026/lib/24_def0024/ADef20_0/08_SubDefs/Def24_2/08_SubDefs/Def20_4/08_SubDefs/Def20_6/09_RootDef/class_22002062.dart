...
/// -----
/// TODO: Khung Hình Thẻ Thành Tích Chiến Đấu Cơ Bản
/// -----
class KHUNGHINHTHETHANHTICHCHIENDAUCOBAN extends StatefulWidget {
  const KHUNGHINHTHETHANHTICHCHIENDAUCOBAN({super.key, required this.nguonHinhAnhKhungHinhTheCuaHang, required this.onBatDauKhungHinhPopupCuaHang});
  ...
  @override
  State<KHUNGHINHTHETHANHTICHCHIENDAUCOBAN> createState() => _KHUNGHINHTHETHANHTICHCHIENDAUCOBANState();
}

class _KHUNGHINHTHETHANHTICHCHIENDAUCOBANState extends State<KHUNGHINHTHETHANHTICHCHIENDAUCOBAN> with SingleTickerProviderStateMixin {
  /// -----
  /// TODO:
  /// -----
