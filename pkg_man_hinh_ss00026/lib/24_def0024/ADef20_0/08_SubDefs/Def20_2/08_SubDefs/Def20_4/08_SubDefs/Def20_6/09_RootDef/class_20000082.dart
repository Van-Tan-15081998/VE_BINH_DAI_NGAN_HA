...
class NutBamCoBanManHinhThanhTichChienDau extends StatefulWidget {
  const NutBamCoBanManHinhThanhTichChienDau({
    super.key,
    required this.onThucThi,
    required this.nguonHinhAnh,
    this.chieuRongNutBam,
    this.chieuCaoNutBam,
  });
  ...
  @override
  State<NutBamCoBanManHinhThanhTichChienDau> createState() => _NutBamCoBanManHinhThanhTichChienDauState();
}

class _NutBamCoBanManHinhThanhTichChienDauState extends State<NutBamCoBanManHinhThanhTichChienDau> with SingleTickerProviderStateMixin {
