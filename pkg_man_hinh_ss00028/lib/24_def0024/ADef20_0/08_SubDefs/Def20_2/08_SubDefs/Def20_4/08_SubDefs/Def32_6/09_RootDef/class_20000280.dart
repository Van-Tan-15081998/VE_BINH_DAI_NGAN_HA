...
class NutBamChuyenManHinhSS02 extends StatefulWidget {
  ...
  @override
  State<NutBamChuyenManHinhSS02> createState() => _NutBamChuyenManHinhSS02State();
}

class _NutBamChuyenManHinhSS02State extends State<NutBamChuyenManHinhSS02> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;

  String nguonHinhAnh =
      'packages/pkg_man_hinh_ss00028/lib/24_def0024/ADef20_0/08_SubDefs/Def20_2/08_SubDefs/Def20_4/08_SubDefs/Def30_6/06_ImgSrcs/nut_bam_chuyen_man_hinh_ss01.png';

  double chieuRongNutBam = 60.0;
  double chieuCaoNutBam = 60.0;
