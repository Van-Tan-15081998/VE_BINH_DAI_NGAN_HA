...
class TienIchTheHangarChienDauCoSSS10SS02 extends StatefulWidget {
  const TienIchTheHangarChienDauCoSSS10SS02({super.key, required this.chienDauCo, required this.onBatDauManHinhBachKhoaChienDauCo});
  ...
  @override
  State<TienIchTheHangarChienDauCoSSS10SS02> createState() => _TienIchTheHangarChienDauCoState();
}

class _TienIchTheHangarChienDauCoState extends State<TienIchTheHangarChienDauCoSSS10SS02>  with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;

  String nguonHinhAnh =
      'packages/pkg_man_hinh_ss00028/lib/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def24_4/08_SubDefs/Def36_6/08_SubDefs/Def22_8/06_ImgSrcs/the_chien_dau_co_hangar_SSS10SS02.png';
