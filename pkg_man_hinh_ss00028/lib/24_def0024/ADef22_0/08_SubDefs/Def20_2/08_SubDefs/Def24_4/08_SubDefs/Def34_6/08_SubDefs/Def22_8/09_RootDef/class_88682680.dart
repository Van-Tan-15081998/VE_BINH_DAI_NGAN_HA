...
class TienIchTheHangarChienDauCo0SS09SS02 extends StatefulWidget {
  const TienIchTheHangarChienDauCo0SS09SS02({super.key, required this.chienDauCo, required this.onBatDauManHinhBachKhoaChienDauCo});
  ...
  @override
  State<TienIchTheHangarChienDauCo0SS09SS02> createState() => _TienIchTheHangarChienDauCoState();
}

class _TienIchTheHangarChienDauCoState extends State<TienIchTheHangarChienDauCo0SS09SS02>  with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;

  String nguonHinhAnh =
      'packages/pkg_man_hinh_ss00028/lib/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def24_4/08_SubDefs/Def34_6/08_SubDefs/Def22_8/06_ImgSrcs/the_chien_dau_co_hangar_0SS09SS02.png';
