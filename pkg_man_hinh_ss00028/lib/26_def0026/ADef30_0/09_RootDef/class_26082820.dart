...
class KhungHoatAnhTheChienDauCoHangar extends StatefulWidget {
  final Widget child;

  const KhungHoatAnhTheChienDauCoHangar({super.key, required this.child});

  @override
  State<KhungHoatAnhTheChienDauCoHangar> createState() => _KhungHoatAnhTheChienDauCoHangarState();
}

class _KhungHoatAnhTheChienDauCoHangarState extends State<KhungHoatAnhTheChienDauCoHangar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Container(color: Colors.transparent, width: chieuRongManHinh, height: chieuCaoManHinh, child: widget.child),
    );
  }
}
