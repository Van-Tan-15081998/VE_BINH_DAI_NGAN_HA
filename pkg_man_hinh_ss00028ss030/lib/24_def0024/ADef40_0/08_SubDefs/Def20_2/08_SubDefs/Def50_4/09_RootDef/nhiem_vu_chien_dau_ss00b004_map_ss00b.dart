...
/// -----
/// TODO: [Khung Thành Phần] Nhiệm Vụ Chiến Đấu SS00B004 MAP SS00A
/// -----
class KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B004MAPSS00B extends StatefulWidget {
  /// -----
  /// TODO:
  /// -----
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B004MAPSS00B({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B004MAPSS00B> createState() => _THANHPHANSTATE();
}

class _THANHPHANSTATE extends State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B004MAPSS00B> {
  /// -----
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      /// TODO:
      /// -----
      await getNhiemVuChienDau?.onCaiDatMoHinh(value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS040, caiDatUuTien: true);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        /// -----
        Positioned(top: 0, width: 110.0, height: 80.0, child: Container(color: Colors.deepOrange)),
      ],
    );
  }
}
