...
/// -----
/// TODO: [Khung Thành Phần] Nhiệm Vụ Chiến Đấu SS00B013 MAP SS00A
/// -----
class KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B013MAPSS00B extends StatefulWidget {
  /// -----
  /// TODO:
  /// -----
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B013MAPSS00B({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B013MAPSS00B> createState() => _THANHPHANSTATE();
}

class _THANHPHANSTATE extends State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00B013MAPSS00B> {
  /// -----
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      /// TODO:
      /// -----
      await getNhiemVuChienDau?.onCaiDatMoHinh(value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS130, caiDatUuTien: true);
    });
  }
