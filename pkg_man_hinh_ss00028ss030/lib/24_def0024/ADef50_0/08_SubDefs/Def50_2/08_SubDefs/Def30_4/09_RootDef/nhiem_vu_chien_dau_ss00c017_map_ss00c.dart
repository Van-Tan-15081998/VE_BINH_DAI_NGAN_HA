...
/// -----
/// TODO: [Khung Thành Phần] Nhiệm Vụ Chiến Đấu SS00C017 MAP SS00A
/// -----
class KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C017MAPSS00C extends StatefulWidget {
  /// -----
  /// TODO:
  /// -----
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C017MAPSS00C({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C017MAPSS00C> createState() => _THANHPHANSTATE();
}

class _THANHPHANSTATE extends State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C017MAPSS00C> {
  /// -----
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      /// TODO:
      /// -----
      await getNhiemVuChienDau?.onCaiDatMoHinh(value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS170, caiDatUuTien: true);
    });
  }
