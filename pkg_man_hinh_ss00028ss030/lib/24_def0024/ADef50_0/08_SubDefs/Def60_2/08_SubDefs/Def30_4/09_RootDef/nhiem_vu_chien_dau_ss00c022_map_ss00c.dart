...
/// -----
/// TODO: [Khung Thành Phần] Nhiệm Vụ Chiến Đấu SS00C022 MAP SS00A
/// -----
class KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C022MAPSS00C extends StatefulWidget {
  /// -----
  /// TODO:
  /// -----
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C022MAPSS00C({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C022MAPSS00C> createState() => _THANHPHANSTATE();
}

class _THANHPHANSTATE extends State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C022MAPSS00C> {
  /// -----
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      /// TODO:
      /// -----
      await getNhiemVuChienDau?.onCaiDatMoHinh(value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS220, caiDatUuTien: true);
    });
  }
