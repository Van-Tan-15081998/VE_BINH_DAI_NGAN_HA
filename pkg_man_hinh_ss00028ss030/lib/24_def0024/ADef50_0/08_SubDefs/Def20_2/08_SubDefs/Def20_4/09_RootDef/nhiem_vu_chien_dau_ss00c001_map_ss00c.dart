...
/// -----
/// TODO: [Khung Thành Phần] Nhiệm Vụ Chiến Đấu SS00C001 MAP SS00A
/// -----
class KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C001MAPSS00C extends StatefulWidget {
  /// -----
  /// TODO:
  /// -----
  ...
  /// TODO:
  /// -----
  const KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C001MAPSS00C({
    super.key,
  ...
  @override
  State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C001MAPSS00C> createState() => _THANHPHANSTATE();
}

class _THANHPHANSTATE extends State<KHUNGTHANHPHANNHIEMVUCHIENDAUSS00C001MAPSS00C> {
  /// -----
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      /// TODO:
      /// -----
      await getNhiemVuChienDau?.onCaiDatMoHinh(value: getBanDoChienDau?.getMoHinh?.getNhiemVuChienDauSS010, caiDatUuTien: true);
    });
  }
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          width: 110.0,
          height: 80.0,
          child: KHUNGTHANHPHANPHUONGTIENDICHTHUOCNHIEMVUCHIENDAUCOBAN(
            chieuRongKhungThanhPhan: 110.0,
