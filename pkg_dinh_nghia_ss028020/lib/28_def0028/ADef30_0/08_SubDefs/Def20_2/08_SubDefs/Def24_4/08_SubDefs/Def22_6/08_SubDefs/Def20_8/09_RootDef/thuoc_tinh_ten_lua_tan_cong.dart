...
/// TODO:
/// -----
class MOHINHTHUOCTINHTENLUATANCONG00S08SS01 extends MOHINHTHUOCTINHTENLUATANCONG {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoSatThuongCoBanTLTCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanTLTCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 90.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 180.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 270.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 360.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 450.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 540.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 630.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 720.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 810.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 900.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 990.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1080.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1170.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1260.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1350.00, caiDatUuTien: true);
