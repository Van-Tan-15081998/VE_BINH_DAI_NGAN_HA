...
class MOHINHTHUOCTINHTENLUATANCONG0SS09SS01 extends MOHINHTHUOCTINHTENLUATANCONG {
  ...
  Future<void> onInitCapDoSatThuongCoBanTLTCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanTLTCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 100.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 200.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 300.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 400.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 500.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 600.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 700.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 800.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 900.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1000.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1100.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1200.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1300.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1400.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1500.00, caiDatUuTien: true);
