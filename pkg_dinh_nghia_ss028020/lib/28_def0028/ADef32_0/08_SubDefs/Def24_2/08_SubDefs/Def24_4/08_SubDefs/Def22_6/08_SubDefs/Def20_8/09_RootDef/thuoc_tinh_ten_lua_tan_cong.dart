...
/// TODO:
/// -----
class MOHINHTHUOCTINHTENLUATANCONG0SS09SS03 extends MOHINHTHUOCTINHTENLUATANCONG {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoSatThuongCoBanTLTCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanTLTCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 120.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 240.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 360.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 480.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 600.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 720.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 840.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 960.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1080.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1200.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1320.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1440.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1560.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1680.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1800.00, caiDatUuTien: true);
