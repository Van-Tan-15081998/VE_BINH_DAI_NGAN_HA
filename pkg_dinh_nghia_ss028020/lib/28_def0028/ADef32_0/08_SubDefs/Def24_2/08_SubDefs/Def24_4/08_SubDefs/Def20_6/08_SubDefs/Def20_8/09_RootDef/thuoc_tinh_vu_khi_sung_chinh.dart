...
/// TODO:
/// -----
class MOHINHTHUOCTINHVUKHISUNGCHINH0SS09SS03 extends MOHINHTHUOCTINHVUKHISUNGCHINH {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoSatThuongCoBanVKSCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanVKSCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 60.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 120.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 180.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 240.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 300.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 360.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 420.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 480.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 540.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 600.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 660.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 720.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 780.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 840.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 900.00, caiDatUuTien: true);
