...
/// TODO:
/// -----
class MOHINHTHUOCTINHVUKHISUNGCHINH00B06SS01 extends MOHINHTHUOCTINHVUKHISUNGCHINH {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoSatThuongCoBanVKSCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanVKSCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 35.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 70.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 105.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 140.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 175.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 210.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 245.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 280.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 315.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 350.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 385.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 420.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 455.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 490.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 525.00, caiDatUuTien: true);
