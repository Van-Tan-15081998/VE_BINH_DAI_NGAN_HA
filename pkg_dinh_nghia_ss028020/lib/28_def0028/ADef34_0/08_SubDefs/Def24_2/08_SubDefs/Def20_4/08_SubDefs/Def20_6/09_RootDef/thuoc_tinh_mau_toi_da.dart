...
/// TODO:
/// -----
class MOHINHTHUOCTINHMAUTOIDASSS10SS03 extends MOHINHTHUOCTINHMAUTOIDA {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoMauToiDaTheoQuyChuan() async {
    ...
    await getCapDoMauToiDaSS01?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 1300.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS02?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 2600.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS03?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 3900.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS04?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 5200.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS05?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 6500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS06?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 7800.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS07?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 9100.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS08?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 10400.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS09?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 11700.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS10?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 13000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS11?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 14300.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS12?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 15600.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS13?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 16900.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS14?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 18200.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS15?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 19500.00, caiDatUuTien: true);
