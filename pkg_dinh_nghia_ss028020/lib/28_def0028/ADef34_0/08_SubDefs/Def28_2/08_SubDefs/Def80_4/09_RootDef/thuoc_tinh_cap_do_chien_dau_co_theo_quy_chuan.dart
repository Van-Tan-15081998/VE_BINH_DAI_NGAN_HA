...
/// TODO:
/// -----
class MOHINHTHUOCTINHCAPDOCHIENDAUCOTHEOQUYCHUANSSS10SS05 extends MOHINHTHUOCTINHCAPDOCHIENDAUCOTHEOQUYCHUAN {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoChienDauCoTheoQuyChuan() async {
    ...
    await getCapDoChienDauCoTheoQuyChuanSS01?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS02?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS02?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 20, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS02?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 2000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS03?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS03?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 30, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS03?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 3000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS04?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS04?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 40, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS04?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 4000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS05?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS05?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 50, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS05?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 5000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS06?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS06?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 60, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS06?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 6000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS07?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS07?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 70, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS07?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 7000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS08?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS08?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 80, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS08?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 8000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS09?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS09?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 90, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS09?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 9000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS10?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS10?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 100, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS10?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 10000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS11?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS11?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 110, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS11?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 11000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS12?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS12?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 120, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS12?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 12000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS13?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS13?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 130, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS13?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 13000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS14?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS14?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 140, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS14?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 14000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS15?.getDiemNangCapThuocTinh?.caiDatDiemNangCapThuocTinh(value: 2000, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS15?.getDieuKienNangCap?.caiDatSoDonViCoGiaTriTraoDoi(value: 150, caiDatUuTien: true);
    await getCapDoChienDauCoTheoQuyChuanSS15?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 15000, caiDatUuTien: true);
