...
/// TODO:
/// -----
class MOHINHTHUOCTINHMAUTOIDASSS10SS05 extends MOHINHTHUOCTINHMAUTOIDA {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoMauToiDaTheoQuyChuan() async {
    ...
    await getCapDoMauToiDaSS01?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 1500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS02?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 3000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS03?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 4500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS04?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 6000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS05?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 7500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS06?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 9000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS07?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 10500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS08?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 12000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS09?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 13500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS10?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 15000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS11?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 16500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS12?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 18000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS13?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 19500.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS14?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 21000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS15?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 22500.00, caiDatUuTien: true);
