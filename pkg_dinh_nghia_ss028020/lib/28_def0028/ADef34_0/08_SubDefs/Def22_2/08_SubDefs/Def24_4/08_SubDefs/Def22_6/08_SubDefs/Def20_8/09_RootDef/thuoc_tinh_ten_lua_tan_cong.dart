...
/// TODO:
/// -----
class MOHINHTHUOCTINHTENLUATANCONGSSS10SS02 extends MOHINHTHUOCTINHTENLUATANCONG {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoSatThuongCoBanTLTCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanTLTCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 140.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 280.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 420.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 560.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 700.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 840.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 980.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1120.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1260.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1400.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1540.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1680.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1820.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 1960.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanTLTCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 2100.00, caiDatUuTien: true);
