...
/// TODO:
/// -----
class MOHINHTHUOCTINHMAUTOIDASSS10SS02 extends MOHINHTHUOCTINHMAUTOIDA {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoMauToiDaTheoQuyChuan() async {
    ...
    await getCapDoMauToiDaSS01?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 1200.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS02?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 2400.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS03?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 3600.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS04?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 4800.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS05?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 6000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS06?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 7200.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS07?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 8400.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS08?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 9600.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS09?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 10800.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS10?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 12000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS11?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 13200.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS12?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 14400.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS13?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 15600.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS14?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 16800.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS15?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 18000.00, caiDatUuTien: true);
