...
/// TODO:
/// -----
class MOHINHTHUOCTINHMAUTOIDASSS10SS01 extends MOHINHTHUOCTINHMAUTOIDA {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoMauToiDaTheoQuyChuan() async {
    ...
    await getCapDoMauToiDaSS01?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 1000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS02?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 2000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS03?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 3000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS04?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 4000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS05?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 5000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS06?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 6000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS07?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 7000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS08?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 8000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS09?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 9000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS10?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 10000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS11?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 11000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS12?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 12000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS13?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 13000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS14?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 14000.00, caiDatUuTien: true);
    ...
    await getCapDoMauToiDaSS15?.getChiSoTheoCapDo?.caiDatChiSoMauToiDa(value: 15000.00, caiDatUuTien: true);
