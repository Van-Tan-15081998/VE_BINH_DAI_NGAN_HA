...
/// TODO:
/// -----
class MOHINHTHUOCTINHVUKHISUNGCHINHSSS10SS01 extends MOHINHTHUOCTINHVUKHISUNGCHINH {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoSatThuongCoBanVKSCTheoQuyChuan() async {
    ...
    await getCapDoSatThuongCoBanVKSCSS01?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 65.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS02?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 130.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS03?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 195.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS04?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 260.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS05?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 325.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS06?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 390.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS07?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 455.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS08?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 520.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS09?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 585.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS10?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 650.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS11?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 715.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS12?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 780.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS13?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 845.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS14?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 910.00, caiDatUuTien: true);
    ...
    await getCapDoSatThuongCoBanVKSCSS15?.getChiSoTheoCapDo?.caiDatChiSoSatThuong(value: 975.00, caiDatUuTien: true);
