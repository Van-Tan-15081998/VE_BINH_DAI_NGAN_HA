...
/// TODO:
/// -----
class MOHINHTHUOCTINHCAPDOCHIENDAUCOTHEOQUYCHUAN00E03SS01 extends MOHINHTHUOCTINHCAPDOCHIENDAUCOTHEOQUYCHUAN {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitCapDoChienDauCoTheoQuyChuan() async {
    ...
    await getCapDoChienDauCoTheoQuyChuanSS02?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 200, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS03?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 300, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS04?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 400, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS05?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 500, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS06?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 600, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS07?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 700, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS08?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 800, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS09?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 900, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS10?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 1000, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS11?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 1100, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS12?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 1200, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS13?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 1300, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS14?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 1400, caiDatUuTien: true);
    ...
    await getCapDoChienDauCoTheoQuyChuanSS15?.getDieuKienNangCap?.getGoiTaiNguyenThanhToan?.getDonViSoLuong?.caiDatTongSoLuong(value: 1500, caiDatUuTien: true);
