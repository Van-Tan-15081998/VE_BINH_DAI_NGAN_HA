...
import 'package:pkg_khung_man_hinh_ss022300/24_def0024/ADef020_0/08_SubDefs/Def040_2/09_RootDef/class_pkg_kmh_ss022300.dart';
import 'package:pkg_khung_man_hinh_ss022300/24_def0024/ADef020_0/08_SubDefs/Def050_2/09_RootDef/class_pkg_kmh_ss022300.dart';
import 'package:pkg_khung_man_hinh_ss022300/24_def0024/ADef020_0/08_SubDefs/Def060_2/09_RootDef/class_pkg_kmh_ss022300.dart';
    ...
    await Future.wait([
      onCaiDatQuanLyThanhPhanManHinhThuocCap(
        value: QUANLYTHANHPHANMANHINHTHUOCCAP(
          ...
          thanhPhanQuanLyThuocCapTrucTiep: this,
          sizeDx: getSizeDx,
          sizeDy: getSizeDy,
        ),
      ).catchError((e) => null),
        ...
        value: QUANLYTHANHPHANNUTBAMTHUOCCAP(
          ...
          onThucThiChuyenTabSS010: () {
            ...
            if (getQuanLyThanhPhanManHinhThuocCap
              ...
              //   },
              // );
              // (getQuanLyThanhPhanManHinhThuocCap as QUANLYTHANHPHANMANHINHTHUOCCAP).getKhungManHinhTabSS020?.onHuyKichHoatThanhPhanManHinhThuocCap();
            }
          },
