...
class NUTBAMCHUYENTABSS020 extends THANHPHANNUTBAMTHUOCCAPTHUANKICHHOAT {
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    // await onCaiDatThanhPhanGameUIKichHoat(value: GAMEUINUTBAMCHONTABBANDOKICHHOAT(), caiDatUuTien: true);
    // await onCaiDatThanhPhanGameUIHuyKichHoat(value: GAMEUINUTBAMCHONTABBANDOKHONGKICHHOAT(), caiDatUuTien: true);

    await onCaiDatThanhPhanGameUIKichHoat(
      value: GAMEUINUTBAMCHONTABBANDOKICHHOAT(),
      caiDatUuTien: true,
    );
