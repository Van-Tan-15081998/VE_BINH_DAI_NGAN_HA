...
/// TODO:
///
class SPRITETHANHNGANGCHISOMAUCHIENDAUCO extends SpriteAnimationComponent with HasVisibility {
  /// -----
  /// TODO:
  /// -----
  ...
  Future<void> onInitRoot() async {
    ...
    /// TODO:
    /// -----
    _spriteGameUIThanhNgangChiSoMauChienDauCo = SpriteAnimationComponent();

    if (getSpriteGameUIThanhNgangChiSoMauChienDauCo != null && getSpriteGameUIThanhNgangChiSoMauChienDauCo?.isMounted == false) {
      add(getSpriteGameUIThanhNgangChiSoMauChienDauCo!);
    }
    ...
    getSpriteGameUIThanhNgangChiSoMauChienDauCo?.anchor = Anchor.center;
    getSpriteGameUIThanhNgangChiSoMauChienDauCo?.position.setValues(0, 0);
    getSpriteGameUIThanhNgangChiSoMauChienDauCo?.size.setValues(175.0, 50.0);
    ...
    _gameUIThanhNgangChiSoMauChienDauCo = GAMEUITHANHNGANGCHISOMAUCHIENDAUCO();
    await _gameUIThanhNgangChiSoMauChienDauCo?.onSetupRoot();
    await _gameUIThanhNgangChiSoMauChienDauCo?.onInitRoot();
  ...
  SpriteAnimationComponent? _spriteGameUIThanhNgangChiSoMauChienDauCo;
  SpriteAnimationComponent? get getSpriteGameUIThanhNgangChiSoMauChienDauCo => _spriteGameUIThanhNgangChiSoMauChienDauCo;
  ...
  void onVoidCapNhatChiSoMau({required double dt, required double? dx, required double? dy, required double? tongChiSoMau, required double? chiSoMauHienHanh}) {
    onVoidCaiDatDx(value: dx);
    onVoidCaiDatDy(value: dy);
  ...
  /// -----
  TrangThaiChienDauCoTrucTiepThucThiChienDau? _moHinh;
  TrangThaiChienDauCoTrucTiepThucThiChienDau? get getMoHinh => _moHinh;
  void onVoidCaiDatMoHinh({required TrangThaiChienDauCoTrucTiepThucThiChienDau? value}) {
    _moHinh = value;
    return;
  }
