...
class SPRITETHANHNGANGCHISOMAUTTTS extends SPRITETHANHNGANGCHISOMAUCOBAN {
  ...
  void onVoidCaiDatNguonHinhAnh() {
    onVoidCaiDatNguonHinhAnhThanhNgangChiSoMauHienHanh(
      value: '../../packages/pkg_man_hinh_ss00230/lib/22_def0022/ADef20_0/07_ImgSrcs/Def020_2/09_RootDef/thanh_ngang_chi_so_mau_hien_hanh.webp',
      caiDatUuTien: true,
    );
    onVoidCaiDatNguonHinhAnhThanhNgangChiSoMauHieuUng(
      value: '../../packages/pkg_man_hinh_ss00230/lib/22_def0022/ADef20_0/07_ImgSrcs/Def020_2/09_RootDef/thanh_ngang_chi_so_mau_hieu_ung.webp',
      caiDatUuTien: true,
    );
    onVoidCaiDatNguonHinhAnhKhungVienChiSoMau(
      value: '../../packages/pkg_man_hinh_ss00230/lib/22_def0022/ADef20_0/07_ImgSrcs/Def020_2/09_RootDef/khung_vien_chi_so_mau.webp',
      caiDatUuTien: true,
    );
  }
}
