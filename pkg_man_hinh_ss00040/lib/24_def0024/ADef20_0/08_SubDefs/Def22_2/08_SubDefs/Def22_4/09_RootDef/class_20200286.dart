...
class KhungHoatAnhSoLuongTaiNguyenCoBanCoBan extends StatefulWidget {
  const KhungHoatAnhSoLuongTaiNguyenCoBanCoBan({
    super.key,
    required this.child,
    required this.chieuRongKhungHoatAnh,
    required this.chieu0CaoKhungHoatAnh,
  });
  ...
  @override
  State<KhungHoatAnhSoLuongTaiNguyenCoBanCoBan> createState() => _KhungHoatAnhSoLuongTaiNguyenCoBanCoBanState();
}

class _KhungHoatAnhSoLuongTaiNguyenCoBanCoBanState extends State<KhungHoatAnhSoLuongTaiNguyenCoBanCoBan> with SingleTickerProviderStateMixin {
