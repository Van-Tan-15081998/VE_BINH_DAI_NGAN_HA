...
class KhungManHinhHoatAnh extends StatefulWidget {
  final Widget child;

  const KhungManHinhHoatAnh({super.key, required this.child});

  @override
  State<KhungManHinhHoatAnh> createState() => _KhungManHinhHoatAnhState();
}

class _KhungManHinhHoatAnhState extends State<KhungManHinhHoatAnh> with SingleTickerProviderStateMixin {
