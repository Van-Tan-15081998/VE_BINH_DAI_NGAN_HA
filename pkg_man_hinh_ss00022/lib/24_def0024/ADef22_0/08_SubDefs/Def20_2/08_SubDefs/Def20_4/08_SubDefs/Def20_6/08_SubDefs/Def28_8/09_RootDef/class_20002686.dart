...
class SpriteNutBamChuyenManHinhSS05 extends SpriteAnimationComponent with TapCallbacks, GestureHitboxes, HasGameRef {
  SpriteNutBamChuyenManHinhSS05({required this.bienTraiNutBam, required this.chieuRongNutBam, required this.chieuCaoNutBam, required this.onThucThi});
  ...
  FutureOr<void> update(double dt) async {
    ...
    if (_kiemTraXuLyHoatAnh == false) {
      ...
      if (animation == null) {
        ...
        images
            .load(
          'packages/pkg_man_hinh_ss00022/lib/24_def0024/ADef22_0/08_SubDefs/Def20_2/08_SubDefs/Def20_4/08_SubDefs/Def20_6/08_SubDefs/Def28_8/06_ImgSrcs/nut_bam_chuyen_man_hinh_ss05.png',
        )
