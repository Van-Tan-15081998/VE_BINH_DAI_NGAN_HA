...
/// -----
/// TODO: Nút Bấm Chuyển Tab SS050
/// -----
class NUTBAMCHUYENTABSS050 extends THANHPHANNUTBAMTHUOCCAPTHUANKICHHOAT {
  /// -----
  /// TODO:
  /// -----
  NUTBAMCHUYENTABSS050({
  ...
  Future<void> onCaiDatChiTietThanhPhanGameUI() async {
    await onCaiDatThanhPhanGameUIKichHoat(
      value: GAMEUINUTBAMCHONTABCAIDATKICHHOAT(),
      caiDatUuTien: true,
    );
    await onCaiDatThanhPhanGameUIHuyKichHoat(
      value: GAMEUINUTBAMCHONTABCAIDATKHONGKICHHOAT(),
      caiDatUuTien: true,
    );
